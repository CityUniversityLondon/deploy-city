(function() {
    ...
    */
        ...
        $('#calculator').change(function(c) {
            ...
            // show block 1, row 2
            if (
                $('input[name="year_of_entry"]:checked').val() &&
                $('input[name="ordinarily_resident_in"]:checked').val()
            ) {
            ...
            if (
                ...
                $('input[name="care_leaver"]:checked').val()
            ) {
            ...
            // show block 2
            if (
                $('input[name="in_city_halls"]:checked').val() &&
                $('input[name="first_degree"]:checked').val()
            ) {
            ...
            // show block 3
            if (
                $('input[name="household_income"]:checked').val() &&
                $('input[name="sfe_funding"]:checked').val()
            ) {
            ...
            if (
                $('input[name="cass_course"]:checked').val() ||
                $('input[name="health_course"]:checked').val()
            ) {
