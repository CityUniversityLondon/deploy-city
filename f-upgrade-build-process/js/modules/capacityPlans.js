...
CITY.capacityPlans = (function() {
    var $highcharts = $('.highcharts#capacityPlans'),
        chart,
        months = [
            'January',
            'February',
        ...
        createSeries = function(i, v) {
            ...
            if (
                parseInt(v.endyear, 10) >= yearIndex &&
                (parseInt(v.enddate, 10) >= monthIndex &&
                    parseInt(v.endyear, 10) >= yearIndex)
            ) {
                ...
                if (parseInt(v.startyear, 10) > yearIndex) {
                    projectData.push([
                        parseInt(v.startdate - monthIndex + 12, 10),
                        parseInt(v.enddate - monthIndex, 10),
                    ]);
                    ...
                    projectData.push([
                        parseInt(v.startdate - monthIndex, 10),
                        parseInt(v.enddate - monthIndex, 10),
                    ]);
                }
            }
