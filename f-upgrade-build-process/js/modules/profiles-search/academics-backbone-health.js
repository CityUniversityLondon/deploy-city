...
(function(B, M) {
    ...
    var // our namespace
        ...
        doLayout = function() {
            ...
            for (
                var i = 0;
                i < APP.collections.academicsCollection.length;
                i++
            ) {
                if (i % 2 === 0) {
     ...
     */
        AcademicsCollection = Backbone.Paginator.clientPager.extend({
            ...
            searchFunnelback: function(query) {
                ...
                data = decodeURIComponent(
                    $.param(_.extend(server_api, { query: query }))
                );
            ...
            filterClick: function(e) {
                ...
                APP.router.navigate(
                    'search/' +
                        data.filterParam +
                        '/' +
                        encodeURIComponent(data.filterValue).replace(
                            /%20/g,
                            '+'
                        ),
                    { trigger: true }
        ...
        FacetsView = B.View.extend({
            ...
            updateSelected: function() {
                ...
                if (
                    this.collection.fieldFilterRules &&
                    this.collection.fieldFilterRules.length
                ) {
                    filterParam = this.collection.fieldFilterRules[0].field;
                    filterValue = this.collection.fieldFilterRules[0].value
                        .source; // chrome only??
                    this.$filters
            ...
            facetClick: function(e) {
                var $this = $(e.target),
                    newUrl =
                        ...
                        '/' +
                        encodeURIComponent($this.data('filter-value')).replace(
                            /%20/g,
                            '+'
                        );
        ...
        */
        ...
        SearchMetaView = M.ItemView.extend({
            ...
            template: function(modelData) {
                ...
                modelData.info =
                    APP.collections.academicsCollection.information;
        ...
        PaginationControlsView = M.ItemView.extend({
            ...
            checkIfNeeded: function() {
                if (
                    this.collection.information.perPage >
