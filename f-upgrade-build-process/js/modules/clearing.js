...
CITY.clearingTimeline = (function() {
    ...
    if ($clearingTable.length) {
        yepnope({
            load:
                '//s1.city.ac.uk/cityr/js/lib/jquery/plugins/dataTables/jquery.dataTables.min.js',
            complete: function() {
                /**
                    ...
                    aoColumns: [
                        ...
                        },
                        {
                            ...
                            mData: function(source) {
                                ...
                                source.keywords = source.keywords.replace(
                                    /,/g,
                                    ', '
                                );
                                return (
                                    '<span class="course-keywords"><a href="' +
                                    source.url +
                                    '">' +
                                    source.keywords +
                                    '</span></a>'
                        ...
                        },
                        {
                            ...
                            mRender: function(data, type, full) {
                                ...
                                return (
                                    '<span class="course-vacancy-status"><a href="' +
                                    full.url +
                                    '">' +
                                    (data === true ? 'Yes' : 'No') +
                                    '</span></a>'
...
function ResponsiveDatatablesHelper(tableSelector, breakpoints) {
    ...
    // Row template
    this.rowTemplate =
        '<tr class="row-detail"><td><ul class="course-extra"><!--column item--></ul></td></tr>';
    this.rowLiTemplate =
        '<li><span class="columnTitle"><!--column title--></span><span>: </span><!--column value--></li>';
                ...
                _.each(
                    ...
                    function(e) {
                        if (this.breakpoints[e] !== undefined) {
                            ...
                            this.breakpoints[e].columnsToHide.push(
...
ResponsiveDatatablesHelper.prototype.respond = function() {
    ...
    if (!this.skipNextWindowsWidthChange) {
        ...
        if (this.columnsHiddenIndexes.length !== newColumnsToHide.length) {
            ...
            d1 = _.difference(this.columnsHiddenIndexes, newColumnsToHide)
                .length;
            d2 = _.difference(newColumnsToHide, this.columnsHiddenIndexes)
                .length;
    ...
    if (columnShowHide) {
        ...
        this.columnsShownIndexes = _.difference(
            this.columnIndexes,
            this.columnsHiddenIndexes
        );
...
ResponsiveDatatablesHelper.prototype.showRowDetail = function(
    ...
    _.each(responsiveDatatablesHelperInstance.columnsHiddenIndexes, function(
        index
    ) {
...
!(function(n) {
    ...
    function e(n, e) {
        ...
        return (
            (n = n[r] || (n[r] = {})),
            'object' == r ? (n[u] && -1 < t(n[u], e) ? 0 : -1) : n[u] ? 0 : -1
        );
    }
    function r(n) {
        var t = this.k,
        ...
        if ('boolean' == e || n == h) t[n] = y;
            ...
            var r = 'number' == e ? n : j + n,
                u = t[e] || (t[e] = {});
            'object' == e
                ? (u[r] || (u[r] = [])).push(n) == this.b.length && (t[e] = b)
                : (u[r] = y);
        }
    }
    function u(n) {
    ...
    function p(n) {
        var t = n.k;
        t && p(t),
            (n.b = n.k = n.l = n.object = n.number = n.string = n.n = h),
            d.length < C && d.push(n);
    }
    function s(n, t, e) {
    ...
    function v(r) {
        ...
        function d(n, t, e) {
            ...
            for (
                var r = -1, u = L[typeof n] && Se(n), a = u ? u.length : 0;
                ++r < a && ((e = u[r]), !(t(n[e], e, n) === false));
        ...
        function rt(n, t, e, r) {
            function u() {
                ...
                return (
                    ...
                    e.length &&
                        (r = r.length
                            ? ((r = Ce.call(r)), f ? r.concat(e) : e.concat(r))
                            : e),
                    this instanceof u
                        ? ((l = gt(n.prototype) ? ye(n.prototype) : {}),
                          (r = n.apply(l, r)),
                          gt(r) ? r : l)
                        : n.apply(l, r)
                );
        ...
        function ot(n) {
            return function(t, e, r, u) {
                return (
                    typeof e != 'boolean' &&
                        e != h &&
                        ((u = r), (r = u && u[e] === t ? g : e), (e = b)),
                    r != h && (r = tt.createCallback(r, u)),
                    n(t, e, r, u)
                );
            };
        }
        function it(n) {
            ...
            return n &&
                ve.call(n) == V &&
                ((t = n.constructor), !vt(t) || t instanceof t)
                ? (C(n, function(n, t) {
                      e = t;
                  }),
                  e === g || le.call(n, e))
        ...
        function lt(n, t, e, r, u, a) {
            var o = n;
            if (
                (typeof t != 'boolean' && t != h && ((r = e), (e = t), (t = b)),
                typeof e == 'function')
            ) {
                if (
                    ((e =
            ...
            return (
                (o = l ? r(o.length) : {}),
                l &&
                    (le.call(n, 'index') && (o.index = n.index),
                    le.call(n, 'input') && (o.input = n.input)),
                u.push(n),
                a.push(o),
                (l ? wt : d)(n, function(n, r) {
                    o[r] = lt(n, t, e, g, u, a);
                }),
                i && (c(u), c(a)),
                o
        ...
        function st(n, t, e, r, u, a) {
            ...
            if (((l = p == W), !l)) {
                ...
                if (
                    p != s &&
                    (!vt(p) || !(p instanceof p && vt(s) && s instanceof s))
                )
                    return b;
            }
            ...
            return (
                C(t, function(t, o, f) {
                    return le.call(f, o)
                        ? (v++, (i = le.call(n, o) && st(n[o], t, e, r, u, a)))
                        : void 0;
                }),
                i &&
                    !o &&
        ...
        function bt(n, t, e) {
            ...
            if (e === k)
                ...
                typeof e != 'number' && (a = r.length),
                    3 < a && 'function' == typeof r[a - 2]
                        ? (o = tt.createCallback(r[--a - 1], r[a--], 2))
                        : 2 < a &&
                          'function' == typeof r[a - 1] &&
                          (o = r[--a]);
            }
            for (; ++u < a; )
        ...
        function dt(n, t, e) {
            ...
            return (
                (e = (0 > e ? _e(0, a + e) : e) || 0),
                a && typeof a == 'number'
                    ? (o = -1 < (ht(n) ? n.indexOf(t, e) : u(n, t, e)))
                    : d(n, function(n) {
        ...
        function xt(n, t, e) {
            ...
            if (!t && Ee(n)) {
                ...
                (t = !t && ht(n) ? u : tt.createCallback(t, e)),
                    wt(n, function(n, e, u) {
        ...
        function qt(n, t) {
            return Oe.fastBind || (ge && 2 < arguments.length)
                ? ge.call.apply(ge, arguments)
                : rt(n, t, Ce.call(arguments, 2));
        }
        function Dt(n, t, e) {
            function r() {
                ue(s), ue(v), (l = 0), (s = v = h);
            ...
            if (((t = _e(0, t || 0)), e === y))
                ...
                gt(e) &&
                    ((m = e.leading),
                    (p = 'maxWait' in e && _e(t, e.maxWait || 0)),
            ...
            wt(ct(n), function(t) {
                ...
                tt.prototype[t] = function() {
                    ...
                    return (
                        ...
                        (t = e.apply(tt, t)),
                        n && typeof n == 'object' && n === t ? this : new et(t)
                    );
                };
            });
        }
        ...
        var Ee = he,
            ...
            Ut = ot(function $e(n, t, e) {
                for (var r = -1, u = n ? n.length : 0, a = []; ++r < u; ) {
                    var o = n[r];
                    e && (o = e(o, r, n)),
                        Ee(o) ? ce.apply(a, t ? o : $e(o)) : a.push(o);
                }
                return a;
            }),
            Ne = ot(function(n, r, u) {
                ...
                for (; ++a < l; ) {
                    var y = n[a],
                        h = u ? u(y, a, n) : y;
                    (r ? !a || g[g.length - 1] !== h : 0 > i(g, h)) &&
                        ((u || v) && g.push(h), s.push(y));
                }
                return v ? (c(g.b), p(g)) : u && c(g), s;
            });
        return (
            Ht && Y && typeof pe == 'function' && (zt = qt(pe, r)),
            (pe =
                8 == je(B + '08')
                    ? je
                    : function(n, t) {
            ...
            (tt.at = function(n) {
                for (
                    var t = -1,
                        e = ae.apply(Zt, Ce.call(arguments, 1)),
                        r = e.length,
                        u = Mt(r);
                    ++t < r;
            ...
            (tt.bind = qt),
            (tt.bindAll = function(n) {
                for (
                    var t =
                            1 < arguments.length
                                ? ae.apply(Zt, Ce.call(arguments, 1))
                                : ct(n),
                        e = -1,
                        r = t.length;
                    ++e < r;
            ...
            (tt.createCallback = function(n, t, e) {
                ...
                if ('function' != r) {
                    ...
                    return function(t) {
                        for (
                            var e = u.length, r = b;
                            e-- && (r = st(t[u[e]], n[u[e]], k));

                        );
                        return r;
                    };
                }
                return typeof t == 'undefined' || ($ && !$.test(ie.call(n)))
                    ? n
                    : 1 === e
                        ? function(e) {
                              return n.call(t, e);
            ...
            (tt.forOwn = d),
            (tt.functions = ct),
            (tt.groupBy = function(n, t, e) {
                var r = {};
                return (
                    (t = tt.createCallback(t, e)),
                    wt(n, function(n, e, u) {
                        (e = Xt(t(n, e, u))),
                            (le.call(r, e) ? r[e] : (r[e] = [])).push(n);
                    }),
                    r
                );
            }),
            ...
            (tt.map = Ct),
            (tt.max = xt),
            (tt.memoize = function(n, t) {
                function e() {
                    var r = e.cache,
                        u = j + (t ? t.apply(this, arguments) : arguments[0]);
                    return le.call(r, u)
                        ? r[u]
                        : (r[u] = n.apply(this, arguments));
                }
                return (e.cache = {}), e;
            }),
            (tt.merge = bt),
            (tt.min = function(n, t, e) {
                var r = 1 / 0,
                    a = r;
                if (!t && Ee(n)) {
                    e = -1;
            ...
            (tt.once = function(n) {
                ...
                return function() {
                    return t
                        ? e
                        : ((t = y), (e = n.apply(this, arguments)), (n = h), e);
                };
            }),
            (tt.pairs = function(n) {
                for (
                    var t = -1, e = Se(n), r = e.length, u = Mt(r);
                    ++t < r;
            ...
            (tt.pick = function(n, t, e) {
                ...
                if (typeof t != 'function')
                    for (
                        var u = -1,
                            a = ae.apply(Zt, Ce.call(arguments, 1)),
                            o = gt(n) ? a.length : 0;
                        ++u < o;
            ...
            (tt.union = function(n) {
                return (
                    Ee(n) || (arguments[0] = n ? Ce.call(n) : Zt),
                    Ne(ae.apply(Zt, arguments))
                );
            }),
            (tt.uniq = Ne),
            (tt.unzip = Rt),
            ...
            (tt.identity = Wt),
            (tt.indexOf = $t),
            (tt.isArguments = function(n) {
                return ve.call(n) == z;
            }),
            (tt.isArray = Ee),
            (tt.isBoolean = function(n) {
            ...
            (tt.isEmpty = function(n) {
                ...
                return e == W ||
                    e == H ||
                    e == z ||
                    (e == V && typeof r == 'number' && vt(n.splice))
                    ? !r
                    : (d(n, function() {
                          return (t = b);
                      }),
            ...
            (tt.isObject = gt),
            (tt.isPlainObject = m),
            (tt.isRegExp = function(n) {
                return n ? typeof n == 'object' && ve.call(n) == G : b;
            }),
            (tt.isString = ht),
            (tt.isUndefined = function(n) {
            ...
            d(tt, function(n, t) {
                tt.prototype[t] ||
                    (tt.prototype[t] = function(t, e) {
                        var r = n(this.__wrapped__, t, e);
                        return t == h || (e && typeof t != 'function')
                            ? r
                            : new et(r);
                    });
            }),
            ...
            (tt.prototype.value = Kt),
            (tt.prototype.valueOf = Kt),
            wt(['join', 'pop', 'shift'], function(n) {
                var t = Zt[n];
