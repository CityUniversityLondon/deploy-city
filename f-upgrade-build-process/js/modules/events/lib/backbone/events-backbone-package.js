        ...
        set: function(models, options) {
            ...
            for (i = 0, l = models.length; i < l; i++) {
                ...
                if ((existing = this.get(model))) {
                    ...
                    if (merge) {
                        attrs =
                            attrs === model ? model.attributes : options._attrs;
...
var Marionette = (function(global, Backbone, _) {
    ...
    Marionette.getOption = function(target, optionName) {
        ...
        if (
            target.options &&
            optionName in target.options &&
            target.options[optionName] !== undefined
        ) {
    ...
    _.extend(Marionette.Region, {
        ...
        buildRegion: function(regionConfig, defaultRegionType) {
            ...
            var regionSelectorIsString =
                typeof regionConfig.selector === 'string';
            var regionTypeIsUndefined =
                typeof regionConfig.regionType === 'undefined';
        ...
        var RegionManager = Marionette.Controller.extend({
            ...
            addRegion: function(name, definition) {
                ...
                if (isString || (isObject && hasSelector)) {
                    region = Marionette.Region.buildRegion(
                        definition,
                        Marionette.Region
                    );
    ...
    Marionette.View = Backbone.View.extend({
        ...
        delegateEvents: function(events) {
            ...
            Marionette.bindEntityEvents(
                this,
                this.collection,
                Marionette.getOption(this, 'collectionEvents')
            );
        },
    ...
    Marionette.CompositeView = Marionette.CollectionView.extend({
        ...
        getItemView: function(item) {
            var itemView =
                Marionette.getOption(this, 'itemView') || this.constructor;
    ...
    _.extend(Marionette.Application.prototype, Backbone.Events, {
        ...
        _initRegionManager: function() {
            ...
            this.listenTo(this._regionManager, 'region:add', function(
                name,
                region
            ) {
                this[name] = region;
            ...
            this.listenTo(this._regionManager, 'region:remove', function(
                name,
                region
            ) {
                delete this[name];
...
Backbone.Paginator = (function(Backbone, _, $) {
                ...
                _.each(rules, function(rule) {
                    ...
                    if (rule.type === 'function') {
                        ...
                        if (
                            ...
                            Number(model.get(rule.field)) >=
                                Number(rule.value.min) &&
                            Number(model.get(rule.field)) <=
                                Number(rule.value.max)
                        ) {
                            should_push = true;
                        }
        ...
        _filter: function(models, fields, filter) {
            ...
            if (_.isString(fields)) {
                ...
                _.each(fields, function(cmp_opts, field) {
                    obj_fields[field] = _.defaults(cmp_opts, {
                        cmp_method: 'regexp',
                    });
                });
            }
            ...
            if (
                _.has(Backbone.Paginator, 'removeDiacritics') &&
                ...
                _.each(fields, function(cmp_opts, field) {
                    ...
                    if (value) {
                        ...
                        if (
                            ...
                            value = Backbone.Paginator.removeDiacritics(
                                value.toString()
                            );
                        } else {
                        ...
                        if (
                            ...
                            _.has(Backbone.Paginator, 'levenshtein') &&
                            self.useLevenshteinPlugin
                        ) {
                            var distance = Backbone.Paginator.levenshtein(
                                value,
                                filter
                            );
                        ...
                        matchesPerField = _.map(matchesPerField, function(
                            match
                        ) {
        ...
        info: function() {
            ...
            info = {
                ...
                startRecord:
                    totalRecords === 0
                        ? 0
                        : (self.currentPage - 1) * this.perPage + 1,
                endRecord: Math.min(
                    totalRecords,
                    self.currentPage * this.perPage
                ),
            };
    ...
    Paginator.requestPager = Backbone.Collection.extend({
        ...
        url: function() {
            ...
            if (
                this.paginator_core !== undefined &&
                this.paginator_core.url !== undefined
            ) {
