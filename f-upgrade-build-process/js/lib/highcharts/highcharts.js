...
(function() {
    ...
    function A(a, b, c) {
        ...
        else if (r(b) && V(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function ha(a) {
        return Da(a) ? a : [a];
    ...
    function Ab(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (
                ...
                (e = E[d[0]]),
                (f = d[1]),
                c[g + 1] && a <= (e * f[f.length - 1] + E[c[g + 1][0]]) / 2)
            )
                break;
    ...
    var y,
        ...
        Sa,
        fb = z.documentElement.ontouchstart !== y,
        Nb = {},
        ub = 0,
        $a,
        N,
                    ...
                    a.fn.highcharts = function() {
                        ...
                        if (c !== y)
                            (c.chart = c.chart || {}),
                                ...
                                (d = this);
                        c === y &&
                            (d = Ba[A(this[0], 'data-highcharts-chart')]);
                        return d;
                    };
                },
    ...
    N = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL:
                'http://code.highcharts.com/3.0.2/modules/canvas-tools.js',
            VMLRadialGradientURL:
                'http://code.highcharts.com/3.0.2/gfx/vml-radial-gradient.png',
        },
        chart: {
            borderColor: '#4572A7',
            borderRadius: 5,
        ...
        attr: function(a, b) {
            ...
            if (fa(a))
                (c = a),
                    ...
                    (s = A(g, c) || this[c] || 0),
                    c !== 'd' && c !== 'visibility' && (s = parseFloat(s));
            else {
                for (c in a)
                    if (
                        ((j = !1),
                        ...
                        if (c === 'stroke-width' || c === 'stroke') {
                            ...
                            if (this.stroke && this['stroke-width'])
                                A(g, 'stroke', this.stroke),
                                    A(g, 'stroke-width', this['stroke-width']),
                                    (this.hasStroke = !0);
                            else if (
                                c === 'stroke-width' &&
                                d === 0 &&
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (
                        ...
                        e &&
                        e.fontSize === '11px' &&
                        c.toPrecision(3) === '22.7'
                    )
                        a.height = c = 14;
                    if (d)
                        (a.width = Q(c * ca(f)) + Q(b * Y(f))),
                            (a.height = Q(c * Y(f)) + Q(b * ca(f)));
                }
                this.bBox = a;
            }
            return a;
    ...
    Ca.prototype = {
        ...
        init: function(a, b, c, d) {
            ...
            this.alignedObjects = [];
            this.url =
                (eb || db) && z.getElementsByTagName('base').length
                    ? e.href
                          .replace(/#.*?$/, '')
                          .replace(/([\('\)])/g, '\\$1')
                          .replace(/ /g, '%20')
            ...
            this.createElement('desc')
                .add()
                .element.appendChild(
                    z.createTextNode('Created with Highcharts 3.0.2')
                );
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            if (h)
                (g = this.path(h)),
                    v(g, { symbolName: a, x: b, y: c, width: d, height: e }),
                    f && v(g, f);
            else if (i.test(a))
                (k = function(a, b) {
                    a.element &&
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                a = o.element.style;
                w =
                    (Ma === void 0 || yb === void 0 || s.styles.textAlign) &&
                    o.getBBox();
                ...
                if (z) {
                    if (!B)
                        (a = t(-G * q)),
                            (b = h ? -A : 0),
                            (s.box = B = d
                                ? p.symbol(d, a, b, s.width, s.height)
                                : p.rect(a, b, s.width, s.height, 0, u[Pb])),
                            B.add(s);
                    B.isImg ||
                ...
                css: function(a) {
                    if (a) {
                        var b = {},
                            a = x(a);
                        n(
                            'fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration'.split(
                                ','
                            ),
                            function(c) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                ((f.getElementsByTagName('stroke')[0] ||
                                    U(i.prepVML(['<stroke/>']), null, null, f))[
                                    c
                                ] = d || 'solid'),
                                    (this.dashstyle = d),
                                    (l = !0);
                                ...
                                (this[c] = d),
                                    (f.style.left = -t(ca(d * bb) + 1) + 'px'),
                                    (f.style.top = t(Y(d * bb)) + 'px');
                            else if (
                                c === 'translateX' ||
                                c === 'translateY' ||
                                c === 'rotation'
                        ...
                        if (i === 'gradient')
                            ...
                            var j = l.r,
                                ...
                                j = function() {
                                    x &&
                                        ((u = d.getBBox()),
                                        (H += (x[0] - u.x) / u.width - 0.5),
                                        (C += (x[1] - u.y) / u.height - 0.5),
                                        (v *= x[2] / u.width),
                                        (P *= x[2] / u.height));
                                    q =
                                        'src="' +
                                        N.global.VMLRadialGradientURL +
                                        '" size="' +
                                        v +
                                        ',' +
                                        P +
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var f = a + c,
                        ...
                        h;
                    !r(e) || !e.r
                        ? (f = Ca.prototype.symbols.square.apply(0, arguments))
                        : ((h = K(e.r, c, d)),
                          (f = [
                              'M',
                              a + h,
    ...
    Ja.prototype = {
        addLabel: function() {
            var a = this.axis,
                ...
                d =
                    ...
                    (!d && (c.optionsMarginLeft || c.plotWidth / 2)),
                j = g === i[0],
                k = g === i[i.length - 1],
                f = e ? o(e[g], f && f[g], g) : g,
                e = this.label,
            ...
            a.isDatetimeAxis &&
                i &&
                (m = b.dateTimeLabelFormats[i.higherRanks[g] || i.unitName]);
            this.isFirst = j;
            this.isLast = k;
        ...
        handleOverflow: function(a, b) {
            ...
            if (f || g) {
                ...
                (f && !i) || (g && i)
                    ? h + m < e && ((h = e - m), d && h + k > j && (c = !1))
                    : h + k > l && ((h = l - k), d && h + m < j && (c = !1));
                b.x = h;
            }
            return c;
        },
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            ...
            r(e.y) ||
                (b += u(c.styles.lineHeight) * 0.9 - c.getBBox().height / 2);
            i && (b += ((g / (h || 1)) % i) * 16);
            return { x: a, y: b };
        },
        ...
        render: function(a, b, c) {
            ...
            if (l && w)
                r === 'inside' && (w = -w),
                    d.opposite && (w = -w),
                    (b = this.getMarkPath(H, P, w, l * C, g, f)),
                    p
                        ...
                        : (this.mark = f
                              ...
                              .add(d.axisGroup));
            if (i && !isNaN(H))
                (i.xy = P = this.getLabelPosition(H, P, i, g, k, u, a, t)),
                    (this.isFirst && !o(e.showFirstLabel, 1)) ||
                    (this.isLast && !o(e.showLastLabel, 1))
                        ? (v = !1)
                        : !x &&
                          g &&
                          k.overflow === 'justify' &&
                          !this.handleOverflow(a, P) &&
                          (v = !1),
                    t && a % t && (v = !1),
                    v && !isNaN(P.y)
                        ? ((P.opacity = c),
                          i[this.isNew ? 'attr' : 'animate'](P),
                          (this.isNew = !1))
                        : i.attr('y', -9999);
        },
        destroy: function() {
    ...
    pb.prototype = {
        render: function() {
            ...
            if (h) {
                if (
                    ((s = b.getPlotLinePath(m, h)),
                    (d = { stroke: B, 'stroke-width': h }),
                    l)
                )
                    d.dashstyle = l;
            } else if (k) {
            ...
            if (p)
                s
                    ? p.animate({ d: s }, null, p.onGetPath)
                    : (p.hide(),
    ...
    ab.prototype = {
        ...
        setOptions: function(a) {
            this.options = x(
                ...
                x(N[this.isXAxis ? 'xAxis' : 'yAxis'], a)
            );
        },
        update: function(a, b) {
            var c = this.chart,
                ...
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (((j = g.xData), j.length))
                            (a.dataMin = K(o(a.dataMin, j[0]), Ga(j))),
                                (a.dataMax = q(o(a.dataMax, j[0]), pa(j)));
                    } else {
                        var P,
                            H,
                            C,
                        ...
                        for (h = 0; h < v; h++) {
                            ...
                            if (
                                G !== null &&
                                G !== y &&
                                (!a.isLog || G.length || G > 0)
                            )
                                if (
                                    (E && (G = g.modifyValue(G)),
                                    g.getExtremesFromAll ||
                                        A ||
                                        ((j[h + 1] || w) >= z.min &&
                                            (j[h - 1] || w) <= z.max))
                                )
                        ...
                        if (!a.usePercentage && u.length)
                            (g.dataMin = k = Ga(u)),
                                (g.dataMax = g = pa(u)),
                                (a.dataMin = K(o(a.dataMin, k), k)),
                                (a.dataMax = q(o(a.dataMax, g), g));
                        if (r(t))
                            if (a.dataMin >= t)
        ...
        getPlotLinePath: function(a, b, c, d) {
            ...
            if (isNaN(a)) l = !0;
                ...
                ((c = f), (i = m - this.right), h < g || h > g + this.height)
            )
                l = !0;
            return l && !d
                ? null
        ...
        getLinearTickPositions: function(a, b, c) {
            for (
                var d, b = ia(T(b / a) * a), c = ia(ja(c / a) * a), e = [];
                b <= c;
        ...
        getLogTickPositions: function(a, b, c, d) {
            ...
            if (a >= 0.5)
                ...
                (a = ib(a, null, I.pow(10, T(I.log(a) / I.LN10)))),
                (g = La(this.getLinearTickPositions(a, b, c), ka)),
                !d)
            )
        ...
        getMinorTickPositions: function() {
            ...
            if (this.isLog) {
                ...
                for (a = 1; a < e; a++)
                    d = d.concat(
                        this.getLogTickPositions(c, b[a - 1], b[a], !0)
                    );
            } else if (this.isDatetimeAxis && a.minorTickInterval === 'auto')
                (d = d.concat(Cb(Ab(c), this.min, this.max, a.startOfWeek))),
                    d[0] < this.min && d.shift();
            else
                for (
                    b = this.min + ((b[0] - this.min) % c);
                    b <= this.max;
                    b += c
                )
                    d.push(b);
        ...
        adjustForMinRange: function() {
            ...
            if (c - b < this.minRange) {
                ...
                c = Ga(c);
                c - b < k &&
                    ((d[0] = c - k), (d[1] = o(a.min, c - k)), (b = pa(d)));
            }
            this.min = b;
            this.max = c;
        },
        ...
        setTickPositions: function(a) {
            ...
            h
                ? ((b.linkedParent = c[g ? 'xAxis' : 'yAxis'][d.linkedTo]),
                  ...
                  d.type !== b.linkedParent.options.type && qa(11, 1))
                : ((b.min = o(b.userMin, d.min, b.dataMin)),
                  (b.max = o(b.userMax, d.max, b.dataMax)));
            if (e)
                !a && K(b.min, o(b.dataMin, b.min)) <= 0 && qa(10, 1),
                    (b.min = ia(ka(b.min))),
                    (b.max = ia(ka(b.max)));
            if (
                b.range &&
                ((b.userMin = b.min = q(b.min, b.max - b.range)),
                (b.userMax = b.max),
                a)
            )
                b.range = null;
            ...
            if (
                !f &&
                !e &&
                ((a = I.pow(10, T(I.log(b.tickInterval) / I.LN10))), !m)
            )
            ...
            b.minorTickInterval =
                d.minorTickInterval === 'auto' && b.tickInterval
                    ? b.tickInterval / 5
                    : d.minorTickInterval;
            b.tickPositions = i = d.tickPositions
                ? [].concat(d.tickPositions)
                : i && i.apply(b, [b.min, b.max]);
            if (!i)
                (i = f
                    ? (b.getNonLinearTimeTicks || Cb)(
                          Ab(b.tickInterval, d.units),
                          b.min,
                          b.max,
                          d.startOfWeek,
                          b.ordinalPositions,
            ...
            if (!h)
                (e = i[0]),
                    ...
                    i.length === 1 && ((b.min -= 0.001), (b.max += 0.001));
        },
        ...
        zoom: function(a, b) {
            this.allowZoomOutside ||
                (a <= this.dataMin && (a = y), b >= this.dataMax && (b = y));
        ...
        render: function() {
            var a = this,
                ...
                o = d.lineWidth,
                B,
                w = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin);
            B = a.hasData;
            var q = a.showAxis,
                t,
                v;
                    ...
                    g.length &&
                        (n(g.slice(1).concat([g[0]]), function(b, c) {
                            ...
                            if (!f || (b >= a.min && b <= a.max))
                                j[b] || (j[b] = new Ja(a, b)),
                                    w && j[b].isNew && j[b].render(c, !0),
                                    j[b].render(c, !1, 1);
                        }),
                        s &&
                            a.min === 0 &&
                            (j[-1] || (j[-1] = new Ja(a, -1, null, !0)),
                            j[-1].render(-1))),
                    p &&
                        n(g, function(b, c) {
                            if (c % 2 === 0 && b < a.max)
            ...
            if (l && l.enabled) {
                ...
                for (u in i) for (x in ((c = i[u]), c)) c[x].render(d);
            }
            a.isDirty = !1;
        },
    ...
    qb.prototype = {
        ...
        getAnchor: function(a, b) {
            ...
            this.followPointer &&
                b &&
                (b.chartX === y && (b = d.pointer.normalize(b)),
        ...
        getPosition: function(a, b, c) {
            ...
            d < 7 && (d = e + q(j, 0) + i);
            d + a > e + g &&
                ((d -= d + a - (e + g)), (k = c - b + f - i), (m = !0));
            k < f + 5 &&
                ((k = f + 5), m && c >= k && c <= k + b && (k = c + f + i));
        ...
        refresh: function(a, b) {
            ...
            f = g[0];
            g = g[1];
            h && (!a.series || !a.series.noSharedTooltip)
                ? ((c.hoverPoints = a),
                  i &&
                      n(i, function(a) {
                          a.setState();
            ...
            h =
                h ||
                !i.isCartesian ||
                i.tooltipOutsidePlot ||
                c.isInsidePlot(f, g);
            j === !1 || !h
                ? this.hide()
                : (this.isHidden && (Ta(d), d.attr('opacity', 1).show()),
                  d.attr({ text: j }),
    ...
    rb.prototype = {
            ...
            if (
                ...
                for (i = 0; i < h; i++)
                    if (
                        ...
                        ((b = c[i].tooltipPoints[k]), b.series)
                    )
                        (b._dist = Q(k - b.clientX)),
                            (j = K(j, b._dist)),
                            e.push(b);
        ...
        scaleGroups: function(a, b) {
            ...
            n(c.series, function(d) {
                d.xAxis &&
                    ...
                    (d.group.attr(a),
                    d.markerGroup &&
                        (d.markerGroup.attr(a),
                        d.markerGroup.clip(b ? c.clipRect : null)),
                    d.dataLabelsGroup && d.dataLabelsGroup.attr(a));
            });
        ...
        pinch: function(a) {
            ...
            if (a.type === 'touchstart')
                ...
                if (!m) b.selectionMarker = m = v({ destroy: ta }, c.plotBox);
        ...
        drop: function(a) {
            ...
            if (b)
                L(b.container, { cursor: b._cursor }),
        ...
        onDocumentMouseMove: function(a) {
            ...
            c &&
                ...
                d.isCartesian &&
                !b.isInsidePlot(
                    a.pageX - c.left - b.plotLeft,
                    a.pageY - c.top - b.plotTop
                ) &&
                this.reset();
        },
    ...
    sb.prototype = {
        ...
        renderItem: function(a) {
            ...
            d = n.getBBox();
            (w = a.legendItemWidth =
                e.itemWidth || g + h + d.width + k + (v ? 20 : 0)),
                (e = w);
            b.itemHeight = g = d.height;
            if (f && b.itemX - o + e > (l || c.chartWidth - 2 * k - o))
                (b.itemX = o),
                    (b.itemY += s + b.lastLineHeight + p),
                    (b.lastLineHeight = 0);
            ...
            f
                ? (b.itemX += e)
                : ((b.itemY += s + g + p), (b.lastLineHeight = g));
        ...
        render: function() {
            ...
            if (m || l) {
                ...
                if (i) {
                    ...
                    (a.box = i = c
                        .rect(0, 0, g, h, j.borderRadius, m || 0)
                        .attr({
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && !e.useHTML) {
                ...
                this.fullHeight = a;
                if (!h)
                    (h = b.clipRect = d.clipRect(0, 0, 9999, 0)),
        ...
        scroll: function(a, b) {
            ...
            if (d > 0)
                b !== y && Ia(b, this.chart),
                    ...
                    (e = -K(e * (d - 1), this.fullHeight - e + i) + 1),
    ...
    tb.prototype = {
            ...
            if (f.display && !l.floating)
                if (B === 'right') {
                    ...
                    if (!r(g))
                        this.plotTop = q(
                            this.plotTop,
                            f.legendHeight + t + p + b
                        );
                } else if (w === 'bottom' && !r(j))
                    this.marginBottom = q(
                        this.marginBottom,
                        f.legendHeight - t + p + d
                    );
        ...
        drawChartBox: function() {
            ...
            if (m)
                h
                    ? h.animate(r)
                    : (this.plotBGImage = b.image(m, o, n, t, q).add());
            v
                ? v.animate({ width: u.width, height: u.height })
                : (this.clipRect = b.clipRect(u));
            if (l)
                g
                    ? g.animate(g.crisp(null, o, n, t, q))
                    : (this.plotBorder = b
                          .rect(o, n, t, q, 0, l)
                          .attr({
        ...
        isReadyToRender: function() {
            var a = this;
            return (!Z && O == O.top && z.readyState !== 'complete') ||
                ($ && !O.canvg)
                ? ($
                      ? Rb.push(function() {
                            a.firstRender();
                ...
                if (this.graphic)
                    ...
                    if (a && h)
                        (e = h.radius),
                            ...
                            j
                                ? j.attr({ x: b - e, y: c - e })
                                : ((d.stateMarkerGraphic = j = m.renderer
    ...
    R.prototype = {
        ...
        addPoint: function(a, b, c, d) {
            ...
            c &&
                (f[0] && f[0].remove
                    ? f[0].remove(!1)
                    : (f.shift(), j.shift(), k.shift(), m.shift(), n.shift()));
            this.getAttribs();
        ...
        generatePoints: function() {
            ...
            for (l = 0; l < g; l++)
                (i = h + l),
                    j
                        ? (m[l] = new f().init(this, [d[l]].concat(ha(e[l]))))
                        : (b[i]
                              ? (k = b[i])
                              : a[i] !== y &&
                                (b[i] = k = new f().init(this, a[i], d[l])),
                          (m[l] = k));
            if (b && (g !== (c = b.length) || j))
                for (l = 0; l < c; l++)
                    if ((l === h && !j && (l += g), b[l]))
            ...
            if (m.enabled || this._hasPointMarkers)
                for (f = b.length; f--; )
                    if (
                        ...
                        (k = g.graphic),
                        (i = g.marker || {}),
                        (a = (m.enabled && i.enabled === y) || i.enabled),
                        (l = c.isInsidePlot(t(d), e, c.inverted)),
                        a && e !== y && !isNaN(e) && g.y !== null)
                    )
                        if (
        ...
        getAttribs: function() {
            ...
            for (g = i.length; g--; ) {
                ...
                if (h.options) for (p in m) r(c[m[p]]) && (f = !0);
                if (f) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
                    ...
                    if (h.negative && b.marker && l)
                        k[
                            ''
                        ].fill = k.hover.fill = k.select.fill = a.convertAttribs(
                            { fillColor: l }
                        ).fill;
                } else k = j;
                h.pointAttr = k;
        ...
        clipNeg: function() {
            ...
            if (d && (f || g))
                (d = ja(
                    this.yAxis.len - this.yAxis.translate(a.threshold || 0)
                )),
                    (a = { x: 0, y: 0, width: k, height: d }),
                    (k = { x: 0, y: d, width: k, height: k - d }),
                    b.inverted &&
                        c.isVML &&
                        ((a = {
                    ...
                    h
                        ...
                        : ((this.posClip = h = c.clipRect(b)),
                          ...
                          f && (f.clip(h), this.graphNeg.clip(i)),
        ...
        setVisible: function(a, b) {
            var c = this,
                ...
                h = c.visible;
            f = (c.visible = a = c.userOptions.visible = a === y ? !h : a)
                ? 'show'
                : 'hide';
            n(['group', 'dataLabelsGroup', 'markerGroup', 'tracker'], function(
                a
            ) {
                if (c[a]) c[a][f]();
            });
        ...
        drawTracker: function() {
            ...
            if (e && !c)
                for (l = e + 1; l--; )
                    d[l] === 'M' &&
                        d.splice(l + 1, 0, d[l + 1] - i, d[l + 2], 'L'),
                        ((l && d[l] === 'M') || l === e) &&
                            d.splice(l, 0, 'L', d[l - 2] + i, d[l - 1]);
    ...
    M = ea(R, {
        ...
        drawGraph: function() {
            ...
            c.negativeColor &&
                d.push(['areaNeg', c.negativeColor, c.negativeFillColor]);
            n(d, function(d) {
                var f = d[0],
                    g = a[f];
                g
    ...
    F = ea(R, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i > a && i > e
                    ? ((i = q(a, e)), (k = 2 * e - i))
                    : i < a && i < e && ((i = K(a, e)), (k = 2 * e - i));
                k > g && k > e
                    ? ((k = q(g, e)), (i = 2 * e - k))
                    : k < g && k < e && ((k = K(g, e)), (i = 2 * e - k));
                b.rightContX = j;
                b.rightContY = k;
            }
            c
    ...
    F = ea(R, {
            ...
            n(a.points, function(c) {
                ...
                Q(l) < h &&
                    ...
                    (t =
                        Q(t - g) > h
                            ? n - h
                            : g - (f.translate(c.y, 0, 1, 0, 1) <= g ? h : 0)));
                c.barX = s;
                c.pointWidth = i;
                c.shapeType = 'rect';
                c.shapeArgs = c = b.renderer.Element.prototype.crisp.call(
                    0,
                    e,
                    s,
                    t,
        ...
        alignDataLabel: function(a, b, c, d, e) {
            var f = this.chart,
                ...
                i =
                    a.below ||
                    a.plotY > o(this.translatedThreshold, f.plotSizeY),
        ...
        animate: function(a) {
            ...
            if (Z)
                a
                    ? ((e.scaleY = 0.001),
                      (a = K(b.pos + b.len, q(b.pos, b.toPixels(c.threshold)))),
    ...
    W = {
        ...
        translate: function(a) {
            ...
            var b = 0,
                ...
                h,
                i,
                j = (this.startAngleRad =
                    (Ka / 180) * (((d.startAngle || 0) % 360) - 90)),
                k = this.points,
                m = 2 * Ka,
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                for (H = 0; !x && b[H]; )
                    (x =
                        b[H] &&
                        b[H].dataLabel &&
                        (b[H].dataLabel.getBBox().height || 21)),
                        H++;
                for (H = 2; H--; ) {
                    var b = [],
                        L = [],
        ...
        verifyDataLabelOverflow: function(a) {
            ...
            d[0] !== null
                ? (e = q(b[2] - q(a[1], a[3]), c))
                : ((e = q(b[2] - a[1] - a[3], c)), (b[0] += (a[3] - a[1]) / 2));
            d[1] !== null
                ? (e = q(K(e, b[2] - q(a[0], a[2])), c))
                : ((e = q(K(e, b[2] - a[0] - a[2]), c)),
                  (b[1] += (a[0] - a[2]) / 2));
            e < b[2]
                ? ((b[2] = e),
                  this.translate(b),
