            ...
            return (
                ...
                this.each(function() {
                    var h,
                        ...
                        y = s(this, 'marginLeft'),
                        k = s(this, 'marginTop'),
                        D = c + y + s(this, 'marginRight') + b.width,
            ...
            flip: {
                left: function(e, t) {
                    var i,
                        ...
                        f = -2 * t.offset[0];
                    0 > u
                        ? ((i = e.left + d + p + f + t.collisionWidth - r - a),
                    ...
                    this.headers
                        ...
                        .each(function(e) {
                            var s = t(this),
                                ...
                                a = s.next(),
                                o = a.attr('id');
                            n || ((n = i + '-header-' + e), s.attr('id', n)),
                                o || ((o = i + '-panel-' + e), a.attr('id', o)),
        ...
        t.uiBackCompat !== !1 &&
                        ...
                        a &&
                            s.add(n).each(function(i) {
                                return t.contains(this, a)
                                    ? ((e.options.active = Math.floor(i / 2)),
                                      !1)
                                    : undefined;
                            });
                    }
            ...
            (function(t, e) {
                ...
                e._findActive = function(t) {
                    return (
                        ...
                        t &&
                            'number' != typeof t &&
                            ((t = this.headers.index(this.headers.filter(t))),
                            -1 === t && (t = !1)),
                        i.call(this, t)
                    );
                };
            ...
            (function(t, e) {
                ...
                e._create = function() {
                    var t = this.options;
                    null === t.animate &&
                        (t.animate = t.animated
                            ? 'slide' === t.animated
                                ? 300
                                : 'bounceslide' === t.animated
                                    ? {
                                          duration: 200,
                                          down: {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _autoSize: function(t) {
            if (this._get(t, 'autoSize') && !t.inline) {
                ...
                if (i.match(/[DM]/)) {
                    var s = function(t) {
                        for (var e = 0, i = 0, s = 0; t.length > s; s++)
                            t[s].length > e && ((e = t[s].length), (i = s));
                        return i;
                    };
                    e.setMonth(
                        s(
            ...
            return (
                ...
                (e.left -=
                    i && e.left == t.input.offset().left
                        ...
                        : 0),
                (e.top -=
                    i && e.top == t.input.offset().top + o
                        ? $(document).scrollTop()
                        : 0),
                (e.left -= Math.min(
                    e.left,
                    e.left + s > r && r > s ? Math.abs(e.left + s - r) : 0
                )),
                (e.top -= Math.min(
                    e.top,
                    e.top + n > h && h > n ? Math.abs(n + o) : 0
                )),
                e
            );
        },
        ...
        _hideDatepicker: function(t) {
            ...
            if (
                ...
                $.effects && ($.effects.effect[i] || $.effects[i])
                    ? e.dpDiv.hide(i, $.datepicker._get(e, 'showOptions'), s, n)
                    : e.dpDiv[
                          'slideDown' == i
                              ? 'slideUp'
                              : 'fadeIn' == i
        ...
        _selectDate: function(t, e) {
            ...
            n
                ? n.apply(s.input ? s.input[0] : null, [e, s])
        ...
        parseDate: function(t, e, i) {
            ...
            for (
                var n =
                    ...
                    d = !1,
                    p = function(e) {
                        var i = t.length > _ + 1 && t.charAt(_ + 1) == e;
                        return i && _++, i;
                    },
                    f = function(t) {
                        var i = p(t),
                    ...
                    m = function(t, i, s) {
                        ...
                        if (
                            ($.each(n, function(t, i) {
                                var s = i[1];
                                return e.substr(v, s.length).toLowerCase() ==
                                    s.toLowerCase()
                                    ? ((a = i[0]), (v += s.length), !1)
                                    : undefined;
                            }),
        ...
        _generateHTML: function(t) {
            ...
            var b = this._canAdjustMonth(t, 1, f, p)
                ...
                x = this._get(t, 'gotoCurrent') && t.currentDay ? u : e;
            y = a ? this.formatDate(y, x, this._getFormatConfig(t)) : y;
            var w = t.inline
                    ? ''
            ...
            for (
                var H = this._getDefaultDate(t), z = '', E = 0;
                o[0] > E;
                E++
            ) {
                var F = '';
                ...
                for (var W = 0; o[1] > W; W++) {
                    var O = this._daylightSavingAdjust(
                            new Date(f, p, t.selectedDay)
                        ),
                        L = ' ui-corner-all',
                        j = '';
                    if (l) {
                        if (
                            ((j += '<div class="ui-datepicker-group'), o[1] > 1)
                        )
                            switch (W) {
                                case 0:
                    ...
                    j +=
                        ...
                        L +
                        '">' +
                        (/all|left/.test(L) && 0 == E ? (i ? b : v) : '') +
                        (/all|right/.test(L) && 0 == E ? (i ? v : b) : '') +
                    ...
                    f == t.selectedYear &&
                        p == t.selectedMonth &&
                        (t.selectedDay = Math.min(t.selectedDay, J));
                    var K = (this._getFirstDayOfMonth(f, p) - D + 7) % 7,
                        q = Math.ceil((K + J) / 7),
                        V = l ? (this.maxRows > q ? this.maxRows : q) : q;
                    this.maxRows = V;
                    for (
                        ...
                        for (
                            ...
                            var X = P
                                    ? P.apply(t.input ? t.input[0] : null, [U])
                                    : [!0, ''],
                                Z = U.getMonth() != p,
                                te =
                                    (Z && !A) ||
