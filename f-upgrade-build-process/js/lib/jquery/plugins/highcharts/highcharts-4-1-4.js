...
(function() {
    ...
    function Cb() {
        ...
        gb = function(a, c, d, h, i, j) {
            var k;
            b
                ? ((k = Aa.UTC.apply(0, arguments)), (k += Wa(k)))
                : (k = new Aa(
                      a,
                      c,
                      p(d, 1),
    ...
    function Hb(a, b, c, d, e) {
        ...
        this.alignOptions = {
            ...
            verticalAlign:
                b.verticalAlign || (f ? 'middle' : c ? 'bottom' : 'top'),
            y: p(b.y, f ? 4 : c ? 14 : -6),
            x: p(b.x, f ? (c ? -6 : 6) : 0),
        };
    ...
    var u,
        ...
        ba =
            !!A.createElementNS && !!A.createElementNS(Ca, 'svg').createSVGRect,
    ...
    w.numberFormat = function(a, b, c, d) {
        var e = P.lang,
            ...
            f =
                b === -1
                    ? I((a.toString().split('.')[1] || '').length, 20)
                    : isNaN((b = O(b)))
                        ? 2
                        : b,
                        ...
                        if (this[0]) {
                            ...
                            if (c !== u)
                                (c.chart = c.chart || {}),
                                    ...
                                    (g = this);
                            c === u &&
                                (g = X[L(this[0], 'data-highcharts-chart')]);
                        }
                        return g;
                    };
                },
    ...
    P = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL:
                'http://code.highcharts.com/4.1.5/modules/canvas-tools.js',
            VMLRadialGradientURL:
                'http://code.highcharts.com/4.1.5/gfx/vml-radial-gradient.png',
        },
        chart: {
            borderColor: '#4572A7',
            borderRadius: 0,
            ...
            (function(a) {
                a && a.stops
                    ...
                    : (c = Tb.exec(a))
                        ...
                        : (c = Ub.exec(a))
                            ? (b = [B(c[1], 16), B(c[2], 16), B(c[3], 16), 1])
                            : (c = Vb.exec(a)) &&
                              (b = [B(c[1]), B(c[2]), B(c[3]), 1]);
            })(a);
            return {
                get: function(c) {
                    var f;
    ...
    K.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (typeof a === 'string')
                g = (this[a + 'Getter'] || this._defaultGetter).call(
                    this,
                    a,
                    e
                );
                ...
                for (c in a) {
                    ...
                    if (this.rotation && (c === 'x' || c === 'y'))
                        this.doTransform = !0;
                    h ||
                        (this[c + 'Setter'] || this._defaultSetter).call(
                            this,
                            d,
                            c,
                            e
            ...
            ab && a === 'click'
                ? ((d.ontouchstart = function(a) {
                  ...
                  (d.onclick = function(a) {
                      (Ba.indexOf('Android') === -1 ||
                          Aa.now() - (c.touchEventFired || 0) > 1100) &&
                          b.call(d, a);
                  }))
                : (d['on' + a] = b);
            return this;
        ...
        getBBox: function(a) {
            ...
            var i,
                ...
                l;
            d !== u &&
                ((l = ['', e || 0, g && g.fontSize, f.style.width].join(',')),
                (l =
                    d === '' || Ob.test(d)
                        ? 'num:' + d.toString().length + l
                        : d + l));
            l && !a && (b = c.cache[l]);
            if (!b) {
        ...
        show: function(a) {
            a && this.element.namespaceURI === Ca
    ...
    K.prototype.translateXSetter = K.prototype.translateYSetter = K.prototype.rotationSetter = K.prototype.verticalAlignSetter = K.prototype.scaleXSetter = K.prototype.scaleYSetter = function(
        a,
        b
    ) {
        this[b] = a;
    ...
    K.prototype['stroke-widthSetter'] = K.prototype.strokeSetter = function(
        a,
        b,
        c
    ) {
    ...
    ta.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.alignedObjects = [];
            this.url =
                (La || xb) && A.getElementsByTagName('base').length
                    ? f.href
                          .replace(/#.*?$/, '')
                          .replace(/([\('\)])/g, '\\$1')
                          .replace(/ /g, '%20')
            ...
            this.createElement('desc')
                .add()
                .element.appendChild(
                    A.createTextNode('Created with Highcharts 4.1.5')
                );
        ...
        buildText: function(a) {
            for (
                var b = a.element,
                    ...
                    n = k && k.lineHeight,
                    o = k && k.textShadow,
                    q = k && k.textOverflow === 'ellipsis',
                    y = g.length,
                    S = l && !a.added && this.box,
                    C = function(a) {
                        return n
                            ? B(n)
                            : c.fontMetrics(
                ...
                b.removeChild(g[y]);
            !f && !o && !q && e.indexOf(' ') === -1
                ? b.appendChild(A.createTextNode(v(e)))
                : ((h = /<.*style="([^"]+)".*>/),
                  (i = /<.*href="(http[^"]+)".*>/),
                  S && S.appendChild(b),
                  (e = f
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            N(j.element, ya ? 'mouseout' : 'mouseleave', function() {
                k !== 3 &&
                    ((l = [e, f, g][k]), (n = [o, q, y][k]), j.attr(l).css(n));
            });
            ...
            if (h)
                ...
                (k = function(a, b) {
                    a.element &&
                        ...
                        a.alignByTranslate ||
                            a.translate(x((d - b[0]) / 2), x((e - b[1]) / 2)));
                }),
                    (j = a.match(i)[1]),
                    (a =
                        Kb[j] ||
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                a = q.element.style;
                p =
                    (fa === void 0 || t === void 0 || o.styles.textAlign) &&
                    s(q.textStr) &&
                    q.getBBox();
                ...
                if (D) {
                    if (!y)
                        (a = x(-C * v)),
                            (b = h ? -I : 0),
                            (o.box = y = d
                                ? n.symbol(d, a, b, o.width, o.height, E)
                                : n.rect(a, b, o.width, o.height, 0, E[Pb])),
                            y.attr('fill', R).add(o);
                    y.isImg ||
                        y.attr(
                            r({ width: x(o.width), height: x(o.height) }, E)
                        );
                    E = null;
                }
            }
    ...
    r(K.prototype, {
        ...
        setSpanRotation: function(a, b, c) {
            ...
            d[e + (La ? 'Origin' : '-origin')] = d.transformOrigin =
                b * 100 + '% ' + c + 'px';
            F(this.element, d);
        },
    ...
    if (!ba && !ea) {
        D = {
            ...
            dashstyleSetter: function(a, b, c) {
                (c.getElementsByTagName('stroke')[0] ||
                    Z(this.renderer.prepVML(['<stroke/>']), null, null, c))[b] =
                    a || 'solid';
                this[b] = a;
            },
            dSetter: function(a, b, c) {
        ...
        D.prototype.ySetter = D.prototype.widthSetter = D.prototype.heightSetter =
            D.prototype.xSetter;
        var Na = {
            Element: D,
            ...
            init: function(a, b, c, d) {
                var e;
                this.alignedObjects = [];
                d = this.createElement(Ka).css(
                    r(this.getStyle(d), { position: 'relative' })
                );
                e = d.element;
                        ...
                        if (i === 'gradient')
                            ...
                            var j = n.r,
                                ...
                                j = function() {
                                    z &&
                                        ((w = d.getBBox()),
                                        (r += (z[0] - w.x) / w.width - 0.5),
                                        (E += (z[1] - w.y) / w.height - 0.5),
                                        (u *= z[2] / w.width),
                                        (x *= z[2] / w.height));
                                    v =
                                        'src="' +
                                        P.global.VMLRadialGradientURL +
                                        '" size="' +
                                        u +
                                        ',' +
                                        x +
            ...
            createElement: function(a) {
                return a === 'rect'
                    ? this.symbol(a)
                    : ta.prototype.createElement.call(this, a);
            },
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    return ta.prototype.symbols[
                        !s(e) || !e.r ? 'square' : 'callout'
                    ].call(0, a, b, c, d, e);
                },
            },
        };
    ...
    Ta.prototype = {
        addLabel: function() {
            ...
            a.isDatetimeAxis &&
                h &&
                (k = b.dateTimeLabelFormats[h.higherRanks[f] || h.unitName]);
            this.isFirst = i;
            this.isLast = j;
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            var i = this.axis,
                ...
                k = i.reversed,
                l = i.staggerLines,
                n = i.tickRotCorr || { x: 0, y: 0 },
                c = p(
                    e.y,
                    n.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))
                ),
                ...
                s === 'inside' && (C = -C),
                    ...
                    o
                        ...
                        : (this.mark = f
                              ...
                              .add(d.axisGroup));
            if (i && !isNaN(w))
                (i.xy = r = this.getLabelPosition(w, r, i, g, k, x, a, fa)),
                    (this.isFirst && !this.isLast && !p(e.showFirstLabel, 1)) ||
                    (this.isLast && !this.isFirst && !p(e.showLastLabel, 1))
                        ? (t = !1)
                        : g &&
                          !d.isRadial &&
                          !k.step &&
                          ...
                          !b &&
                          c !== 0 &&
                          this.handleOverflow(r),
                    fa && a % fa && (t = !1),
                    t && !isNaN(r.y)
                        ? ((r.opacity = c),
                          i[this.isNew ? 'attr' : 'animate'](r),
                          (this.isNew = !1))
                        : i.attr('y', -9999);
        },
        destroy: function() {
    ...
    w.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (g) {
                if (
                    ((o = b.getPlotLinePath(k, g)),
                    (v = { stroke: y, 'stroke-width': g }),
                    l)
                )
                    v.dashstyle = l;
            } else if (j) {
            ...
            if (s(p)) v.zIndex = p;
            if (n)
                if (o) n.animate({ d: o }, null, n.onGetPath);
                else {
                    if (
                        (n.hide(),
    ...
    va.prototype = {
        ...
        init: function(a, b) {
            ...
            this.crosshair = p(
                d.crosshair,
                ra(a.options.tooltip.crosshairs)[c ? 0 : 1],
                !1
            );
            var f,
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (((d = c.xData), d.length))
                            (a.dataMin = I(p(a.dataMin, d[0]), Pa(d))),
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            isNaN(e)
                ...
                : this.horiz
                    ? ((i = h),
                      (j = k - this.bottom),
                      (a = c = o(a, g, g + this.width)))
                    : ((a = g),
                      (c = l - this.right),
                      (i = j = o(i, h, h + this.height)));
            return n && !d
                ? null
                : f.renderer.crispLine(['M', a, i, 'L', c, j], b || 1);
        },
        ...
        getMinorTickPositions: function() {
            ...
            if (g && g / c < this.len / 3)
                if (this.isLog) {
                    ...
                    for (e = 1; e < a; e++)
                        d = d.concat(
                            this.getLogTickPositions(c, b[e - 1], b[e], !0)
                        );
                } else if (
                    this.isDatetimeAxis &&
        ...
        adjustForMinRange: function() {
            ...
            if (c - b < this.minRange) {
                ...
                c = Pa(c);
                c - b < k &&
                    ((d[0] = c - k), (d[1] = p(a.min, c - k)), (b = Fa(d)));
            }
            this.min = b;
            this.max = c;
        },
        ...
        setTickInterval: function(a) {
            ...
            h
                ...
                : ((b.min = p(b.userMin, d.min, b.dataMin)),
                  (b.max = p(b.userMax, d.max, b.dataMax)));
            if (e)
                !a && I(b.min, p(b.dataMin, b.min)) <= 0 && ka(10, 1),
                    (b.min = da(Ea(b.min))),
                    (b.max = da(Ea(b.max)));
            if (b.range && s(b.max))
                (b.userMin = b.min = t(b.min, b.max - b.range)),
                    (b.userMax = b.max),
                    (b.range = null);
            ...
            b.tickInterval =
                b.min === b.max || b.min === void 0 || b.max === void 0
                    ? 1
                    : h && !k && l === b.linkedParent.options.tickPixelInterval
                        ? b.linkedParent.tickInterval
                        : p(
                              k,
                              this.tickAmount
                                  ? (b.max - b.min) / t(this.tickAmount - 1, 1)
                                  : void 0,
                              n ? 1 : ((b.max - b.min) * l) / t(b.len, l)
                          );
            g &&
                !a &&
                m(b.series, function(a) {
        ...
        setTickPositions: function() {
            ...
            this.minorTickInterval =
                a.minorTickInterval === 'auto' && this.tickInterval
                    ? this.tickInterval / 5
                    : a.minorTickInterval;
            this.tickPositions = b = a.tickPositions && a.tickPositions.slice();
            if (
                !b &&
                ((this.tickPositions = b = this.isDatetimeAxis
                    ? this.getTimeTicks(
        ...
        getTickAmount: function() {
            ...
            !d &&
                ...
                c.alignTicks !== !1 &&
                (m(this.chart[this.coll], function(c) {
                    var d = c.options,
                        c = c.horiz,
                        d = [
                            c ? d.left : d.top,
        ...
        zoom: function(a, b) {
            ...
            this.allowZoomOutside ||
                (s(c) && a <= I(c, p(e.min, c)) && (a = u),
                s(d) && b >= t(d, p(e.max, d)) && (b = u));
        ...
        unsquish: function() {
            var a = this.ticks,
                ...
                g,
                h = b.rotation,
                i = this.chart.renderer.fontMetrics(
                    b.style.fontSize,
                    a[0] && a[0].label
                ),
                j,
            ...
            var a = this.chart,
                ...
                h = (this.slotWidth =
                    (f &&
                        !e.step &&
                        !e.rotation &&
                        ((this.staggerLines || 1) * a.plotWidth) / c.length) ||
                    (!f &&
                        ((g[3] && g[3] - a.spacing[3]) ||
                            a.chartWidth * 0.33))),
            ...
            if (this.autoRotation)
                ...
                for (h = c.length; !f && h--; )
                    if (((i = c[h]), (i = d[i].label)))
                        if (
                            (i.styles.textOverflow === 'ellipsis' &&
                                i.css({ textOverflow: 'clip' }),
                            i.getBBox().height >
                                this.len / c.length - (g.h - g.f))
                        )
        ...
        getOffset: function() {
            ...
            if (!a.axisGroup)
                (a.gridGroup = c
                    ...
                    (a.labelGroup = c
                        .g('axis-labels')
                        .attr({ zIndex: y.zIndex || 7 })
                        .addClass(
                            'highcharts-' + a.coll.toLowerCase() + '-labels'
                        )
                        .add());
            if (j || a.isLinked) {
                if (
            ...
            if (q && q.text && q.enabled !== !1) {
                if (!a.axisTitle)
                    (a.axisTitle = c
                        ...
                        .addClass(
                            'highcharts-' + this.coll.toLowerCase() + '-title'
                        )
                        .css(q.style)
                        .add(a.axisGroup)),
                        (a.axisTitle.isNew = !0);
        ...
        render: function() {
            ...
            if (y || f) {
                a.minorTickInterval &&
                    !a.categories &&
                    m(a.getMinorTickPositions(), function(b) {
                ...
                n &&
                    m(g, function(b, c) {
                        if (c % 2 === 0 && b < a.max)
                            k[b] || (k[b] = new w.PlotLineOrBand(a)),
                                (v = b + o),
                ...
                if (!a._addedPlotLB)
                    m((d.plotLines || []).concat(d.plotBands || []), function(
                        b
                    ) {
        ...
        drawCrosshair: function(a, b) {
            ...
            if (!this.crosshair || (s(b) || !p(this.crosshair.snap, !0)) === !1)
                ...
                (p(d.snap, !0)
                    ? s(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY)
                    : (c = this.horiz
                          ? a.chartX - this.pos
                          : this.len - a.chartY + this.pos),
                (c = this.isRadial
                    ? this.getPlotLinePath(
                          this.isXAxis ? b.x : p(b.stackY, b.y)
                      ) || null
                    : this.getPlotLinePath(null, null, null, null, c) || null),
                c === null)
            )
                this.hideCrosshair();
            else if (this.cross)
    ...
    va.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (s(b)) {
            ...
            j >= G.month &&
                (i[vb](j >= G.year ? 0 : k * U(i[Ya]() / k)), (h = i[Za]()));
            j >= G.year && ((h -= h % k), i[wb](h));
            if (j === G.week) i[ub](i[Xa]() - i[tb]() + p(d, 1));
            b = 1;
            if (nb || eb) (i = i.getTime()), (i = new Aa(i + Wa(i)));
            h = i[Za]();
            for (
                var d = i.getTime(),
                    l = i[Ya](),
                    n = i[Xa](),
                    o =
                        (G.day + (g ? Wa(i) : i.getTimezoneOffset() * 6e4)) %
                        G.day;
                d < c;
    ...
    va.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) (a = x(a)), (g = this.getLinearTickPositions(a, b, c));
            ...
            (a = pb(a, null, ob(a))),
            (g = Ua(this.getLinearTickPositions(a, b, c), Ea)),
            !d)
        )
    ...
    Mb.prototype = {
        ...
        getAnchor: function(a, b) {
            ...
            this.followPointer &&
                b &&
                (b.chartX === u && (b = d.pointer.normalize(b)),
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                g = c.h,
                h,
                i = ['y', d.chartHeight, b, c.plotY + d.plotTop],
                j = ['x', d.chartWidth, a, c.plotX + d.plotLeft],
                k = p(
                    c.ttBelow,
                    (d.inverted && !c.negative) || (!d.inverted && c.negative)
                ),
                l = function(a, b, c, d) {
                    var h = c < d - e,
                        i = d + e + c < b,
        ...
        refresh: function(a, b) {
            ...
            i === !1
                ? this.hide()
                : (this.isHidden && (db(d), d.attr('opacity', 1).show()),
                  d.attr({ text: i }),
        ...
        getXDateFormat: function(a, b, c) {
            ...
            if (e) {
                ...
                for (f in G) {
                    if (
                        e === G.week &&
                        +Oa('%w', a.x) === c.options.startOfWeek &&
                        ...
                        g[f] &&
                        h.substr(g[f]) !== '01-01 00:00:00.000'.substr(g[f])
                    )
                        break;
                    f !== 'week' && (i = f);
                }
    ...
    Va.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (n && (n !== f || (d && d.isHidden)))
                if (e && !n.series.noSharedTooltip) {
                    for (h = l.length; h--; )
                        (l[h].clientX !== n.clientX ||
                            l[h].series.noSharedTooltip) &&
                            l.splice(h, 1);
                ...
                (c = g && g.tooltipOptions.followPointer),
                    d &&
                        ...
                        !d.isHidden &&
                        ((c = d.getAnchor([{}], a)),
                        d.updatePosition({ plotX: c[0], plotY: c[1] }));
            ...
            if (a)
                f.refresh(g),
                    e &&
                        ...
                        m(c.axes, function(b) {
                            p(
                                b.options.crosshair && b.options.crosshair.snap,
                                !0
                            )
                                ? b.drawCrosshair(null, a)
                                : b.hideCrosshair();
                        }));
            else {
                if (e) e.onMouseOut();
        ...
        destroy: function() {
            ...
            bb ||
                (Y(A, 'mouseup', this.onDocumentMouseUp),
                Y(A, 'touchend', this.onDocumentTouchEnd));
    ...
    if (H.PointerEvent || H.MSPointerEvent) {
        ...
        r(Va.prototype, {
            ...
            batchMSEvents: function(a) {
                ...
                a(
                    this.chart.container,
                    Ab ? 'pointermove' : 'MSPointerMove',
                    this.onContainerPointerMove
                );
                a(
                    A,
                    Ab ? 'pointerup' : 'MSPointerUp',
        ...
        cb(Va.prototype, 'init', function(a, b, c) {
            a.call(this, b, c);
            this.hasZoom &&
                F(b.container, { '-ms-touch-action': R, 'touch-action': R });
        });
    ...
    mb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!m) {
                ...
                a.legendItem = m = c
                    ...
                    .add(a.legendGroup);
                if (!this.baseline)
                    (this.fontMetrics = c.fontMetrics(h.fontSize, m)),
            ...
            e
                ? (this.itemX += f)
                : ((this.itemY += q + g + o), (this.lastLineHeight = g));
            this.offsetWidth =
                n || t((e ? this.itemX - y - k : f) + j, this.offsetWidth);
        },
        getAllItems: function() {
            ...
            m(this.chart.series, function(b) {
                ...
                if (p(c.showInLegend, !s(c.linkedTo) ? u : !1, !0))
                    a = a.concat(
                        b.legendItems || (c.legendType === 'point' ? b.data : b)
                    );
            });
            return a;
        },
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && !e.useHTML) {
                this.clipHeight = h = t(
                    f - 20 - this.titleHeight - this.padding,
                    0
                );
        ...
        scroll: function(a, b) {
            ...
            if (e > 0)
                b !== u && Sa(b, this.chart),
                    ...
                    this.up
                        .attr({ fill: e === 1 ? g : h })
                        .css({ cursor: e === 1 ? 'default' : 'pointer' }),
                    i.attr({ text: e + '/' + d }),
                    this.down
                        .attr({
    ...
    Na = w.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            if (c && c.enabled !== !1)
                (b = c.radius),
                    (this.legendSymbol = d = e
                        .symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b)
                        .add(f)),
                    (d.isMarker = !0);
        },
    };
    (/Trident\/7\.0/.test(Ba) || La) &&
        cb(mb.prototype, 'positionItem', function(a, b) {
            var c = this,
                d = function() {
    ...
    D.prototype = {
        ...
        layOutTitles: function(a) {
            ...
            if (
                c &&
                (c
                    .css({ width: (f.width || h) + 'px' })
                    .align(
                        r({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f),
                        !1,
                        'spacingBox'
                    ),
                ...
                b = c.getBBox().height;
            d &&
                (d.css({ width: (e.width || h) + 'px' }).align(
                    r(
                        {
                            y:
                                b +
                                (f.margin - 13) +
                                g.fontMetrics(f.style.fontSize, d).b,
                        },
                        e
                    ),
                    !1,
        ...
        getChartSize: function() {
            ...
            this.chartHeight = t(
                0,
                p(a, this.containerHeight > 19 ? this.containerHeight : 400)
            );
        },
        ...
        drawChartBox: function() {
            ...
            o = i + (a.shadow ? 8 : 0);
            if (i || j)
                if (e) e.animate(e.crisp({ width: c - o, height: d - o }));
                else {
                    e = { fill: j || R };
                    if (i) (e.stroke = a.borderColor), (e['stroke-width'] = i);
                    this.chartBackground = b
                        .rect(o / 2, o / 2, c - o, d - o, a.borderRadius, i)
                        .attr(e)
            ...
            if (l)
                h
                    ? h.animate(v)
                    : (this.plotBGImage = b.image(l, q, p, m, s).add());
            r
        ...
        linkSeries: function() {
            ...
            m(b, function(b) {
                ...
                if (
                    Da(d) &&
                    (d = d === ':previous' ? a.series[b.index - 1] : a.get(d))
                )
        ...
        isReadyToRender: function() {
            var a = this;
            return (!ba && H == H.top && A.readyState !== 'complete') ||
                (ea && !H.canvg)
                ? (ea
                      ? Lb.push(function() {
                            a.firstRender();
    ...
    Q.prototype = {
        ...
        getColor: function() {
            this.options.colorByPoint ||
                this.getCyclic(
                    'color',
                    this.options.color || aa[this.type].color,
                ...
                if (o && h > o) {
                    ...
                    for (c = 0; c < h; c++)
                        if (
                            a[c] !== u &&
                            ((i = { series: e }),
                            e.pointClass.prototype.applyOptions.apply(i, [
                                a[c],
                            ]),
        ...
        processData: function(a) {
            ...
            if (k && this.sorted && (!i || d > i || this.forceCrop))
                if (b[d - 1] < l || b[0] > n) (b = []), (c = []);
                    ...
                    (e = this.cropData(this.xData, this.yData, l, n)),
                        (b = e.xData),
                        (c = e.yData),
                        (e = e.start),
                        (f = !0);
        ...
        generatePoints: function() {
            ...
            for (n = 0; n < g; n++)
                (i = h + n),
                    j
                        ? (l[n] = new f().init(this, [d[n]].concat(ra(e[n]))))
                        : (b[i]
                              ? (k = b[i])
                              : a[i] !== u &&
                                (b[i] = k = new f().init(this, a[i], d[n])),
                          (l[n] = k)),
                    (l[n].index = i);
            if (b && (g !== (c = b.length) || j))
                for (n = 0; n < c; n++)
        ...
        translate: function() {
            ...
            for (
                ...
                var v =
                    b &&
                    e.stacks[
                        (this.negStacks && C < k ? '-' : '') + this.stackKey
                    ];
                if (e.isLog && C !== null && C <= 0) (m.y = C = null), ka(10);
                m.plotX = l = c.translate(
                    r,
                    0,
                    0,
                    0,
                ...
                m.plotY = n =
                    typeof C === 'number' && C !== Infinity
                        ? I(t(-1e5, e.translate(C, 0, 1, 0, 1)), 1e5)
                        : u;
                m.isInside =
                    n !== u && n >= 0 && n <= e.len && l >= 0 && l <= c.len;
        ...
        animate: function(a) {
            ...
            a
                ...
                : ((d = this.sharedClipKey),
                  ...
                  b[d + 'm'] &&
                      b[d + 'm'].animate({ width: b.plotSizeX + 99 }, c),
                  (this.animate = null));
        },
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--; )
                    if (
                        ...
                        (o = g.marker || {}),
                        (q = !!g.marker),
                        (a = (t && o.enabled === u) || o.enabled),
                        (m = g.isInside),
                        a && e !== u && !isNaN(e) && g.y !== null)
                    )
                        if (
                            ((a = g.pointAttr[g.selected ? 'select' : ''] || n),
                            (h = a.r),
                            (i = p(o.symbol, this.symbol)),
                            (j = i.indexOf('url') === 0),
                            k)
                        )
                            k[m ? 'show' : 'hide'](!0).animate(
                                r(
                                    { x: d - h, y: e - h },
                                    k.symbolName
        ...
        getAttribs: function() {
            ...
            var p = a.zones,
                ...
                C;
            b.marker
                ? ((e.radius = e.radius || c.radius + e.radiusPlus),
                  (e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus))
                : ((e.color =
                      e.color ||
                      na(e.color || g)
            ...
            if (!j || g < j || l)
                for (; g--; ) {
                    j = i[g];
                    if (
                        (c = (j.options && j.options.marker) || j.options) &&
                        c.enabled === !1
                    )
                        c.radius = 0;
                    if (p.length) {
                ...
                if (k) db(k), k.animate({ d: f });
                    ...
                    (k = {
                        ...
                        c[2]
                            ? (k.dashstyle = c[2])
                            : e &&
                              (k['stroke-linecap'] = k['stroke-linejoin'] =
                                  'round'),
                ...
                i && i.hide(),
                    ...
                    m(d, function(d, m) {
                        ...
                        g[m]
                            ? g[m].animate(h)
                            : ((g[m] = c.clipRect(h)),
                              i && a['zoneGraph' + m].clip(g[m]),
                              j && a['zoneArea' + m].clip(g[m]));
                        q = d.value > l.max;
                    }),
                    (this.clips = g);
        },
        ...
        searchKDTree: function(a) {
            function b(a, h, i, j) {
                ...
                h[n] &&
                    ((n = b(a, h[n], i + 1, j)),
                    (o = n.dist[d] < o.dist[d] ? n : k),
                    (k = l < 0 ? 'right' : 'left'),
                    h[k] &&
                        Math.sqrt(l * l) < o.dist[d] &&
                        ((a = b(a, h[k], i + 1, j)),
                        (o = a.dist[d] < o.dist[d] ? a : o)));
                return o;
            }
            var c = this,
                d = this.kdComparer,
    ...
    Q.prototype.setStackedPoints = function() {
        if (
            ...
            for (s = 0; s < d; s++) {
                ...
                if (!l[m][r])
                    n[m] && n[m][r]
                        ? ((l[m][r] = n[m][r]), (l[m][r].total = null))
                        : (l[m][r] = new Hb(k, k.options.stackLabels, o, r, g));
                m = l[m][r];
                m.points[p] = [m.cum || 0];
                e === 'percent'
                    ? ((o = o ? h : i),
                      j && l[o] && l[o][r]
                          ? ((o = l[o][r]),
                            (m.total = o.total =
                                t(o.total, m.total) + O(v) || 0))
                          : (m.total = da(m.total + (O(v) || 0))))
                    : (m.total = da(m.total + (v || 0)));
                m.cum = (m.cum || 0) + (v || 0);
    ...
    r(Ga.prototype, {
        update: function(a, b, c, d) {
            function e() {
                ...
                j.legend.display &&
                    k.legendType === 'point' &&
                    (g.updateTotals(), j.legend.clearItems());
                b && j.redraw(c);
            }
            var f = this,
                g = f.series,
    ...
    r(va.prototype, {
        update: function(a, b) {
            var c = this.chart,
                a = (c.options[this.coll][this.options.index] = z(
                    this.userOptions,
                    a
                ));
            this.destroy(!0);
    ...
    var pa = ja(Q, {
        ...
        drawGraph: function() {
            ...
            m(d, function(d) {
                ...
                g
                    ? g.animate({ d: b })
                    : (a[f] = a.chart.renderer
                          .path(b)
                          .attr({
                              fill: p(
                                  d[2],
                                  na(d[1])
                                      .setOpacity(p(c.fillOpacity, 0.75))
                                      .get()
                              ),
                              zIndex: 0,
                          })
    ...
    xa = ja(Q, {
        ...
        getColumnMetrics: function() {
            ...
            return (a.columnMetrics = {
                ...
                offset:
                    b +
                    (j +
                        ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) *
                            k -
                        c / 2) *
                        (e ? -1 : 1),
            });
        ...
        translate: function() {
            ...
            m(a.points, function(c) {
                ...
                O(u) < g &&
                    ...
                    ((u = g),
                    (w =
                        (!e.reversed && !c.negative) ||
                        (e.reversed && c.negative)),
                    (r = x(O(r - f) > g ? d - g : f - (w ? g : 0))));
                c.barX = m;
                c.pointWidth = i;
                c.tooltipPos = b.inverted
                    ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - m - s / 2]
                    : [m + s / 2, h + e.pos - b.plotTop];
                s = x(m + s) + l;
                m = x(m) + l;
                s -= m;
                d = O(r) < 0.5;
                ...
                if (i !== u && !isNaN(i) && h.y !== null)
                    (f = h.shapeArgs),
                        (i = s(a.borderWidth)
                            ...
                            : {}),
                        (g =
                            h.pointAttr[h.selected ? 'select' : ''] ||
                            a.pointAttr['']),
                        j
                            ? (db(j),
                              j
                                  .attr(i)
                                  [b.pointCount < e ? 'animate' : 'attr'](z(f)))
        ...
        animate: function(a) {
            ...
            if (ba)
                a
                    ? ((e.scaleY = 0.001),
                      (a = I(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))),
    ...
    T = {
        ...
        translate: function(a) {
            ...
            var b = 0,
                ...
                i =
                    (this.endAngleRad =
                        (la / 180) * (p(c.endAngle, i + 360) - 90)) - j,
                k = this.points,
                ...
                m(e, function(e) {
                    ...
                    if (m && !h) e.dataLabel = m.destroy();
                        ...
                        if (m)
                            ...
                            if (v.color === 'contrast')
                                A.color =
                                    d.inside || d.distance < 0 || b.stacking
                                        ? k.getContrast(e.color || a.color)
                                        : '#000000';
                            if (c) A.cursor = c;
                            for (t in m) m[t] === u && delete m[t];
                            m = e.dataLabel = k[h ? 'text' : 'label'](
                                i,
                                0,
                                -999,
                                d.shape,
    ...
    Q.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (l)
            (d = r(
                ...
                c.rotation
                    ? ((a = f.renderer.rotCorr(k, c.rotation)),
                      b[e ? 'attr' : 'animate']({
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (L) {
                        ...
                        for (E = b = 0; !b && H[E]; )
                            (b =
                                H[E] &&
                                H[E].dataLabel &&
                                (H[E].dataLabel.getBBox().height || 21)),
                                E++;
                        if (n > 0) {
                ...
                if (Fa(F) === 0 || this.verifyDataLabelOverflow(F))
                    this.placeDataLabels(),
                        s &&
                            g &&
                            m(this.points, function(b) {
                                j = b.connector;
                                w = b.labelPos;
                                if ((u = b.dataLabel) && u._pos)
                                    (D = u._attr.visibility),
                                        (A = u.connX),
                                        (B = u.connY),
                                        (k = l
                                            ? [
                                        ...
                                        j
                                            ? (j.animate({ d: k }),
                                              j.attr('visibility', D))
                                            : (b.connector = j = a.chart.renderer
                                                  .path(k)
                                                  .attr({
                                                      'stroke-width': g,
                                                      stroke:
            ...
            (J.pie.prototype.verifyDataLabelOverflow = function(a) {
                ...
                d[0] !== null
                    ...
                    : ((e = t(b[2] - a[1] - a[3], c)),
                      (b[0] += (a[3] - a[1]) / 2));
                d[1] !== null
                    ? (e = t(I(e, b[2] - t(a[0], a[2])), c))
                    : ((e = t(I(e, b[2] - a[0] - a[2]), c)),
                      (b[1] += (a[0] - a[2]) / 2));
                e < b[2]
                    ? ((b[2] = e),
                      this.translate(b),
                ...
                for (c = d + 1; c < b; ++c)
                    if (
                        ...
                        i &&
                            ...
                            j.newOpacity !== 0 &&
                            !(
                                j.alignAttr.x > i.alignAttr.x + i.width ||
                                j.alignAttr.x + j.width < i.alignAttr.x ||
                                j.alignAttr.y > i.alignAttr.y + i.height ||
                                j.alignAttr.y + j.height < i.alignAttr.y
                            ))
                    )
            ...
            for (d = 0; d < b; d++)
                if ((c = a[d])) {
                    if (c.oldOpacity !== c.newOpacity && c.placed)
                        (c.alignAttr.opacity = c.newOpacity),
                            c[c.isOld && c.newOpacity ? 'animate' : 'attr'](
                                c.alignAttr
                            );
                    c.isOld = !0;
                }
    ...
    T = w.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            if (e && !c)
                for (n = e + 1; n--; )
                    d[n] === 'M' &&
                        d.splice(n + 1, 0, d[n + 1] - i, d[n + 2], 'L'),
                        ((n && d[n] === 'M') || n === e) &&
                            d.splice(n, 0, 'L', d[n - 2] + i, d[n - 1]);
        ...
        pan: function(a, b) {
            ...
            m(b === 'xy' ? [1, 0] : [1], function(b) {
                var d = a[b ? 'chartX' : 'chartY'],
                    ...
                    j =
                        h.toValue(
                            i + c[b ? 'plotWidth' : 'plotHeight'] - d,
                            !0
                        ) - j,
                    i = i > d;
                if (
                    h.series.length &&
                    (i || l > I(k.dataMin, k.min)) &&
                    (!i || j < t(k.dataMax, k.max))
                )
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(
                ...
                function() {
                    ...
                    c.setState(a && 'select');
                    b ||
                        m(e.getSelectedPoints(), function(a) {
                            if (a.selected && a !== c)
                ...
                if (this.graphic)
                    ...
                    if (a && i)
                        if (
                            ...
                            (e.stateMarkerGraphic = k = n.renderer
                    ...
                    if (k)
                        k[
                            a && n.isInsidePlot(c, d, n.inverted)
                                ? 'show'
                                : 'hide'
                        ]();
                }
    ...
    r(Q.prototype, {
        ...
        setState: function(a) {
            ...
            if (
                ...
                ((this.state = a),
                !(d[a] && d[a].enabled === !1) &&
                    (a && (e = d[a].lineWidth || e + (d[a].lineWidthPlus || 0)),
                    c && !c.dashstyle))
            ) {
                a = { 'stroke-width': e };
        ...
        setVisible: function(a, b) {
            var c = this,
                ...
                h = c.visible;
            f = (c.visible = a = c.userOptions.visible = a === u ? !h : a)
                ? 'show'
                : 'hide';
            m(['group', 'dataLabelsGroup', 'markerGroup', 'tracker'], function(
                a
            ) {
                if (c[a]) c[a][f]();
            });
...
Highcharts.theme = {
    colors: ['#f7f7f7', '#b02a1a'],
    labels: { style: { color: '#333333', font: '12px Arial' } },
    legend: {
        layout: 'vertical',
        backgroundColor: '#FFF',
        borderRadius: 0,
        ...
        floating: true,
        shadow: true,
        itemStyle: { cursor: 'pointer', font: '12px Arial', color: '#333333' },
    },
    plotOptions: {
        pie: {
            borderColor: '#cccccc',
            ...
            dataLabels: {
                ...
                color: '#333',
                connectorColor: '#ccc',
                style: { color: '#333333', font: '12px Arial' },
            },
            shadow: false,
        },
        series: { stacking: 'normal' },
        bar: { borderColor: '#cccccc', shadow: false },
    },
    subtitle: {
        style: {
            color: '#333333',
    ...
    tooltip: { style: { color: '#333333', font: '12px Arial' } },
    xAxis: {
        labels: { style: { color: '#ba433d', font: '14px Arial' } },
        lineColor: '#cccccc',
    ...
    yAxis: {
        ...
        gridLineColor: '#f7f7f7',
        lineColor: '#e7e7e7',
        title: { style: { color: '#333333', font: '12px Arial' }, margin: 10 },
    },
};
