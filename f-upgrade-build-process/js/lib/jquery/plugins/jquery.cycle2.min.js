...
(function(a) {
    ...
    (a.fn.cycle = function(b) {
        var e;
        return this.length === 0 && !a.isReady
            ? ((e = { s: this.selector, c: this.context }),
              c('requeuing slideshow (dom not ready)'),
              a(function() {
                  a(e.s, e.c).cycle(b);
              }),
              this)
            : this.each(function() {
                  ...
                  for (var j in e)
                      e.hasOwnProperty(j) &&
                          /^cycle[A-Z]+/.test(j) &&
                          ((h = e[j]),
                          (g = j.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, d)),
                          c(g + ':', h, '(' + typeof h + ')'),
                          (e[g] = h));
                  (f = a.extend({}, a.fn.cycle.defaults, e, b || {})),
                      (f.timeoutId = 0),
                      (f.paused = 0),
                      (f.container = i),
                      (f._maxZ = f.maxZ),
                      (f.API = a.extend({ _container: i }, a.fn.cycle.API)),
                      (f.API.log = c),
                      (f.API.trigger = function(a, b) {
                          return f.container.trigger(a, b), f.API;
                      }),
                      i.data('cycle.opts', f),
                      i.data('cycle.API', f.API),
                      f.API.trigger('cycle-bootstrap', [f, f.API]),
                      f.API.addInitialSlides(),
                      f.API.preInitSlideshow(),
                      f.slides.length && f.API.initSlideshow();
              });
    }),
        (a.fn.cycle.API = {
            opts: function() {
            ...
            initSlideshow: function() {
                ...
                b.API.calcFirstSlide(),
                    b.container.css('position') == 'static' &&
                        b.container.css('position', 'relative'),
                    a(b.slides[b.currSlide])
                        .css('opacity', 1)
                        .show(),
                    b.API.stackSlides(
                    ...
                    b.pauseOnHover &&
                        ...
                        c.hover(
                            function() {
                                (b.paused = 1),
                                    b.API.trigger('cycle-paused', [b]);
                            },
                            function() {
                                (b.paused = 0),
                                    b.API.trigger('cycle-resumed', [b]);
                            }
                        )),
                    b.timeout &&
                    ...
                    (b._initialized = !0),
                    b.API.updateView(),
                    b.container.on('cycle-paused cycle-resumed', function(a) {
                        b.container[
                            a.type === 'cycle-paused'
                                ? 'addClass'
                                : 'removeClass'
            ...
            add: function(b, c) {
                ...
                a(b).each(function(b) {
                    var e,
                        f = a(this);
                    c ? d.container.prepend(f) : d.container.append(f),
                        d.slideCount++,
                        (e = d.API.buildSlideOpts(f)),
                        c
                            ? (d.slides = a(f).add(d.slides))
                            : (d.slides = d.slides.add(f)),
            ...
            calcTx: function(b, d) {
                var e = b,
                    f;
                return (
                    d && e.manualFx && (f = a.fn.cycle.transitions[e.manualFx]),
                    f || (f = a.fn.cycle.transitions[e.fx]),
                    f ||
                        ((f = a.fn.cycle.transitions.fade),
                        c('Transition "' + e.fx + '" not found.  Using fade.')),
                    f
                );
            },
            prepareTx: function(a, b) {
                ...
                (e = c.slides[c.currSlide]),
                    ...
                    (c._tx = h),
                    a &&
                        g.manualSpeed !== undefined &&
                        (g.speed = g.manualSpeed),
                    c.nextSlide != c.currSlide &&
                    (a || (!c.paused && c.timeout))
                        ? (c.API.trigger('cycle-before', [g, e, f, b]),
                          h.before && h.before(g, e, f, b),
                          (d = function() {
                              (c.busy = !1),
                                  h.after && h.after(g, e, f, b),
                          ...
                          (c.busy = !0),
                          h.transition
                              ? h.transition(g, e, f, b, d)
                              : c.API.doTransition(g, e, f, b, d),
                          c.API.calcNextSlide())
                        : c.API.queueTransition(g);
            },
            ...
            buildSlideOpts: function(b) {
                ...
                for (var i in h)
                    h.hasOwnProperty(i) &&
                        /^cycle[A-Z]+/.test(i) &&
                        ((f = h[i]),
                        (g = i.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, d)),
                        c(
                            '[' + (e.slideCount - 1) + ']',
                            g + ':',
                            f,
                        ...
                        (h[g] = f));
                (h = a.extend({}, a.fn.cycle.defaults, e, h)),
                    (h.slideNum = e.slideCount);
                try {
                    delete h.API,
                        delete h.slideCount,
                        delete h.currSlide,
            ...
            updateView: function() {
                ...
                var b = a.API.getSlideOpts(),
                    c = a.slides[a.currSlide];
                a.slideActiveClass &&
                    a.slides
                    ...
                    a.hideNonActive &&
                        a.slides
                            .filter(':not(.' + a.slideActiveClass + ')')
                            .hide(),
                    a.API.trigger('cycle-update-view', [a, b, c]);
            },
    ...
    (function(a) {
        'use strict',
            ...
            a(document).on('cycle-initialized', function(b, c) {
                function e() {
                    c.container.height(c.container.width() / d);
                }
                var d;
                a.type(c.autoHeight) == 'number' && c.autoHeight >= 0
                    ? (c._sentinel = a(c.slides[c.autoHeight])
                          .clone()
                          .css({
                              position: 'static',
                              visibility: 'hidden',
                    ...
                    : a.type(c.autoHeight) == 'string' &&
                      /\d+\:\d+/.test(c.autoHeight) &&
                      ((d = c.autoHeight.match(/(\d+)\:(\d+)/)),
                      (d = d[1] / d[2]),
                      a(window).on('resize', e),
                      (c._autoHeightOnResize = e),
                      setTimeout(function() {
                          a(window).triggerHandler('resize');
                      }, 15));
            }),
            a(document).on('cycle-destroyed', function(b, c) {
                c._sentinel && c._sentinel.remove(),
                    c._autoHeightOnResize &&
                        a(window).off('resize', c._autoHeightOnResize);
            });
    })(jQuery),
    (function(a) {
        'use strict',
        ...
        (a.fn.cycle = function(c) {
            ...
            a.extend(b.API, {
                next: function() {
                    var a = this.opts(),
                        b = a.reverse ? -1 : 1;
                    if (a.allowWrap === !1 && a.currSlide + b >= a.slideCount)
                        return;
                ...
                destroy: function() {
                    ...
                    clearTimeout(a.timeoutId),
                        (a.timeoutId = 0),
                        a.API.stop(),
                        a.API.trigger('cycle-destroyed', [a]).log(
                            'cycle-destroyed'
                        ),
                        a.container.removeData('cycle.opts');
                },
                jump: function(a) {
                    var b,
                        c = this.opts(),
                ...
                pause: function() {
                    var a = this.opts();
                    (a.paused = !0),
                        a.API.trigger('cycle-paused', [a]).log('cycle-paused');
                },
                resume: function() {
                    var a = this.opts();
                    (a.paused = !1),
                        a.API.trigger('cycle-resumed', [a]).log(
                            'cycle-resumed'
                        );
                },
                reinit: function() {
                ...
                remove: function(b) {
                    ...
                    e &&
                        ...
                        c.slideCount--,
                        a(e).remove(),
                        b == c.currSlide && c.API.advanceSlide(1),
                        c.API.trigger('cycle-slide-removed', [c, b, e]).log(
                            'cycle-slide-removed'
                        ),
                        c.API.updateView());
                },
    ...
    (function(a) {
        function b(b, c, d) {
            ...
            f.each(function() {
                var f = a(this);
                if (c.pagerTemplate) {
                    var g = b.API.tmpl(c.pagerTemplate, c, d[0]);
                    e = a(g).appendTo(f);
        ...
        'use strict',
            ...
            a(document).on('cycle-destroyed', function(a, b) {
                ...
                b.pager &&
                    b.pagerTemplate &&
                    ((c = b.API.getComponent('pager')), c.empty());
            });
    })(jQuery),
    (function(a) {
        'use strict',
            ...
            a(document).on('cycle-initialized', function(a, b) {
                b.API.getComponent('next')
                    .off(b.nextEvent)
                    .on(b.nextEvent, function(a) {
                        a.preventDefault(), b.API.next();
                    }),
                    b.API.getComponent('prev')
                        .off(b.prevEvent)
                        .on(b.prevEvent, function(a) {
            ...
            a(document).on('cycle-destroyed', function(b, c) {
                a(c.next).off(c.nextEvent),
                    a(c.prev).off(c.prevEvent),
                    c.container.off(
                ...
                g &&
                    (d.prepareTx = function(a, b) {
                        ...
                        b && c.currSlide == c.slideCount - 1
                            ? ((e = h[0]),
                              (h = h.slice(1)),
                              c.container.one('cycle-slide-added', function(
                                  a,
                                  b
                              ) {
    ...
    (function(a) {
        'use strict',
            ...
            a.extend(a.fn.cycle.API, {
                tmpl: function(b, c, d) {
                    var e = new RegExp(c.tmplRegex, 'g');
                    if (b && c)
                        return b.replace(e, function(b, e) {
                            var f,
                                g,
                                h = c,
                                i = e.split('.');
