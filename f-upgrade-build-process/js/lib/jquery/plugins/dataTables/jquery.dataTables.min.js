        ...
        var j = function(e) {
                        ...
                        for (g = j.length; f < g; f++)
                            if ('number' === typeof j[f] && 0 <= j[f]) {
                                ...
                                for (w = a.aoColumns.length; e < w; e++)
                                    ('_all' == j[f] ||
                                        h(a.aoColumns[e].nTh).hasClass(j[f])) &&
                                        d(e, b[i]);
                            }
                    }
                if (c) {
                ...
                if (a.bDeferLoading || null === a.sAjaxSource)
                    for (b = a.nTBody.firstChild; b; ) {
                        if ('TR' == b.nodeName.toUpperCase()) {
                            ...
                            b._DT_RowIndex = c;
                            a.aoData.push(
                                h.extend(!0, {}, j.models.oRow, { nTr: b })
                            );
                    ...
                    for (d = a.aoColumns.length; b < d; b++)
                        c[b] &&
                            ...
                            a.aoColumns[b].sClass &&
                                h(c[b]).addClass(a.aoColumns[b].sClass));
                }
            }
            function W(a, b, c) {
                var d,
            ...
            function Ea(a) {
                ...
                c.push({
                    name: 'iDisplayLength',
                    value:
                        !1 !== a.oFeatures.bPaginate ? a._iDisplayLength : -1,
                });
                for (f = 0; f < b; f++)
            ...
            function Fa(a, b) {
                ...
                c && (d = u(a, b.sColumns));
                for (
                    var i = Q(a.sAjaxDataProp)(b), f = 0, g = i.length;
                    f < g;
                    f++
                )
                    if (c) {
                        for (
                            var e = [], h = 0, j = a.aoColumns.length;
                            h < j;
                            h++
                        )
                            e.push(i[f][d[h]]);
            ...
            function za(a) {
                ...
                c.attr('aria-controls', a.sTableId).bind(
                    'keypress.DT',
                    function(a) {
            ...
            function Ha(a, b, c, d, i, f) {
                if ('' !== b)
                    for (
                        var g = 0,
                            b = ma(b, d, i, f),
                            d = a.aiDisplay.length - 1;
                        0 <= d;
                        d--
                    )
                        (i = Ja(
                            v(a, a.aiDisplay[d], c, 'filter'),
                            a.aoColumns[c].sType
                        )),
                ...
                if (!1 === a.bInitialised)
                    ...
                    for (c = a.aoColumns.length; b < c; b++)
                        null !== a.aoColumns[b].sWidth &&
                            (a.aoColumns[b].nTh.style.width = q(
                                a.aoColumns[b].sWidth
                            ));
                    a.oFeatures.bSort
                        ? O(a)
                        : a.oFeatures.bFilter
                ...
                a._iDisplayEnd =
                    !1 === a.oFeatures.bPaginate
                        ...
                        : a._iDisplayStart + a._iDisplayLength >
                              a.aiDisplay.length || -1 == a._iDisplayLength
                            ? a.aiDisplay.length
                            : a._iDisplayStart + a._iDisplayLength;
            }
            function Da(a) {
                ...
                a.aanFeatures.p ||
                    a.aoDrawCallback.push({
                        fn: function(a) {
                            j.ext.oPagination[a.sPaginationType].fnUpdate(
                                a,
                                function(a) {
                                    y(a);
                                    x(a);
            ...
            function qa(a, b) {
                ...
                if ('number' === typeof b)
                    (a._iDisplayStart = b * a._iDisplayLength),
                        a._iDisplayStart > a.fnRecordsDisplay() &&
                            (a._iDisplayStart = 0);
                    ...
                    if (0 <= a._iDisplayLength) {
                        var d =
                            parseInt(
                                (a.fnRecordsDisplay() - 1) / a._iDisplayLength,
                                10
                            ) + 1;
            ...
            function E(a, b) {
                if (a.oFeatures.bProcessing)
                    for (
                        var c = a.aanFeatures.r, d = 0, i = c.length;
                        d < i;
                        d++
                    )
            ...
            function Ba(a) {
                ...
                e.appendChild(o);
                null !== k &&
                    (b.appendChild(f), g.appendChild(j), j.appendChild(k));
                ...
                f.style.border = '0';
                d.style.width =
                    '' !== a.oScroll.sXInner ? a.oScroll.sXInner : '100%';
            ...
            function La(a) {
                var b = a.nScrollHead.getElementsByTagName('div')[0],
                    ...
                    R =
                        null !== a.nTFoot
                            ? l.getElementsByTagName('table')[0]
                            : null,
                ...
                a.oScroll.bCollapse &&
                    '' !== a.oScroll.sY &&
                    (d.style.height =
                        d.offsetHeight + a.nTHead.offsetHeight + 'px');
                ...
                if (h(a.nTable).outerWidth() < i) {
                    ...
                    (d.style.width = q('100%')),
                        ...
                        null !== a.nTFoot &&
                            (a.nScrollFoot.style.width = q('100%'));
                '' === a.oScroll.sY &&
                    r &&
                    (d.style.height = q(
                        a.nTable.offsetHeight + a.oScroll.iBarWidth
                    ));
                '' !== a.oScroll.sY &&
                    a.oScroll.bCollapse &&
                    ...
                    (r =
                        '' !== a.oScroll.sX &&
                        a.nTable.offsetWidth > d.offsetWidth
                            ? a.oScroll.iBarWidth
                            : 0),
                ...
                null !== a.nTFoot &&
                    ((R.style.width = q(r)),
                    (l.style.width = q(r)),
                    (l.style.paddingRight = c
                        ? a.oScroll.iBarWidth + 'px'
                        : '0px'));
                h(d).scroll();
            ...
            function Oa(a, b) {
                '' === a.oScroll.sX && '' !== a.oScroll.sY
                    ? (h(b).width(),
                      (b.style.width = q(
                          h(b).outerWidth() - a.oScroll.iBarWidth
                      )))
                    : '' !== a.oScroll.sX &&
            ...
            function Sa(a, b) {
                if (a.oFeatures.bStateSave) {
                    ...
                    if (c) {
                        var d = A(a, 'aoStateLoadParams', 'stateLoadParams', [
                            a,
                            c,
                        ]);
                        if (-1 === h.inArray(!1, d)) {
            ...
            this.$ = function(a, b) {
                ...
                b = h.extend(
                    {},
                    { filter: 'none', order: 'current', page: 'all' },
                    b
                );
                if ('current' == b.page) {
                    c = d._iDisplayStart;
            ...
            this.each(function() {
                ...
                if ('table' != this.nodeName.toLowerCase())
                    ...
                    if (null === c || '' === c)
                        this.id = c =
                            'DataTables_Table_' +
                            j.ext._oExternConfig.iNextUnique++;
                    ...
                    for (b = g.aaSorting.length; a < b; a++) {
                        g.aaSorting[a][0] >= g.aoColumns.length &&
                            (g.aaSorting[a][0] = 0);
                    ...
                    0 === b.length &&
                        ((b = [l.createElement('thead')]),
                        this.appendChild(b[0]));
                    g.nTHead = b[0];
                    b = h(this).children('tbody');
                    0 === b.length &&
                        ((b = [l.createElement('tbody')]),
                        this.appendChild(b[0]));
                    g.nTBody = b[0];
                    ...
                    if (
                        ...
                        (b = [l.createElement('tfoot')]),
                            this.appendChild(b[0]);
                    0 < b.length &&
                        ((g.nTFoot = b[0]), V(g.aoFooter, g.nTFoot));
                    if (f)
        ...
        j.defaults = {
            ...
            fnFormatNumber: function(e) {
                ...
                for (
                    ...
                    0 === k % 3 &&
                        0 !== k &&
                        (j = this.oLanguage.sInfoThousands + j),
                        (j = e[h - k - 1] + j);
                return j;
            },
                ...
                fnUpdate: function(e, o) {
                    if (e.aanFeatures.p) {
                        var m = j.ext.oPagination.iFullNumbersShowPages,
                            ...
                            n =
                                Math.ceil(
                                    e._iDisplayStart / e._iDisplayLength
                                ) + 1,
                            t = '',
                            r,
                            B = e.oClasses,
