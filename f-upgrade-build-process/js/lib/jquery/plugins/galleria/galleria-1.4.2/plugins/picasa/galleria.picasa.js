...
(function($) {
    ...
    Galleria.requires(
        1.25,
        'The Picasa Plugin requires Galleria version 1.2.5 or later.'
    );
    ...
    Galleria.prototype.load = function() {
        ...
        if (picasa.length) {
            ...
            if (typeof Galleria.Picasa.prototype[picasa[0]] !== 'function') {
                Galleria.raise(
                    picasa[0] + ' method not found in Picasa plugin'
                );
            ...
            if (picasa[0] == 'useralbum') {
                ...
                if (arg.length != 2) {
                    Galleria.raise(
                        'Picasa useralbum not correctly formatted (should be [user]/[album])'
                    );
                    return;
                }
            } else {
