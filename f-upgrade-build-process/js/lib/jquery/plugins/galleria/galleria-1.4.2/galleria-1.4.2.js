    ...
    var doc = window.document,
        ...
        _video = {
            ...
            dailymotion: {
                ...
                embed: function() {
                    return (
                        PROT + '//www.dailymotion.com/embed/video/' + this.id
                    );
                },
                getUrl: function() {
                    return (
                ...
                wait: function(options) {
                    ...
                    var start = Utils.timestamp(),
                        ...
                        fn = function() {
                            ...
                            Galleria._waiters.push(
                                (tid = window.setTimeout(fn, 10))
                            );
                        };
...
*/
    ...
    Galleria = function() {
        ...
        var lightbox = (this._lightbox = {
            ...
            show: function(index) {
                ...
                $(lightbox.elems.box).toggleClass(
                    'iframe',
                    lightbox.image.isIframe
                );
            ...
            if (options.swipe) {
                ...
                this.finger = new Galleria.Finger(this.get('stage'), {
                    ...
                    oncomplete: function(page) {
                        ...
                        if (
                            self._options.carousel &&
                            self._options.carouselFollow
                        ) {
    ...
    */
        ...
        hasVariation: function(variation) {
            return (
                $.inArray(variation, this._options.variation.split(/\s+/)) > -1
            );
        },
...
this.prependChild( 'info', 'myElement' );
        ...
        rescale: function(width, height, complete) {
            ...
            var scale = function() {
                ...
                if (self._options.swipe) {
                    ...
                    self.$('images').css(
                        'width',
                        self._stageWidth * self.getDataLength()
                    );
                } else {
    ...
    */
        ...
        show: function(index, rewind, _history) {
            ...
            index = M.max(
                0,
                M.min(parseInt(index, 10), this.getDataLength() - 1)
            );
            ...
            var complete = (function(data, next, active, queue, thumb) {
                return function() {
                    ...
                    $(active.container)
                        ...
                        .remove();
                    $(
                        self._controls.frames[self._controls.active].container
                    ).hide();
        ...
        Finger.prototype = {
            ...
            ontouchmove: function(e) {
                ...
                if (this.isScrolling === null) {
                    this.isScrolling = !!(
                        this.isScrolling ||
                        M.abs(this.deltaX) <
                            M.abs(touch[0].pageY - this.start.pageY)
                    );
                }
            ...
            loop: function() {
                ...
                if (this.width && distance) {
                    factor = M.max(
                        0.5,
                        M.min(1.5, M.abs(distance / this.width))
                    );
                }
