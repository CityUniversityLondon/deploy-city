!(function(t, e, i, n) {
    var a = e.document,
        ...
        F = function(e) {
            ...
            t.each(P, function(t, i) {
                if (
                    i._options.theme == e.name ||
                    (!i._initialized && !i._options.theme)
                ) {
                    i.theme = e;
                    i._init.call(i);
                }
            ...
            return {
                ...
                animate: (function() {
                    ...
                    return function(a, v, y) {
                        y = t.extend(
                            { duration: 400, complete: m, stop: false },
                            y
                        );
                        a = t(a);
                        if (!y.duration) {
                ...
                revertStyles: function() {
                    t.each(H.array(arguments), function(e, i) {
                        ...
                        i.attr('style', '');
                        if (i.data('styles')) {
                            i.attr('style', i.data('styles')).data(
                                'styles',
                                null
                            );
                        }
                ...
                loadCSS: function(e, o, r) {
                    ...
                    if (t('#' + o).length) {
                        ...
                        s = t('<link>')
                            .attr({ rel: 'stylesheet', href: e, id: o })
                            .get(0);
        ...
        O = function(e) {
            ...
            return t(H.create('galleria-videoicon'))
                .html('<i></i>')
                .appendTo(e)
                .click(function() {
                    t(this)
            ...
            t(this)
                ...
                .on('touchmove.fast', function(e) {
                    var i = n(e.originalEvent),
                        ...
                        o = Math.max(
                            Math.abs(a.coords.x - i.x),
                            Math.abs(a.coords.y - i.y)
                        );
                    if (o > 6) {
                        t(this).data(
                            'clickstate',
                            t.extend(a, { touchdown: false })
                        );
                    }
                })
    ...
    i = function() {
        ...
        var d = (this._carousel = {
            ...
            update: function() {
                ...
                t.each(s._thumbnails, function(a, o) {
                    if (o.ready) {
                        ...
                        i = g.max(
                            i,
                            o.outerHeight || t(o.container).outerHeight(true)
                        );
                    }
                });
                ...
                d.setClasses();
                s.$('thumbnails-container').toggleClass(
                    'galleria-carousel',
                    e > d.width
                );
                d.width = s.$('thumbnails-list').width();
            ...
            follow: function(t) {
                ...
                var e = d.current;
                while (
                    d.hooks[e] - d.hooks[d.current] < d.width &&
                    e <= d.hooks.length
                ) {
                    e++;
                }
            ...
            setClasses: function() {
                ...
                d.next.toggleClass(
                    'disabled',
                    d.hooks[d.current] + d.width >= d.max
                );
            },
            animate: function(e) {
                d.setClasses();
                            ...
                            complete: function(e) {
                                ...
                                if (n) {
                                    t(n)
                                        ...
                                        .attr('style', t(e.image).attr('style'))
        ...
        var w = (this._lightbox = {
            ...
            init: function() {
                ...
                var e =
                    ...
                    c = {
                        ...
                        prevholder:
                            r + 'width:50%;top:0;bottom:40px;cursor:pointer;',
                        nextholder:
                            r +
                ...
                u(
                    t(n.close)
                        .on('click:fast', w.hide)
                        .html('&#215;')
                );
                t.each(['Prev', 'Next'], function(e, a) {
                    var o = t(n[a.toLowerCase()]).html(
                            /v/.test(a) ? '&#8249;&#160;' : '&#160;&#8250;'
                        ),
            ...
            hide: function() {
                ...
                H.hide(w.elems.overlay, 200, function() {
                    t(this)
                        .hide()
                        .css('opacity', s._options.overlayOpacity);
                ...
                w.image.load(a.big || a.image || a.iframe, function(i) {
                    if (i.isIframe) {
                        ...
                        if (i.video && s._options.maxVideoSize) {
                            var u = g.min(
                                s._options.maxVideoSize / l,
                                s._options.maxVideoSize / c
                            );
                            if (u < 1) {
                                l *= u;
                                c *= u;
    ...
    i.prototype = {
            ...
            if (!this._options.swipe) {
                t.each(new Array(2), function(e) {
                    ...
                    t(n.container)
                        ...
                        .prepend(
                            (o._layers[e] = t(H.create('galleria-layer')).css({
                                position: 'absolute',
                                top: 0,
                                left: 0,
                                right: 0,
            ...
            if (s.swipe) {
                ...
                this.finger = new i.Finger(this.get('stage'), {
                    ...
                    oncomplete: function(e) {
                        var i = g.max(
                                0,
                                g.min(parseInt(e, 10), o.getDataLength() - 1)
                            ),
                            n = o.getData(i);
                        t(o._thumbnails[i].container)
                            .addClass('active')
                            .siblings('.active')
                            .removeClass('active');
                        if (!n) {
                ...
                this.$('stage').on('click', function(i) {
                    ...
                    if (a.iframe) {
                        ...
                        t(r.container)
                            .css({ width: s, height: l, opacity: 0 })
                            .show()
                ...
                this.$('stage').on(
                    ...
                    (function() {
                        var t,
                            ...
                            r,
                            s = function(t) {
                                return t.originalEvent.touches
        ...
        _getWH: function() {
            ...
            t.each(['width', 'height'], function(t, r) {
                if (n._options[r] && typeof n._options[r] === 'number') {
                    ...
                    o = [
                        H.parseValue(e.css(r)),
                        H.parseValue(i.css(r)),
                        e[r](),
                        i[r](),
                    ];
                    if (!n['_' + r]) {
                        o.splice(
                            o.length,
                            H.parseValue(e.css('min-' + r)),
                            H.parseValue(i.css('min-' + r))
                        );
                    }
                    a[r] = g.max.apply(g, o);
                }
        ...
        _createThumbnails: function(n) {
            ...
            var o,
                ...
                v =
                    typeof u.thumbnails === 'string'
                        ? u.thumbnails.toLowerCase()
                        : null,
                _ = function(t) {
                    return a.defaultView && a.defaultView.getComputedStyle
                        ? a.defaultView.getComputedStyle(r.container, null)[t]
                        : l.css(t);
                },
                b = function(e, n, a) {
                    return function() {
                    ...
                    e.scale({
                        ...
                        complete: function(e) {
                            ...
                            t.each(a, function(i, a) {
                                ...
                                e['outer' + a] = t(e.container)['outer' + a](
                                    true
                                );
                            });
                            H.toggleQuality(
            ...
            for (; this._data[h]; h++) {
                ...
                t(r.container)
                    .add(u.keepSource && u.linkSourceImages ? s.original : null)
                    .data('index', h)
                    .on(u.thumbEventType, w)
                    .data('thumbload', T);
                if (m === o) {
            ...
            H.wait({
                ...
                success: function() {
                    ...
                    if (a._options.swipe) {
                        var o = a
                            .$('images')
                            .width(a.getDataLength() * a._stageWidth);
            ...
            if (t.isArray(e)) {
                ...
                t(e)
                    ...
                    .each(function(e, i) {
                        ...
                        if (
                            s &&
                            (i[0].nodeName == 'IMG' || i.hasClass('video')) &&
                            S(s)
                        ) {
                            n.video = s;
        ...
        _parseData: function(e) {
            ...
            t.each(this._data, function(e, o) {
                ...
                if ('video' in o) {
                    ...
                    if (s) {
                        a.iframe =
                            new I(s.provider, s.id).embed() +
                            (function() {
                                if (typeof i._options[s.provider] == 'object') {
                                    var e = '?',
                                        n = [];
                                    t.each(i._options[s.provider], function(
                                        t,
                                        e
                                    ) {
                                        n.push(t + '=' + e);
            ...
            if (this._options.preload) {
                ...
                try {
                    for (e = this._options.preload; e > 0; e--) {
                        ...
                        a = this.getData(n);
                        t.preload(
                            this.isFullscreen() && a.big ? a.big : a.image
                        );
                        n = this.getNext(n);
                    }
                } catch (o) {}
                ...
                e.setTimeout(function() {
                    if (!h.ready || t(h.image).attr('src') != u) {
                        ...
                        h.load(u, function(e) {
                            ...
                            c._scaleImage(e, m).trigger(
                                t.extend(p, { type: i.IMAGE })
                            );
                            m();
                        });
                    } else {
        ...
        _show: function() {
            ...
            t(a._thumbnails[o.index].container)
                .addClass('active')
                .siblings('.active')
                .removeClass('active');
            a.trigger({
            ...
            u.load(l, function(e) {
                var s = t(a._layers[1 - a._controls.active])
                    .html(r.layer || '')
                    .hide();
                a._scaleImage(e, {
                    complete: function(e) {
    ...
    i.Picture.prototype = {
        ...
        load: function(n, a, o) {
            ...
            f.css('display', 'block');
            H.hide(this.image);
            t.each('minWidth minHeight maxWidth maxHeight'.split(' '), function(
                t,
                e
            ) {
                ...
                success: function() {
                    var i = (h - e.margin * 2) / a.original.width,
                        ...
                        s = {
                            ...
                            false: o,
                            landscape:
                                a.original.width > a.original.height ? r : o,
                            portrait:
                                a.original.width < a.original.height ? r : o,
                        },
                        l = s[e.crop.toString()],
                    ...
                    t.each(['width', 'height'], function(e, i) {
                        t(a.image)[i](
                            (a[i] = a.image[i] = g.round(a.original[i] * l))
                        );
                    });
                    t(a.container)
                        .width(h)
    ...
    i.Finger = (function() {
        ...
        var l = function(i, n) {
            ...
            this.setX = function() {
                ...
                t.MozTransform = t.webkitTransform = t.transform =
        ...
        l.prototype = {
            ...
            ontouchmove: function(t) {
                ...
                if (this.isScrolling === null) {
                    this.isScrolling = !!(
                        this.isScrolling ||
                        g.abs(this.deltaX) <
                            g.abs(e[0].pageY - this.start.pageY)
                    );
                }
                if (!this.isScrolling) {
                    t.preventDefault();
                    this.deltaX /=
                        ...
                        (this.index == this.length - 1 && this.deltaX < 0)
                            ? g.abs(this.deltaX) / this.width + 1.8
                            : 1;
            ...
            ontouchend: function(t) {
                ...
                var e =
                        (+new Date() - this.start.time < 250 &&
                            g.abs(this.deltaX) > 40) ||
                        g.abs(this.deltaX) > this.width / 2,
                    i =
                        (!this.index && this.deltaX > 0) ||
                        (this.index == this.length - 1 && this.deltaX < 0);
                if (!this.isScrolling) {
            ...
            loop: function() {
                var t = this.to - this.pos,
                    e = 1;
                if (this.width && t) {
                    e = g.max(0.5, g.min(1.5, g.abs(t / this.width)));
                }
