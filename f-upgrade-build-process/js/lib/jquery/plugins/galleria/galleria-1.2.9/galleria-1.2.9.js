            ...
            return {
                ...
                init: function(effect, params, complete) {
                    if (_transitions.effects.hasOwnProperty(effect)) {
                        _transitions.effects[effect].call(
                            this,
                            params,
                            complete
                        );
                ...
                effects: {
                    ...
                    fadeslide: function(params, complete) {
                        _slide.apply(
                            this,
                            Utils.array(arguments).concat([true])
                        );
                    },
        ...
        var fullscreen = (this._fullscreen = {
            ...
            enter: function(callback) {
                ...
                if (self._options.trueFullscreen && _nativeFullscreen.support) {
                    ...
                    if (Galleria.MAC) {
                        if (
                            Galleria.WEBKIT &&
                            !(Galleria.SAFARI && /version\/[1-5]/.test(NAV))
                        ) {
                            self.$('container')
                                .css('opacity', 0)
                                .addClass('fullscreen');
            ...
            _enter: function(callback) {
                ...
                var data = self.getData(),
                    ...
                    inBrowser =
                        !self._options.trueFullscreen ||
                        !_nativeFullscreen.support,
                    htmlbody = {
                        height: '100%',
                        overflow: 'hidden',
                        margin: 0,
        ...
        scale: function(options) {
            ...
            if (this.isIframe) {
                ...
                if (options.iframelimit) {
                    var r = Math.min(
                        options.iframelimit / cw,
                        options.iframelimit / ch
                    );
                    if (r < 1) {
                        nw = cw * r;
                        nh = ch * r;
