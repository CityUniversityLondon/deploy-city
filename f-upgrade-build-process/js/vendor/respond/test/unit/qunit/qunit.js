        ...
        run: function() {
            ...
            try {
                ...
                fail(
                    'Test ' +
                        this.testName +
                        ' died, exception and test follows',
                    e,
                    this.callback
                );
                QUnit.ok(
        ...
        var callbacks = (function() {
            ...
            return {
                ...
                object: function(b, a) {
                    ...
                    return (
                        eq && innerEquiv(aProperties.sort(), bProperties.sort())
                    );
                },
            };
        })();
        ...
        var jsDump = {
            ...
            parsers: {
                ...
                function: function(fn) {
                    var ret = 'function',
                        name =
                            'name' in fn ? fn.name : (reName.exec(fn) || [])[1]; //functions never have name in IE
                    if (name) ret += ' ' + name;
                    ret += '(';

                    ret = [
                        ret,
                        QUnit.jsDump.parse(fn, 'functionArgs'),
                        '){',
                    ].join('');
                    return join(
                        ret,
                        QUnit.jsDump.parse(fn, 'functionCode'),
                        '}'
                    );
                },
                array: array,
