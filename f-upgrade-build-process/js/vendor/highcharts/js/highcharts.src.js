...
(function() {
    ...
    function pad(number, length) {
        ...
        return (
            new Array((length || 2) + 1 - String(number).length).join(0) +
            number
        );
    }
        ...
        win.HighchartsAdapter =
            ...
            ($ && {
                ...
                init: function(pathAnim) {
                    ...
                    $.each(['cur', '_default', 'width', 'height'], function(
                        i,
                        fn
                    ) {
                        var obj = Step,
                            ...
                            obj[fn] = function(fx) {
                                ...
                                return elem.attr // is SVG element wrapper
                                    ? elem.attr(
                                      ...
                                      ) // apply the SVG wrapper's method
                    ...
                    dSetter = function(fx) {
                        ...
                        elem.attr(
                            'd',
                            pathAnim.step(fx.start, fx.end, fx.pos, elem.toD)
                        );
                    };
                    ...
                    this.each = Array.prototype.forEach
                        ...
                        : function(arr, fn) {
                              ...
                              for (; i < len; i++) {
                                  if (
                                      fn.call(arr[i], arr[i], i, arr) === false
                                  ) {
                                      return i;
                                  }
                              }
                ...
                fireEvent: function(el, type, eventArguments, defaultFunction) {
                    ...
                    // objects. #615.
                    /*jslint unparam: true*/
                    $.each(['preventDefault', 'stopPropagation'], function(
                        i,
                        fn
                    ) {
                        var base = event[fn];
        ...
        attr: function(hash, val) {
            ...
            if (isString(hash)) {
                ...
                for (key in hash) {
                    ...
                    result =
                        attrSetters[key] &&
                        attrSetters[key].call(wrapper, value, key);
                    ...
                    if (result !== false) {
                        ...
                        if (key === 'd') {
                            ...
                            titleNode = element.getElementsByTagName(
                                'title'
                            )[0];
                            if (!titleNode) {
    ...
    SVGRenderer.prototype = {
        ...
        buildText: function(wrapper) {
            var textNode = wrapper.element,
                ...
                width =
                    textStyles && textStyles.width && pInt(textStyles.width),
        ...
        color: function(color, elem, prop) {
            ...
            if (gradName) {
                ...
                if (!gradAttr.id || !gradients[gradAttr.id]) {
                    ...
                    gradients[gradAttr.id] = gradientObject = renderer
        ...
        fontMetrics: function(fontSize) {
            ...
            var lineHeight =
                    fontSize < 24 ? fontSize + 4 : mathRound(fontSize * 1.2),
                    ...
                    for (key in hash) {
                        ...
                        if (result !== false && value !== null) {
							...
							and cause an epileptic effect */
                                ...
                                element.style.left =
                                    -mathRound(mathSin(value * deg2rad) + 1) +
                                    PX;
                                element.style.top =
                                    mathRound(mathCos(value * deg2rad)) + PX;
                                ...
                                applyRadialGradient = function() {
                                    if (radialReference) {
                                        ...
                                        cy +=
                                            ...
                                            0.5;
                                        sizex *=
                                            radialReference[2] / bBox.width;
                                        sizey *=
                                            radialReference[2] / bBox.height;
                                    }
                                    fillAttr =
                                        'src="' +
            ...
            symbols: {
                ...
                rect: function(left, top, width, height, options) {
                    ...
                    if (!defined(options) || !options.r) {
                        ret = SVGRenderer.prototype.symbols.square.apply(
                            0,
                            arguments
                        );
    ...
    Tick.prototype = {
        ...
        addLabel: function() {
            ...
            css = width && {
                width:
                    mathMax(
                        1,
                        mathRound(width - 2 * (labelOptions.padding || 10))
                    ) + PX,
            };
        ...
        getLabelSides: function() {
            var bBox = this.labelBBox, // assume getLabelSize has run at this point
                ...
                leftSide =
                    width *
                        { left: 0, center: 0.5, right: 1 }[labelOptions.align] -
                    labelOptions.x;
        ...
        handleOverflow: function(index, xy) {
            ...
            if (isFirst || isLast) {
                var sides = this.getLabelSides(),
                    ...
                    neighbour =
                        axis.ticks[tickPositions[index + (isFirst ? 1 : -1)]],
                    neighbourEdge =
                        neighbour &&
                        neighbour.label.xy &&
                        neighbour.label.xy.x +
                            neighbour.getLabelSides()[isFirst ? 0 : 1];
    ...
    Axis.prototype = {
        ...
        init: function(chart, userOptions) {
            ...
            axis.tickmarkOffset =
                options.categories && options.tickmarkPlacement === 'between'
                    ? 0.5
                    : 0;
            ...
            if (categories) {
                ...
                while (i-- && ret === UNDEFINED) {
                    ...
                    if (
                        ...
                        ret =
                            numberFormat(value / multi, -1) + numericSymbols[i];
                    }
                }
            }
                    ...
                    if (axis.isXAxis) {
                        ...
                        for (i = 0; i < yDataLength; i++) {
                            ...
                            if (stacking) {
                                ...
                                y = pointStack[x] = defined(pointStack[x])
        ...
        translate: function(
            ...
            var axis = this,
                ...
                returnValue,
                postTranslate =
                    axis.options.ordinal || (axis.isLog && handleLog);
        ...
        getMinorTickPositions: function() {
            ...
            if (axis.isLog) {
                ...
                for (
                    pos =
                        axis.min +
                        ((tickPositions[0] - axis.min) % minorTickInterval);
                    pos <= axis.max;
                ...
                if (linkedParent) {
                    ...
                    each(axis.series, function(series) {
                        ...
                        if (
                            ...
                            defined(seriesClosestPointRange)
                        ) {
        ...
        setTickPositions: function(secondPass) {
            ...
            if (axis.postProcessTickInterval) {
                axis.tickInterval = axis.postProcessTickInterval(
                    axis.tickInterval
                );
            }
            ...
            axis.tickPositions = tickPositions =
                ...
                (tickPositioner &&
                    tickPositioner.apply(axis, [axis.min, axis.max]));
            if (!tickPositions) {
                if (isDatetimeAxis) {
                    tickPositions = (axis.getNonLinearTimeTicks ||
                        getTimeTicks)(
        ...
        adjustTickAmount: function() {
            ...
            if (
                ...
                if (calculatedTickAmount < tickAmount) {
                    ...
                    axis.transA *=
                        (calculatedTickAmount - 1) / (tickAmount - 1);
        ...
        getOffset: function() {
            ...
            axis.offset =
                directionFactor * pick(options.offset, axisOffset[side]);
    ...
    Tooltip.prototype = {
        ...
        getPosition: function(boxWidth, boxHeight, point) {
            ...
            if (y + boxHeight > plotTop + plotHeight) {
                y = mathMax(
                    plotTop,
                    plotTop + plotHeight - boxHeight - distance
                ); // below
            }
        ...
        refresh: function(point, mouseEvent) {
            ...
            if (text === false || !show) {
                ...
                ).call(tooltip, label.width, label.height, {
                    plotX: x,
                    plotY: y,
                });
                ...
                coordinates[isXAxis ? 'xAxis' : 'yAxis'].push({
                    ...
                    value: axis.translate(
                        (isHorizontal
                            ...
                            : axis.top + axis.len - e.chartY) -
                            axis.minPixelPadding, // #1051
                        true
                    ),
                });
            });
            ...
            if (
                ...
                for (j = 0; j < i; j++) {
                    if (
                        ...
                        point._dist = mathAbs(
                            index -
                                point[series[j].xAxis.tooltipPosName || 'plotX']
                        );
    ...
    Legend.prototype = {
        ...
        renderItem: function(item) {
            ...
            if (
                ...
                legend.itemX - initialItemX + itemWidth >
                    (widthOption ||
                        chart.chartWidth - 2 * padding - initialItemX)
            ) {
        ...
        render: function() {
            ...
            if (!legendGroup) {
                ...
                legend.clipRect = renderer.clipRect(
                    0,
                    0,
                    9999,
                    chart.chartHeight
        ...
        handleOverflow: function(legendHeight) {
            ...
            if (legendHeight > spaceHeight) {
                ...
                this.pageCount = pageCount = mathCeil(
                    legendHeight / clipHeight
                );
        ...
        scroll: function(scrollBy, animation) {
            ...
            if (currentPage > 0) {
                ...
                this.down
                    ...
                    .css({
                        cursor:
                            currentPage === pageCount ? 'default' : 'pointer',
                    });
    ...
    Chart.prototype = {
        ...
        pan: function(chartX) {
            ...
            var xAxis = chart.xAxis[0],
                ...
                newMin =
                    xAxis.translate(mouseDownX - chartX, true) + halfPointRange,
                newMax =
                    xAxis.translate(
                        mouseDownX + chart.plotWidth - chartX,
                        true
                    ) - halfPointRange,
                hoverPoints = chart.hoverPoints;
        ...
        getMargins: function() {
            ...
            if (
                ...
                !defined(chart.optionsMarginTop)
            ) {
                titleOffset = mathMax(
                    (chart.title &&
        ...
        initReflow: function() {
            ...
            function reflow(e) {
                var width = optionsChart.width || adapterRun(renderTo, 'width'),
                    height =
                        optionsChart.height || adapterRun(renderTo, 'height'),
                ...
                if (width && height && (target === win || target === doc)) {
                    if (
                        ...
                        chart.reflowTimeout = reflowTimeout = setTimeout(
                            function() {
                                if (chart.container) {
        ...
        setChartSize: function() {
            ...
            chart.plotWidth = plotWidth = mathRound(
                chartWidth - plotLeft - chart.marginRight
            );
            chart.plotHeight = plotHeight = mathRound(
                chartHeight - plotTop - chart.marginBottom
            );
        ...
        init: function(chartEvents) {
            ...
            chart.animation = useCanVG
                ? false
                : pick(optionsChart.animation, true);
    ...
    Point.prototype = {
        ...
        setState: function(state) {
            ...
            if (point.graphic) {
                ...
                if (stateMarkerGraphic) {
                    stateMarkerGraphic[
                        state && chart.isInsidePlot(plotX, plotY)
                            ? 'show'
                            : 'hide'
                    ]();
                }
    ...
    Series.prototype = {
        ...
        setData: function(data, redraw) {
            ...
            series.pointRange =
                xAxis && xAxis.categories ? 1 : options.pointRange;
            ...
            if (dataLength > turboThreshold) {
                ...
                for (i = 0; i < dataLength; i++) {
                    ...
                    xData[i] = pt.x;
                    yData[i] = pointProto.toYData
                        ? pointProto.toYData.call(pt)
                        : pt.y;
                }
            }
            ...
            for (i = 0; i < dataLength; i++) {
                ...
                point.plotY =
                    typeof yValue === 'number'
                        ? mathRound(yAxis.translate(yValue, 0, 1, 0, 1) * 10) /
                          10 // Math.round fixes #591
                        : UNDEFINED;
        ...
        tooltipHeaderFormatter: function(key) {
            ...
            return tooltipOptions.headerFormat
                .replace(
                    '{point.key}',
                    isDateTime && isNumber(key)
                        ? dateFormat(xDateFormat, key)
                        : key
                )
        ...
        animate: function(init) {
            ...
            sharedClipKey =
                '_sharedClip' + animation.duration + animation.easing;
            ...
            if (init) {
                ...
                if (!clipRect) {
                    ...
                    chart[
                        sharedClipKey + 'm'
                    ] = markerClipRect = renderer.clipRect(
        ...
        invertGroups: function() {
            ...
            function setInvert() {
                ...
                each(['group', 'trackerGroup', 'markerGroup'], function(
                    groupName
                ) {
                    if (series[groupName]) {
            ...
            if (tracker) {
                ...
                series.tracker = renderer
                    ...
                    .attr({
                        ...
                        'stroke-width':
                            options.lineWidth + (trackByArea ? 0 : 2 * snap),
                    })
    ...
    var AreaSeries = extendClass(Series, {
         ...
         */
        getSegmentPath: function(segment) {
            var segmentPath = Series.prototype.getSegmentPath.call(
                    this,
                    segment
                ), // call base method
        ...
        closeSegment: function(path, segment) {
            var translatedThreshold = this.yAxis.getThreshold(
    ...
    var ColumnSeries = extendClass(Series, {
        ...
        translate: function() {
            ...
            var points = series.points,
                ...
                translatedThreshold = (series.translatedThreshold = series.yAxis.getThreshold(
                    threshold
                )),
        ...
        alignDataLabel: function(point, dataLabel, options, alignTo, isNew) {
            var chart = this.chart,
                ...
                below =
                    point.below ||
                    point.plotY > (this.translatedThreshold || chart.plotSizeY),
