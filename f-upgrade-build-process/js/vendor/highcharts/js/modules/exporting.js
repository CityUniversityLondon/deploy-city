...
(function() {
    ...
    var g = Highcharts,
        ...
        h = document,
        D = window,
        A = h.documentElement.ontouchstart !== void 0,
        v = g.getOptions();
    n(v.lang, {
    ...
    n(y.prototype, {
        getSVG: function(a) {
            ...
            d = d
                ...
                .replace(/&quot;/g, "'");
            d.match(/ xmlns="/g).length === 2 &&
                (d = d.replace(/xmlns="[^"]+"/, ''));
            return d;
        },
        exportChart: function(a, b) {
            var c,
                d = this.getSVG(s(this.options.exporting.chartOptions, b)),
                a = s(this.options.exporting, a);
            c = r(
                'form',
                {
                    method: 'post',
        ...
        contextMenu: function(a, b, c, d, e, f) {
            ...
            if (!j)
                (i[q] = j = r(
                    ...
                    { position: 'absolute', zIndex: 1e3, padding: l + 'px' },
                    i.container
                )),
                    (m = r(
                        'div',
                        ...
                        if (a) {
                            var b = r(
                                'div',
                                {
                                    ...
                                    innerHTML:
                                        a.text || i.options.lang[a.textKey],
                                },
                                n({ cursor: 'pointer' }, h),
                                m
                            );
                    ...
                    i.exportDivElements.push(m, j),
                    (i.exportMenuWidth = j.offsetWidth),
                    (i.exportMenuHeight = j.offsetHeight);
            a = { display: 'block' };
            c + i.exportMenuWidth > o
                ? (a.right = o - c - e - l + 'px')
                : (a.left = c - l + 'px');
            d + f + i.exportMenuHeight > p
                ? (a.bottom = p - d - l + 'px')
                : (a.top = d + f - l + 'px');
            t(j, a);
        },
        addButton: function(a) {
            ...
            var c = this,
                d = c.renderer,
                e = s(c.options.navigation.buttonOptions, a),
                f = e.onclick,
                g = e.menuItems,
                h = e.width,
                k = e.height,
            ...
            e.enabled !== !1 &&
                ...
                (q = d
                    ...
                    .on('mouseover', function() {
                        p.attr({
                            stroke: e.hoverSymbolStroke,
                            fill: e.hoverSymbolFill,
                        });
                ...
                (p = d
                    ...
                    .add()),
                c.exportSVGElements.push(o, q, p));
        },
        destroyExport: function() {
            var a, b;
            for (a = 0; a < this.exportSVGElements.length; a++)
                (b = this.exportSVGElements[a]),
                    (b.onclick = b.ontouchstart = null),
                    (this.exportSVGElements[a] = b.destroy());
            for (a = 0; a < this.exportDivElements.length; a++)
                (b = this.exportDivElements[a]),
                    B(b, 'mouseleave'),
