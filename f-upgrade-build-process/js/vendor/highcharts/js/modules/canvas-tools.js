    ...
    function m() {
            ...
            this.Length = {
                ...
                EM: function(b) {
                    var d = 12,
                        c = new a.Property(
                            'fontSize',
                            a.Font.Parse(a.ctx.font).fontSize
                        );
        ...
        a.BoundingBox = function(a, d, b, k) {
            ...
            this.isPointInBox = function(b, a) {
                return (
                    this.x1 <= b && b <= this.x2 && this.y1 <= a && a <= this.y2
                );
            };
            this.addPoint(a, d);
            this.addPoint(b, k);
        ...
        a.Transform = function(c) {
            ...
            this.Type.skewX = function(b) {
                ...
                this.m = [
                    1,
                    0,
                    Math.tan(this.angle.Angle.toRadians()),
                    1,
                    0,
                    0,
                ];
        ...
        a.AspectRatio = function(c, d, b, k, e, f, g, j, h, l) {
            ...
            h.hasValue() && l.hasValue()
                ? c.translate(
                      -p * h.Length.toPixels('x'),
                      -p * l.Length.toPixels('y')
                  )
                : (o.match(/^xMid/) &&
                ...
                if (this.style('fill').Definition.isUrl()) {
                    ...
                    (b = this.style('fill')),
                        this.style('fill-opacity').hasValue() &&
                            (b = b.Color.addOpacity(
                                this.style('fill-opacity').value
                            )),
                        (d.fillStyle =
                            b.value == 'none' ? 'rgba(0,0,0,0)' : b.value);
                if (this.style('stroke').Definition.isUrl()) {
                    if (
                        ((b = this.style('stroke').Definition.getFillStyle(
                            this
                        )),
                        b != null)
                    )
        ...
        a.Element.polyline = function(c) {
            ...
            this.getMarkers = function() {
                for (var a = [], b = 0; b < this.points.length - 1; b++)
                    a.push([
                        this.points[b],
                        this.points[b].angleTo(this.points[b + 1]),
                    ]);
                a.push([
                ...
                for (d != null && d.beginPath(); !b.isEnd(); )
                    switch ((b.nextCommand(), b.command.toUpperCase())) {
                        ...
                        case 'H':
                            for (; !b.isCommandOrEnd(); )
                                (e = new a.Point(
                                    (b.isRelativeCommand() ? b.current.x : 0) +
                                        b.getScalar(),
                                    b.current.y
                                )),
                                    ...
                                    d != null &&
                                        d.lineTo(b.current.x, b.current.y);
                            break;
                        case 'V':
                            for (; !b.isCommandOrEnd(); )
                                (e = new a.Point(
                                    b.current.x,
                                    (b.isRelativeCommand() ? b.current.y : 0) +
                                        b.getScalar()
                                )),
                                    b.addMarker(e, b.current),
                                    (b.current = e),
                        ...
                        case 'Q':
                            for (; !b.isCommandOrEnd(); )
                                (g = b.current),
                                    ...
                                    d != null &&
                                        d.quadraticCurveTo(j.x, j.y, e.x, e.y);
                            break;
                        case 'T':
                            for (; !b.isCommandOrEnd(); )
                                (g = b.current),
        ...
        a.Element.marker = function(c) {
            ...
            this.render = function(d, b, c) {
                ...
                e.attributes.refX = new a.Property(
                    'refX',
                    this.attribute('refX').value
                );
                e.attributes.refY = new a.Property(
                    'refY',
                    this.attribute('refY').value
                );
        ...
        a.Element.GradientBase = function(c) {
            ...
            this.createGradient = function(d, b) {
                ...
                for (
                    var e = this.getGradient(d, b), f = 0;
                    f < c.stops.length;
                    f++
                )
                ...
                if (this.attribute('gradientTransform').hasValue()) {
                    ...
                    f.attributes.x = new a.Property(
                        'x',
                        -a.MAX_VIRTUAL_PIXELS / 3
                    );
                    f.attributes.y = new a.Property(
                        'y',
                        -a.MAX_VIRTUAL_PIXELS / 3
                    );
                    f.attributes.width = new a.Property(
                        'width',
                        a.MAX_VIRTUAL_PIXELS
                    );
                    f.attributes.height = new a.Property(
                        'height',
                        a.MAX_VIRTUAL_PIXELS
                    );
                ...
                var c = b.getBoundingBox(),
                    e =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.x() +
                              c.width() * this.attribute('x1').numValue()
                            : this.attribute('x1').Length.toPixels('x'),
                    f =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.y() +
                              c.height() * this.attribute('y1').numValue()
                            : this.attribute('y1').Length.toPixels('y'),
                    g =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.x() +
                              c.width() * this.attribute('x2').numValue()
                            : this.attribute('x2').Length.toPixels('x'),
                    c =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.y() +
                              c.height() * this.attribute('y2').numValue()
                            : this.attribute('y2').Length.toPixels('y');
            ...
            this.getGradient = function(a, b) {
                var c = b.getBoundingBox(),
                    e =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.x() +
                              c.width() * this.attribute('cx').numValue()
                            : this.attribute('cx').Length.toPixels('x'),
                    f =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.y() +
                              c.height() * this.attribute('cy').numValue()
                ...
                this.attribute('fx').hasValue() &&
                    (g =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.x() +
                              c.width() * this.attribute('fx').numValue()
                            : this.attribute('fx').Length.toPixels('x'));
                this.attribute('fy').hasValue() &&
                    (j =
                        this.gradientUnits == 'objectBoundingBox'
                            ? c.y() +
                              c.height() * this.attribute('fy').numValue()
            ...
            this.update = function(a) {
                ...
                if (this.duration > this.maxDuration)
                    if (this.attribute('repeatCount').value == 'indefinite')
                        ...
                        return this.attribute('fill').valueOrDefault(
                            'remove'
                        ) == 'remove' && !this.removed
                            ? ((this.removed = !0),
            ...
            if (c != null) {
                ...
                for (var d = 0; d < c.childNodes.length; d++) {
                    ...
                    b.nodeType == 1
                        ? this.addChild(b, !0)
                        : b.nodeType == 3 &&
                          this.addChild(new a.Element.tspan(b), !1);
                }
            }
            this.baseSetContext = this.setContext;
            ...
            this.renderChildren = function(c) {
                ...
                if (b != null) {
                    ...
                    for (
                        ...
                        c.translate(-this.x, -this.y);
                        this.x +=
                            (k * (h.horizAdvX || b.horizAdvX)) /
                            b.fontFace.unitsPerEm;
                        typeof g[j] != 'undefined' &&
                            !isNaN(g[j]) &&
                            (this.x += g[j]);
                    }
                } else
            ...
            this.measureText = function(c) {
                ...
                if (b != null) {
                    ...
                    for (
                        ...
                        k +=
                            ((j.horizAdvX || b.horizAdvX) * c) /
                            b.fontFace.unitsPerEm;
                        typeof f[g] != 'undefined' &&
                            !isNaN(f[g]) &&
                            (k += f[g]);
                    }
                    return k;
        ...
        a.Element.use = function(c) {
            ...
            this.getDefinition = function() {
                ...
                if (this.attribute('width').hasValue())
                    a.attribute('width', !0).value = this.attribute(
                        'width'
                    ).value;
                if (this.attribute('height').hasValue())
                    a.attribute('height', !0).value = this.attribute(
                        'height'
                    ).value;
                return a;
            };
        ...
        a.Element.clipPath = function(c) {
            ...
            this.apply = function(a) {
                for (var b = 0; b < this.children.length; b++)
                    this.children[b].path &&
                        (this.children[b].path(a), a.clip());
            };
            this.render = function() {};
        };
        ...
        a.Element.MISSING = function(a) {
            console.log(
                "ERROR: Element '" + a.nodeName + "' not yet implemented."
            );
        };
