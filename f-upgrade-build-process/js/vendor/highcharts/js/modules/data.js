    ...
    m.extend(n.prototype, {
        ...
        parseCSV: function() {
            var a = this.options,
                ...
                e = a.startColumn || 0,
                j = a.endColumn || Number.MAX_VALUE;
            b &&
                ((b = b.split(a.lineDelimiter || '\n')),
                l(b, function(b, k) {
                    if (k >= c && k <= f) {
        ...
        parseTable: function() {
            ...
            b &&
                ...
                l(b.getElementsByTagName('tr'), function(a, b) {
                    g = 0;
                    b >= c &&
                        b <= f &&
                        l(a.childNodes, function(a) {
                            if (
        ...
        parseTypes: function() {
            for (var a = this.columns, b = a.length, d, c, f, e; b--; )
                for (d = a[b].length; d--; )
                    (c = a[b][d]),
                        (f = parseFloat(c)),
                        (e = this.trim(c)),
                        e == f
                            ? ((a[b][d] = f),
                              f > 31536e6
                                  ...
                                  : (a[b].isNumeric = !0))
                            : ((c = Date.parse(c)),
                              b === 0 && typeof c === 'number' && !isNaN(c)
                                  ? ((a[b][d] = c), (a[b].isDatetime = !0))
                                  : (a[b][d] = e));
        },
        parsed: function() {
        ...
        complete: function() {
            ...
            if (e.complete) {
                a.length > 1 &&
                    ((c = a.shift()),
                    this.headerRow === 0 && c.shift(),
                    (b = c.isNumeric || c.isDatetime) || (d = c),
                    c.isDatetime && (f = 'datetime'));
                j = [];
