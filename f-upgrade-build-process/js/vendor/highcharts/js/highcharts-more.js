...
(function(h, u) {
    ...
    function B(a, b) {
        ...
        if (c.polar) {
            if (c.renderer.isSVG)
                if ((d === !0 && (d = {}), b)) {
                    if (
                        ((e.attrSetters.scaleX = e.attrSetters.scaleY = function(
                            a,
                            b
                        ) {
                            this[b] = a;
                        ...
                        (g.attrSetters = e.attrSetters), g.attr(c);
                } else
                    (c = {
                        translateX: j,
                        translateY: n,
    ...
    v(z.prototype, {
        init: function(a, b, c) {
            ...
            d.options = a = o(e, a);
            (a = a.background) &&
                p([].concat(h.splat(a)).reverse(), function(a) {
    ...
    var x = r.prototype,
        ...
        F = {
            ...
            getOffset: function() {
                ...
                this.center = this.pane.center = i.pie.prototype.getCenter.call(
                    this.pane
                );
            },
            ...
            getPosition: function(a, b) {
                ...
                return this.postTranslate(
                    this.translate(a),
                    m(b, this.center[2] / 2) - this.offset
                );
            },
            ...
            getPlotBandPath: function(a, b, c) {
                ...
                this.options.gridLineInterpolation === 'polygon'
                    ...
                    : (C ||
                          ((f[0] = this.translate(a)),
                          (f[1] = this.translate(b))),
                      (f = D(f, function(a) {
    ...
    l(x, 'init', function(a, b, c) {
        ...
        if (!j && (e || g)) {
            ...
            this.endAngleRad = g =
                ((m(g.endAngle, g.startAngle + 360) - 90) * Math.PI) / 180;
            this.offset = a.offset || 0;
            if ((this.isCircular = n) && c.max === u && g - e === 2 * Math.PI)
                this.autoConnect = !0;
        }
    });
    ...
    l(r, 'getLabelPosition', function(a, b, c, d, e, g, f, j, n) {
        var h = this.axis,
            ...
            l = g.align,
            k =
                ((h.translate(this.pos) + h.startAngleRad + Math.PI / 2) /
                    Math.PI) *
                180;
        h.isRadial
            ? ((a = h.getPosition(
                  this.pos,
                  h.center[2] / 2 + m(g.distance, -25)
              )),
              g.rotation === 'auto'
                  ? d.attr({ rotation: k })
                  : i === null &&
                    (i = w(d.styles.lineHeight) * 0.9 - d.getBBox().height / 2),
              l === null &&
                  ((l = h.isCircular
                      ? k > 20 && k < 160
                          ? 'left'
    ...
    i.arearange = h.extendClass(i.area, {
        ...
        getSegmentPath: function(a) {
            for (
                var b = [], c = a.length, d = y.prototype.getSegmentPath, e;
                c--;
    ...
    k = {
        ...
        translate: function() {
            ...
            p(a.points, function(d) {
                ...
                d.shapeArgs = {
                    ...
                    translateY: c[1],
                    rotation:
                        ((b.startAngleRad + b.translate(d.y)) * 180) / Math.PI,
                };
                d.plotX = c[0];
                d.plotY = c[1];
            });
        ...
        drawPoints: function() {
            ...
            p(a.points, function(b) {
                ...
                c
                    ? (c.animate(e), (e.d = h))
                    : (b.graphic = a.chart.renderer[b.shapeType](e)
                          .attr({
            ...
            c
                ? c.animate({ cx: b[0], cy: b[1] })
                : (a.pivot = a.chart.renderer
                      .circle(b[0], b[1], m(e.radius, 5))
                      .attr({
    ...
    l(t, 'setTooltipPoints', function(a, b) {
        this.chart.polar &&
            v(this.xAxis, { tooltipLen: 360, tooltipPosName: 'deg' });
        return a.call(this, b);
    });
