...
(function() {
    ...
    function z(a, b, c) {
        ...
        else if (t(b) && X(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function na(a) {
        return Ha(a) ? a : [a];
    ...
    function Ia(a, b, c, d) {
        ...
        b === -1
            ? ((b = (a || 0).toString()),
              (a = b.indexOf('.') > -1 ? b.split('.')[1].length : 0))
            : (a = isNaN((b = L(b))) ? 2 : b);
        var b = a,
            c = c === void 0 ? e.decimalPoint : c,
            d = d === void 0 ? e.thousandsSep : d,
            e = f < 0 ? '-' : '',
            a = String(w((f = L(+f || 0).toFixed(b)))),
            g = a.length > 3 ? a.length % 3 : 0;
        return (
            e +
            (g ? a.substr(0, g) + d : '') +
            a.substr(g).replace(/(\d{3})(?=\d)/g, '$1' + d) +
            (b
                ? c +
                  L(f - a)
                      .toFixed(b)
    ...
    function Nb(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (
                ...
                (e = B[d[0]]),
                (f = d[1]),
                c[g + 1] && a <= (e * f[f.length - 1] + B[c[g + 1][0]]) / 2)
            )
                break;
    ...
    function Ob(a, b, c, d) {
        ...
        b >= B[ib] &&
            (i.setMilliseconds(0),
            i.setSeconds(b >= B[Ua] ? 0 : j * T(i.getSeconds() / j)));
        if (b >= B[Ua]) i[Ab](b >= B[Ja] ? 0 : j * T(i[jb]() / j));
        if (b >= B[Ja]) i[Bb](b >= B[oa] ? 0 : j * T(i[kb]() / j));
        if (b >= B[oa]) i[lb](b >= B[Ka] ? 1 : j * T(i[La]() / j));
        b >= B[Ka] &&
            (i[Cb](b >= B[ta] ? 0 : j * T(i[Wa]() / j)), (h = i[Xa]()));
        b >= B[ta] && ((h -= h % j), i[Db](h));
        ...
        for (
            var k = i.getTime(),
                l = i[Wa](),
                m = i[La](),
                i = g ? 0 : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5;
            k < c;
            ...
            e.push(k),
                b === B[ta]
                    ...
                    : b === B[Ka]
                        ? (k = Ya(h, l + d * j))
                        : !g && (b === B[oa] || b === B[Va])
                            ? (k = Ya(h, l, m + d * j * (b === B[oa] ? 1 : 7)))
                            : ((k += b * j),
                              b <= B[Ja] && k % B[oa] === i && (f[k] = oa)),
                d++;
        e.push(k);
    ...
    function Hb(a, b, c, d, e, f) {
        ...
        this.alignOptions = {
            ...
            verticalAlign:
                b.verticalAlign || (g ? 'middle' : c ? 'bottom' : 'top'),
            y: o(b.y, g ? 4 : c ? 14 : -6),
            x: o(b.x, g ? (c ? -6 : 6) : 0),
        };
    ...
    var x,
        ...
        Ib = K.opera,
        Ca = /msie/i.test(Fa) && !Ib,
        Qa = C.documentMode === 8,
        tb = /AppleWebKit/.test(Fa),
        bb = /Firefox/.test(Fa),
        pa = 'http://www.w3.org/2000/svg',
        Z = !!C.createElementNS && !!C.createElementNS(pa, 'svg').createSVGRect,
        Pb = bb && parseInt(Fa.split('Firefox/')[1], 10) < 4,
        U = !Z && !Ca && !!C.createElement('canvas').getContext,
        Ra,
        fa = C.documentElement.ontouchstart !== x,
        Jb = {},
        ub = 0,
        Za,
        M,
        ...
        ia = 'div',
        R = 'none',
        wb = 'rgba(192,192,192,' + (Z ? 1.0e-6 : 0.002) + ')',
        zb = 'millisecond',
        ib = 'second',
        Ua = 'minute',
        Ja = 'hour',
        ...
        K.HighchartsAdapter =
            ...
            (a && {
                init: function(b) {
                    ...
                    a.each(['cur', '_default', 'width', 'height'], function(
                        a,
                        b
                    ) {
                        var e = d,
                ...
                fireEvent: function(b, c, d, e) {
                    ...
                    a.each(['preventDefault', 'stopPropagation'], function(
                        a,
                        b
                    ) {
                        var c = f[b];
    ...
    M = {
        ...
        global: {
            useUTC: !0,
            canvasToolsURL:
                'http://code.highcharts.com/2.3.3/modules/canvas-tools.js',
            VMLRadialGradientURL:
                'http://code.highcharts.com/2.3.3/gfx/vml-radial-gradient.png',
        },
        chart: {
            borderColor: '#4572A7',
            borderRadius: 5,
    ...
    var qa = function(a) {
        ...
        (function(a) {
            (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(
                ...
                ? (b = [w(c[1]), w(c[2]), w(c[3]), parseFloat(c[4], 10)])
                : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(
                      a
                  )) && (b = [w(c[1], 16), w(c[2], 16), w(c[3], 16), 1]);
        })(a);
        return {
            get: function(c) {
                return b && !isNaN(b[0])
    ...
    va.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (la(a))
                (c = a),
                    ...
                    (u = z(g, c) || this[c] || 0),
                    c !== 'd' && c !== 'visibility' && (u = parseFloat(u));
            else
                for (c in a)
                    if (
                        ((j = !1),
                        ...
                        if (
                            l &&
                            /^(width|height|visibility|x|y|d|transform)$/.test(
                                c
                            )
                        )
                            for (e = l.length; e--; )
        ...
        symbolAttr: function(a) {
            ...
            b.attr({
                d: b.renderer.symbols[b.symbolName](
                    b.x,
                    b.y,
                    b.width,
                    b.height,
        ...
        crisp: function(a, b, c, d, e) {
            var f,
                ...
                a =
                    a ||
                    this.strokeWidth ||
                    (this.attr && this.attr('stroke-width')) ||
                    0;
            i = (s(a) % 2) / 2;
            h.x = T(b || this.x || 0) + i;
            h.y = T(c || this.y || 0) + i;
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === 'SPAN') {
                    ...
                    var q = this.xCorr || 0,
                        D = this.yCorr || 0,
                        aa = [j, g, b.innerHTML, this.textWidth].join(',');
                    k = {};
                    if (aa !== this.cTT) {
                        if (t(j))
                            a.isSVG
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG && ((b = a.width), (c = a.height), d))
                    (a.width = L(c * Y(g)) + L(b * V(g))),
                        (a.height = L(c * V(g)) + L(b * Y(g)));
                if (
                    Ca &&
                    f &&
                    f.fontSize === '11px' &&
                    c === 22.700000762939453
                )
                    a.height = 14;
                this.bBox = a;
            }
    ...
    ra.prototype = {
        ...
        init: function(a, b, c, d) {
            ...
            this.alignedObjects = [];
            this.url =
                (bb || tb) && C.getElementsByTagName('base').length
                    ? e.href
                          .replace(/#.*?$/, '')
                          .replace(/([\('\)])/g, '\\$1')
                          .replace(/ /g, '%20')
        ...
        button: function(a, b, c, d, e, f, g) {
            ...
            f = A(
                ...
                ka(
                    ...
                    '#68A',
                    'fill',
                    ka('linearGradient', a, 'stops', [[0, '#FFF'], [1, '#ACF']])
                ),
                f
            );
            m = f.style;
            ...
            g = A(
                ...
                ka(
                    ...
                    '#68A',
                    'fill',
                    ka('linearGradient', a, 'stops', [[0, '#9BD'], [1, '#CDF']])
                ),
                g
            );
            p = g.style;
        ...
        setSize: function(a, b, c) {
            ...
            this.height = b;
            for (
                this.boxWrapper[o(c, !0) ? 'animate' : 'attr']({
                    width: a,
                    height: b,
                });
                e--;
        ...
        color: function(a, b, c) {
            ...
            if (g) {
                ...
                return f.test(a)
                    ? ((e = qa(a)),
                      z(b, c + '-opacity', e.get('a')),
                      e.get('rgb'))
                    : (b.removeAttribute(c + '-opacity'), a);
        },
        text: function(a, b, c, d) {
            var e = M.chart.style,
                f = U || (!Z && this.forExport);
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                var a = p.styles,
                    ...
                    c;
                c = h ? 0 : yb;
                if (t(Ga) && (a === 'center' || a === 'right'))
                    b += { center: 0.5, right: 1 }[a] * (Ga - q.width);
            ...
            g.text = function(a, b) {
                ...
                c = u.element.style;
                q =
                    (Ga === void 0 || v === void 0 || p.styles.textAlign) &&
                    u.getBBox();
                ...
                css: function(a) {
                    if (a) {
                        var b = {},
                            a = A({}, a);
                        n(
                            'fontSize,fontWeight,fontFamily,color,lineHeight,width'.split(
                                ','
                            ),
                            function(c) {
    ...
    if (!Z && !U) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                ((f.getElementsByTagName('stroke')[0] ||
                                    Q(i.prepVML(['<stroke/>']), null, null, f))[
                                    c
                                ] = d || 'solid'),
                                    (this.dashstyle = d),
                                    (m = !0);
                                ...
                                (this[c] = d),
                                    (f.style.left = -s(Y(d * ab) + 1) + 'px'),
                                    (f.style.top = s(V(d * ab)) + 'px');
                            else if (
                                c === 'translateX' ||
                                c === 'translateY' ||
                                c === 'rotation'
            ...
            clip: function(a) {
                ...
                a
                    ? ((c = a.members),
                      ...
                      e &&
                          e.className === 'highcharts-tracker' &&
                          !Qa &&
                          H(d, { visibility: 'hidden' }),
                      (a = a.getCSS(b)))
                    : (b.destroyClip && b.destroyClip(),
                      (a = { clip: Qa ? 'inherit' : 'rect(auto)' }));
                return b.css(a);
            },
        ...
        var ha = {
            ...
            clipRect: function(a, b, c, d) {
                ...
                return r(e, {
                    ...
                    getCSS: function(a) {
                        ...
                        !b &&
                            Qa &&
                            a.element.nodeName !== 'IMG' &&
                            r(c, { width: e + 'px', height: f + 'px' });
                        return c;
                    },
                        ...
                        if (i === 'gradient')
                            ...
                            var j = m.r,
                                ...
                                j = function() {
                                    A &&
                                        ((w = d.getBBox()),
                                        (y += (A[0] - w.x) / w.width - 0.5),
                                        (x += (A[1] - w.y) / w.height - 0.5),
                                        (r *= A[2] / w.width),
                                        (P *= A[2] / w.height));
                                    t =
                                        'src="' +
            ...
            image: function(a, b, c, d, e) {
                ...
                arguments.length > 1 &&
                    f.attr({ x: b, y: c, width: d, height: e });
                return f;
            },
            rect: function(a, b, c, d, e, f) {
                if (X(a))
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var f = a + c,
                        ...
                        h;
                    !t(e) || !e.r
                        ? (f = ra.prototype.symbols.square.apply(0, arguments))
                        : ((h = O(e.r, c, d)),
                          (f = [
                              'M',
                              a + h,
    ...
    Pa.prototype = {
        addLabel: function() {
            ...
            a.isDatetimeAxis &&
                h &&
                (l = b.dateTimeLabelFormats[h.higherRanks[f] || h.unitName]);
            this.isFirst = i;
            this.isLast = j;
            ...
            return {
                x: a
                    ...
                    : e.left +
                      e.offset +
                      (e.opposite
                          ? ((d && f.oldChartWidth) || f.chartWidth) -
                            e.right -
                            e.left
                          : 0),
                y: a
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            ...
            t(e.y) ||
                (b += w(c.styles.lineHeight) * 0.9 - c.getBBox().height / 2);
            i && (b += ((g / (h || 1)) % i) * 16);
            return { x: a, y: b };
        },
        getMarkPath: function(a, b, c, d, e, f) {
            return f.crispLine(
                ['M', a, b, 'L', a + (e ? 0 : -c), b + (e ? c : 0)],
                d
            );
        },
        render: function(a, b) {
            ...
            if (l && q)
                t === 'inside' && (q = -q),
                    c.opposite && (q = -q),
                    (g = this.getMarkPath(P, r, q, l, f, e)),
                    m
                        ? m.animate({ d: g })
                        : (this.mark = e
                              .path(g)
                              .attr({ stroke: D, 'stroke-width': l })
                              .add(c.axisGroup));
            if (h && !isNaN(P))
                (h.xy = r = this.getLabelPosition(P, r, h, f, j, F, a, s)),
                    (this.isFirst && !o(d.showFirstLabel, 1)) ||
                    (this.isLast && !o(d.showLastLabel, 1))
                        ? (v = !1)
                        : !y &&
                          f &&
                          j.overflow === 'justify' &&
                          !this.handleOverflow(a, r) &&
                          (v = !1),
                    s && a % s && (v = !1),
                    v
                        ? (h[this.isNew ? 'attr' : 'animate'](r),
                          h.show(),
                          (this.isNew = !1))
                        : h.hide();
        },
    ...
    nb.prototype = {
        render: function() {
            ...
            if (h) {
                if (
                    ((u = b.getPlotLinePath(l, h)),
                    (d = { stroke: q, 'stroke-width': h }),
                    m)
                )
                    d.dashstyle = m;
            } else if (k) {
                if (
                    ((j = y(j, b.min - d)),
                    (i = O(i, b.max + d)),
                    (u = b.getPlotBandPath(j, i, e)),
                    (d = { fill: q }),
                    e.borderWidth)
                )
                    (d.stroke = e.borderColor),
                        (d['stroke-width'] = e.borderWidth);
            } else return;
            if (t(D)) d.zIndex = D;
            if (p)
                u
                    ? p.animate({ d: u }, null, p.onGetPath)
                    : (p.hide(),
    ...
    ob.prototype = {
        ...
        init: function(a, b) {
            ...
            this.tickmarkOffset =
                d.categories && d.tickmarkPlacement === 'between' ? 0.5 : 0;
            this.ticks = {};
            this.minorTicks = {};
        ...
        setOptions: function(a) {
            this.options = A(
                ...
                A(M[this.isXAxis ? 'xAxis' : 'yAxis'], a)
            );
        },
        defaultLabelFormatter: function() {
            var a = this.axis,
                ...
                d = M.lang.numericSymbols,
                e = d && d.length,
                f,
                g = a.isLog ? b : a.tickInterval;
            if (a.categories) f = b;
            else if (c) f = cb(c, b);
            else if (e && g >= 1e3)
                for (; e-- && f === x; )
                    (a = Math.pow(1e3, e + 1)),
                        g >= a && d[e] !== null && (f = Ia(b / a, -1) + d[e]);
                ...
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (((h = g.xData), h.length))
                            (a.dataMin = O(o(a.dataMin, h[0]), Ma(h))),
                                (a.dataMax = y(o(a.dataMax, h[0]), Da(h)));
                    } else {
                        var F,
                            w,
                            P,
                        ...
                        if (!a.usePercentage && r.length)
                            (a.dataMin = O(o(a.dataMin, r[0]), Ma(r))),
                                (a.dataMax = y(o(a.dataMax, r[0]), Da(r)));
                        if (t(D))
                            if (a.dataMin >= D)
        ...
        getPlotLinePath: function(a, b, c) {
            ...
            if (isNaN(a)) l = !0;
                ...
                ((c = e), (h = k - this.right), g < f || g > f + this.height)
            )
                l = !0;
            return l
                ? null
                : d.renderer.crispLine(['M', c, g, 'L', h, i], b || 0);
        },
        ...
        getLinearTickPositions: function(a, b, c) {
            for (
                var d, b = ea(T(b / a) * a), c = ea(wa(c / a) * a), e = [];
                b <= c;
        ...
        getLogTickPositions: function(a, b, c, d) {
            ...
            if (a >= 0.5)
                ...
                (a = hb(a, null, J.pow(10, T(J.log(a) / J.LN10)))),
        ...
        getMinorTickPositions: function() {
            ...
            if (this.isLog) {
                ...
                for (d = 1; d < e; d++)
                    c = c.concat(
                        this.getLogTickPositions(b, a[d - 1], a[d], !0)
                    );
            } else
                for (
                    a = this.min + ((a[0] - this.min) % b);
                    a <= this.max;
                    a += b
                )
                    c.push(a);
        ...
        adjustForMinRange: function() {
            ...
            if (this.isXAxis && this.minRange === x && !this.isLog)
                t(a.min) || t(a.max)
                    ...
                    : (n(this.series, function(a) {
                          i = a.xData;
                          for (
                              g = j = a.xIncrement ? 1 : i.length - 1;
                              g > 0;
                              g--
                          )
                              if (((h = i[g] - i[g - 1]), f === x || h < f))
                                  f = h;
                      }),
            ...
            if (c - b < this.minRange) {
                ...
                c = Ma(c);
                c - b < k &&
                    ((d[0] = c - k), (d[1] = o(a.min, c - k)), (b = Da(d)));
            }
            this.min = b;
            this.max = c;
        },
        ...
        setTickPositions: function(a) {
            ...
            h
                ? ((b.linkedParent = c[g ? 'xAxis' : 'yAxis'][d.linkedTo]),
                  ...
                  d.type !== b.linkedParent.options.type && $a(11, 1))
                : ((b.min = o(b.userMin, d.min, b.dataMin)),
                  (b.max = o(b.userMax, d.max, b.dataMax)));
            if (e)
                !a && O(b.min, o(b.dataMin, b.min)) <= 0 && $a(10, 1),
                    (b.min = ea(ma(b.min))),
                    (b.max = ea(ma(b.max)));
            if (
                b.range &&
                ((b.userMin = b.min = y(b.min, b.max - b.range)),
                (b.userMax = b.max),
                a)
            )
                b.range = null;
            ...
            b.tickInterval =
                b.min === b.max || b.min === void 0 || b.max === void 0
                    ...
                    : h && !l && p === b.linkedParent.options.tickPixelInterval
                        ? b.linkedParent.tickInterval
                        : o(l, u ? 1 : ((b.max - b.min) * p) / (b.len || 1));
            g &&
                !a &&
            ...
            if (
                !f &&
                !e &&
                ((a = J.pow(10, T(J.log(b.tickInterval) / J.LN10))), !l)
            )
                b.tickInterval = hb(b.tickInterval, null, a, d);
            b.minorTickInterval =
                d.minorTickInterval === 'auto' && b.tickInterval
                    ? b.tickInterval / 5
                    : d.minorTickInterval;
            b.tickPositions = i =
                d.tickPositions || (i && i.apply(b, [b.min, b.max]));
            if (!i)
                (i = f
                    ? (b.getNonLinearTimeTicks || Ob)(
                          Nb(b.tickInterval, d.units),
                          b.min,
                          b.max,
                          d.startOfWeek,
                          b.ordinalPositions,
            ...
            if (m && m.text) {
                if (!a.axisTitle)
                    (a.axisTitle = c
                        ...
                        (a.axisTitle.isNew = !0);
                if (i)
                    (j = a.axisTitle.getBBox()[g ? 'height' : 'width']),
                        (l = o(m.margin, g ? 5 : 10)),
                        (k = m.offset);
                a.axisTitle[i ? 'show' : 'hide']();
            }
            a.offset = q * o(d.offset, da[h]);
            a.axisTitleMargin = o(
                k,
                u + l + (h !== 2 && u && q * d.labels[g ? 'y' : 'x'])
            );
        ...
        getLinePath: function(a) {
            ...
            this.lineTop = c =
                b.chartHeight - this.bottom - (c ? this.height : 0) + d;
        ...
        render: function() {
            var a = this,
                ...
                o = d.lineWidth,
                q,
                D = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin),
                r = a.showAxis,
                s,
                v;
            if (a.hasData || f)
                if (
                    ...
                    n((d.plotLines || []).concat(d.plotBands || []), function(
                        b
                    ) {
    ...
    pb.prototype = {
        ...
        getPosition: function(a, b, c) {
            ...
            d < 7 && (d = e + y(j, 0) + i);
            d + a > e + g &&
                ((d -= d + a - (e + g)), (k = c - b + f - i), (l = !0));
            k < f + 5 &&
                ((k = f + 5), l && c >= k && c <= k + b && (k = c + f + i));
        ...
        refresh: function(a, b) {
            function c() {
                ...
                n(a, function(a) {
                    b = a.series;
                    c.push(
                        (b.tooltipFormatter && b.tooltipFormatter(a)) ||
                            a.point.tooltipFormatter(
                                b.tooltipOptions.pointFormat
                            )
                    );
                });
            ...
            g = h[0];
            h = h[1];
            i && (!a.series || !a.series.noSharedTooltip)
                ? ((d.hoverPoints = a),
                  j &&
                      n(j, function(a) {
                          a.setState();
            ...
            i =
                i ||
                !j.isCartesian ||
                j.tooltipOutsidePlot ||
                d.isInsidePlot(g, h);
            k === !1 || !i
                ? this.hide()
                : (this.isHidden && e.show(),
                  e.attr({ text: k }),
                  (m = f.borderColor || a.color || j.color || '#606060'),
                  e.attr({ stroke: m }),
                  (e = (f.positioner || this.getPosition).call(
                      this,
                      e.width,
                      e.height,
                      { plotX: g, plotY: h }
                  )),
                  this.move(s(e.x), s(e.y), g + d.plotLeft, h + d.plotTop),
                  (this.isHidden = !1));
            if (p) {
                p = na(p);
                for (e = p.length; e--; )
                    if (((i = a.series[e ? 'yAxis' : 'xAxis']), p[e] && i))
                        if (
                            ((i = i.getPlotLinePath(
                                e ? o(a.stackY, a.y) : a.x,
                                1
                            )),
                            this.crosshairs[e])
                        )
                            this.crosshairs[e].attr({
                                d: i,
                                visibility: 'visible',
                            });
                        else {
    ...
    qb.prototype = {
        normalizeMouseEvent: function(a) {
            ...
            d.pageX === x
                ? ((c = a.x), (b = a.y))
                : ((c = d.pageX - b.left), (b = d.pageY - b.top));
                ...
                b[e ? 'xAxis' : 'yAxis'].push({
                    ...
                    value: d.translate(
                        ((c.inverted
                          ...
                          : e)
                            ? a.chartX - c.plotLeft
                            : d.top + d.len - a.chartY) - d.minPixelPadding,
                        !0
                    ),
                });
            });
                ...
                for (i = 0; i < h; i++)
                    if (
                        ...
                        (b = c[i].tooltipPoints[k]),
                            (b._dist = L(
                                k - b[c[i].xAxis.tooltipPosName || 'plotX']
                            )),
                            (j = O(j, b._dist)),
                            e.push(b);
                for (h = e.length; h--; ) e[h]._dist > j && e.splice(h, 1);
                if (e.length && e[0].plotX !== this.hoverX)
                    d.refresh(e, a), (this.hoverX = e[0].plotX);
            }
            if (g && g.tracker && (b = g.tooltipPoints[k]) && b !== f)
                b.onMouseOver();
        },
        ...
        setDOMEvents: function() {
            ...
            b.hideTooltipOnMouseMove = function(a) {
                ...
                b.chartPosition &&
                    c.hoverSeries &&
                    c.hoverSeries.isCartesian &&
                    !c.isInsidePlot(
                        a.pageX - b.chartPosition.left - c.plotLeft,
                        a.pageY - b.chartPosition.top - c.plotTop
                    ) &&
                    b.resetTracker();
            };
            ...
            var h = function(a) {
                if (!a || !(a.touches && a.touches.length > 1)) {
                    ...
                    fa &&
                        a.type === 'touchstart' &&
                        (z(a.target, 'isTracker')
                            ? c.runTrackerClick || a.preventDefault()
                            : !c.runChartClick && !l && a.preventDefault());
                    if (l)
                        d < c.plotLeft
                            ? (d = c.plotLeft)
                            : d > c.plotLeft + c.plotWidth &&
                              (d = c.plotLeft + c.plotWidth),
                            h < c.plotTop
                                ? (h = c.plotTop)
                                : h > c.plotTop + c.plotHeight &&
                                  (h = c.plotTop + c.plotHeight);
                    if (
                        c.mouseIsDown &&
                        a.type !== 'touchstart' &&
                        ((e = Math.sqrt(
                            Math.pow(b.mouseDownX - d, 2) +
                                Math.pow(b.mouseDownY - h, 2)
                        )),
                        e > 10)
                    ) {
                        var m = c.isInsidePlot(
                            b.mouseDownX - c.plotLeft,
                            b.mouseDownY - c.plotTop
                        );
                        if (
                            ...
                            b.selectionMarker = c.renderer
                                ...
                                .attr({
                                    fill:
                                        b.options.chart.selectionMarkerFill ||
            ...
            d.onclick = function(a) {
                ...
                if (!c.cancelClick)
                    d &&
                    (z(a.target, 'isTracker') ||
                        z(a.target.parentNode, 'isTracker'))
                        ? ((e = d.plotX),
                          (f = d.plotY),
                          r(d, {
                              pageX:
                                  b.chartPosition.left +
                                  c.plotLeft +
                                  (c.inverted ? c.plotWidth - f : e),
                              pageY:
                                  b.chartPosition.top +
                                  c.plotTop +
                                  (c.inverted ? c.plotHeight - e : f),
                          }),
                          E(d.series, 'click', r(a, { point: d })),
                          d.firePointEvent('click', a))
                        : (r(a, b.getMouseCoordinates(a)),
                          c.isInsidePlot(
                              a.chartX - c.plotLeft,
                              a.chartY - c.plotTop
                          ) && E(c, 'click', a));
    ...
    rb.prototype = {
        ...
        positionItem: function(a) {
            var b = this.options,
                ...
                f = a.checkbox;
            a.legendGroup &&
                a.legendGroup.translate(
                    b ? e : this.legendWidth - e - 2 * c - 4,
                    d
                );
            if (f) (f.x = e), (f.y = d);
        },
        ...
        positionCheckboxes: function() {
            ...
            n(a.allItems, function(b) {
                ...
                c &&
                    H(c, {
                        left:
                            d.translateX + b.legendItemWidth + c.x - 20 + 'px',
        ...
        renderItem: function(a) {
            ...
            d = q.getBBox();
            (u = a.legendItemWidth =
                e.itemWidth || g + h + d.width + k + (s ? 20 : 0)),
                (e = u);
            b.itemHeight = g = d.height;
            if (f && b.itemX - n + e > (m || c.chartWidth - 2 * k - n))
                (b.itemX = n),
                    (b.itemY += o + b.lastLineHeight + p),
                    (b.lastLineHeight = 0);
            b.maxItemWidth = y(b.maxItemWidth, e);
            b.lastItemY = o + b.itemY + p;
            b.lastLineHeight = y(g, b.lastLineHeight);
            a._legendItemPos = [b.itemX, b.itemY];
            f
                ? (b.itemX += e)
                : ((b.itemY += o + g + p), (b.lastLineHeight = g));
    ...
    sb.prototype = {
        ...
        addSeries: function(a, b, c) {
            ...
            a &&
                (ua(c, e),
                (b = o(b, !0)),
                E(e, 'addSeries', { options: a }, function() {
                    d = e.initSeries(a);
                    e.isDirtyLegend = !0;
                    b && e.redraw();
                }));
        ...
        isInsidePlot: function(a, b, c) {
            var d = c ? b : a,
                a = c ? a : b;
            return (
                d >= 0 && d <= this.plotWidth && a >= 0 && a <= this.plotHeight
            );
        },
        ...
        showLoading: function(a) {
            ...
            if (!c)
                (this.loadingDiv = c = Q(
                    ...
                    (this.loadingSpan = Q('span', null, d.labelStyle, c));
            this.loadingSpan.innerHTML = a || b.lang.loading;
            if (!this.loadingShown)
                H(c, { opacity: 0, display: '' }),
                    xb(
                        c,
        ...
        zoom: function(a) {
            ...
            !a || a.resetSelection
                ...
                : n(a.xAxis.concat(a.yAxis), function(a) {
                      var e = a.axis;
                      if (b.tracker[e.isXAxis ? 'zoomX' : 'zoomY'])
                          c = e.zoom(a.min, a.max);
                  });
        ...
        pan: function(a) {
            ...
            b.series.length &&
                f > O(e.dataMin, e.min) &&
                c < y(e.dataMax, e.max) &&
                b.setExtremes(f, c, !0, !1, { trigger: 'pan' });
            this.mouseDownX = a;
        ...
        getChartSize: function() {
            ...
            this.chartHeight =
                a.height ||
                (this.containerHeight > 19 ? this.containerHeight : 400);
        },
        ...
        getMargins: function() {
            ...
            this.resetMargins();
            e = this.axisOffset;
            if ((this.title || this.subtitle) && !t(this.optionsMarginTop))
                if (
                    (l = y(
                        (this.title &&
                            !k.floating &&
                    ...
                    this.plotTop = y(this.plotTop, l + o(k.margin, 15) + b);
            if (f.display && !m.floating)
                if (q === 'right') {
                    ...
                    if (!t(g))
                        this.plotTop = y(
                            this.plotTop,
                            f.legendHeight + r + p + b
                        );
                } else if (s === 'bottom' && !t(j))
                    this.marginBottom = y(
                        this.marginBottom,
                        f.legendHeight - r + p + d
                    );
        ...
        drawChartBox: function() {
            ...
            if (l)
                h
                    ? h.animate(t)
                    : (this.plotBGImage = b.image(l, o, n, q, r).add());
            s
                ? s.animate({ width: v.width, height: v.height })
                : (this.clipRect = b.clipRect(v));
            if (m)
                g
                    ? g.animate(g.crisp(null, o, n, q, r))
                    : (this.plotBorder = b
                          .rect(o, n, q, r, 0, m)
                          .attr({
        ...
        destroy: function() {
            ...
            n(
                'title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,tracker,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer'.split(
                    ','
                ),
                function(b) {
                    var c = a[b];
        ...
        firstRender: function() {
            var a = this,
                ...
                c = a.callback;
            if (
                (!Z && K == K.top && C.readyState !== 'complete') ||
                (U && !K.canvg)
            )
                U
                    ? Mb.push(function() {
                ...
                if (
                    Highcharts.Scroller &&
                    (b.navigator.enabled || b.scrollbar.enabled)
                )
    ...
    Ta.prototype = {
        ...
        destroy: function() {
            var a = this.series.chart,
                ...
                c;
            a.pointCount--;
            if (b && (this.setState(), Ba(b, this), !b.length))
                a.hoverPoints = null;
        ...
        destroyElements: function() {
            for (
                var a = 'graphic,tracker,dataLabel,group,connector,shadowGroup'.split(
                        ','
                    ),
                    b,
                    c = 6;
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(
                ...
                function() {
                    ...
                    c.setState(a && 'select');
                    b ||
                        n(d.getSelectedPoints(), function(a) {
                            if (a.selected && a !== c)
                                (a.selected = !1),
                                    a.setState(''),
            ...
            for (i in d)
                (g = d[i]),
                    la(g) &&
                        g !== a &&
                        ((h = (' ' + g).split(e)),
                        (f = { point: this, series: b }[h[1]]),
                        (h = h[2]),
                        f === this && j.hasOwnProperty(h)
                            ? ((f = j[h] ? h : 'value'),
                              (f =
                                  (c[f + 'Prefix'] || '') +
                                  Ia(this[h], o(c[f + 'Decimals'], -1)) +
                                  (c[f + 'Suffix'] || '')))
                            : (f = f[h]),
                        (a = a.replace(g, f)));
            return a;
        ...
        setState: function(a) {
            var b = this.plotX,
                ...
                d = this.series,
                e = d.options.states,
                f = W[d.type].marker && d.options.marker,
                g = f && !f.enabled,
                h = f && f.states[a],
                i = h && h.enabled === !1,
            ...
            if (
                ...
                if (this.graphic)
                    (e = f && this.graphic.symbolName && l[a].r),
                        this.graphic.attr(
                            A(
                                l[a],
                                e
                    ...
                    if (a && h)
                        (e = h.radius),
                            j
                                ? j.attr({ x: b - e, y: c - e })
                                : (d.stateMarkerGraphic = j = k.renderer
                                      .symbol(
                                          d.symbol,
                                          b - e,
                                          c - e,
    ...
    N.prototype = {
        ...
        bindAxes: function() {
            ...
            a.isCartesian &&
                n(['xAxis', 'yAxis'], function(e) {
                    n(c[e], function(c) {
                        d = c.options;
                        if (b[e] === d.index || (b[e] === x && d.index === 0))
        ...
        drawLegendSymbol: function(a) {
            ...
            if (c && c.enabled)
                (b = c.radius),
                    (this.legendSymbol = e
                        .symbol(this.symbol, d / 2 - b, a - 4 - b, 2 * b, 2 * b)
                        .add(f));
        },
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++)
                (i = h + m),
                    j
                        ? (l[m] = new f().init(this, [d[m]].concat(na(e[m]))))
                        : (b[i]
                              ? (k = b[i])
                              : a[i] !== x &&
                                (b[i] = k = new f().init(this, a[i], d[m])),
                          (l[m] = k));
            if (b && (g !== (c = b.length) || j))
                for (m = 0; m < c; m++)
                    if ((m === h && !j && (m += g), b[m]))
                        b[m].destroyElements(), (b[m].plotX = x);
            this.data = b;
            this.points = l;
        },
        translate: function() {
            ...
            for (l = 0; l < h; l++) {
                ...
                if (c && this.visible && q && q[p])
                    (r = q[p]),
                        (p = r.total),
                        (r.cum = r = r.cum - n),
                        (n = r + n),
                        j && (r = o(b.threshold, f.min)),
                        f.isLog && r <= 0 && (r = null),
                        c === 'percent' &&
                            ((r = p ? (r * 100) / p : 0),
                            (n = p ? (n * 100) / p : 0)),
                        (k.percentage = p ? (k.y * 100) / p : 0),
                        (k.total = k.stackTotal = p),
                        (k.stackY = n);
                k.yBottom = t(r) ? f.translate(r, 0, 1, 0, 1) : null;
                i && (n = this.modifyValue(n, k));
                k.plotY =
                    typeof n === 'number'
                        ? s(f.translate(n, 0, 1, 0, 1) * 10) / 10
                        : x;
        ...
        tooltipHeaderFormatter: function(a) {
            ...
            if (e && !c)
                for (f in B)
                    if (B[f] >= d.closestPointRange) {
                        c = b.dateTimeLabelFormats[f];
                        break;
                    }
            return b.headerFormat
                .replace('{point.key}', e && Aa(a) ? cb(c, a) : a)
                .replace('{series.name}', this.name)
                .replace('{series.color}', this.color);
        },
        onMouseOver: function() {
            var a = this.chart,
                b = a.hoverSeries;
        ...
        getAttribs: function() {
            var a = this,
                b = W[a.type].marker ? a.options.marker : a.options,
                c = b.states,
                d = c.hover,
                e,
                f = a.color,
            ...
            for (f = h.length; f--; ) {
                g = h[f];
                if (
                    (b = (g.options && g.options.marker) || g.options) &&
                    b.enabled === !1
                )
                    b.radius = 0;
                ...
                if (e) {
                    ...
                    e = c.hover = c.hover || {};
                    if (!a.options.marker)
                        e.color = qa(e.color || g.color)
                            .brighten(e.brightness || d.brightness)
                            .get();
        ...
        destroy: function() {
            ...
            n(
                'area,graph,dataLabelsGroup,group,markerGroup,tracker,trackerGroup'.split(
                    ','
                ),
                function(b) {
                    a[b] &&
                        ((d = c && b === 'group' ? 'hide' : 'destroy'),
                        a[b][d]());
                }
            );
                    ...
                    n(c, function(c) {
                        ...
                        if (j && !i) c.dataLabel = j.destroy();
                            ...
                            if (j) j.attr({ text: f }), (l = !1);
                                ...
                                j = c.dataLabel = a.chart.renderer[
                                    i ? 'text' : 'label'
                                ](f, 0, -999, null, null, null, b.useHTML)
                                    .attr(j)
                                    .css(b.style)
                                    .add(g)
                                    .shadow(b.shadow);
        ...
        alignDataLabel: function(a, b, c, d, e) {
            ...
            b.attr({
                visibility:
                    c.crop === !1 ||
                    f.isInsidePlot(d.x, d.y) ||
                    f.isInsidePlot(h, a, g)
                        ? Z
                            ? 'inherit'
                            : 'visible'
                        : 'hidden',
        ...
        getSegmentPath: function(a) {
            ...
            n(a, function(d, e) {
                b.getPointSpline
                    ? c.push.apply(c, b.getPointSpline(a, d, e))
                    : (c.push(e ? 'L' : 'M'),
        ...
        drawTracker: function() {
            ...
            if (e && !c)
                for (m = e + 1; m--; )
                    d[m] === 'M' &&
                        d.splice(m + 1, 0, d[m + 1] - h, d[m + 2], 'L'),
                        ((m && d[m] === 'M') || m === e) &&
                            d.splice(m, 0, 'L', d[m - 2] + h, d[m - 1]);
    ...
    G = ca(N, {
        type: 'area',
        getSegmentPath: function(a) {
            var b = N.prototype.getSegmentPath.call(this, a),
                c = [].concat(b),
                d,
                e = this.options;
            ...
            if (e.stacking && !this.closedStacks)
                for (d = a.length - 1; d >= 0; d--)
                    d < a.length - 1 &&
                        e.step &&
                        c.push(a[d + 1].plotX, a[d].yBottom),
    ...
    ha = ca(N, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i > a && i > e
                    ? ((i = y(a, e)), (k = 2 * e - i))
                    : i < a && i < e && ((i = O(a, e)), (k = 2 * e - i));
                k > g && k > e
                    ? ((k = y(g, e)), (i = 2 * e - k))
                    : k < g && k < e && ((k = O(g, e)), (i = 2 * e - k));
                b.rightContX = j;
                b.rightContY = k;
            }
            c
    ...
    ha = ca(N, {
        ...
        translate: function() {
            ...
            var l = a.points,
                ...
                p = (g - 2 * m) / f,
                u = c.pointWidth,
                r = t(u) ? (p - u) / 2 : p * c.pointPadding,
                q = o(u, p - 2 * r),
                s = wa(y(q, 1 + 2 * e)),
                w =
                    r +
                    (m +
                        ((h ? f - a.columnIndex : a.columnIndex) || 0) * p -
                        g / 2) *
                        (h ? -1 : 1),
                z = (a.translatedThreshold = a.yAxis.getThreshold(c.threshold)),
                v = o(c.minPointLength, 5);
            n(l, function(c) {
                var f = c.plotY,
                    g = o(c.yBottom, z),
                    h = c.plotX + w,
                ...
                L(j) < v &&
                    v &&
                    ((j = v),
                    (i = L(i - z) > v ? g - v : z - (f <= z ? v : 0)));
                c.barX = h;
                c.pointWidth = q;
                c.shapeType = 'rect';
                c.shapeArgs = f = b.renderer.Element.prototype.crisp.call(
                    0,
                    e,
                    h,
                    i,
                ...
                c.trackerArgs =
                    L(j) < 3 && A(c.shapeArgs, { height: 6, y: i - 3 });
            });
        },
        getSymbol: ya,
        ...
        alignDataLabel: function(a, b, c, d, e) {
            var f = this.chart,
                ...
                h =
                    a.below ||
                    a.plotY > (this.translatedThreshold || f.plotSizeY),
                ...
                n(c, function(a) {
                    ...
                    c &&
                        (c.attr({
                            ...
                            y: t(h)
                                ? g.getThreshold(h)
                                : g.translate(g.getExtremes().min, 0, 1, 0, 1),
                        }),
    ...
    za = ca(N, {
        ...
        drawTracker: function() {
            ...
            a._hasTracking
                ...
                : a.markerGroup
                      .attr({ isTracker: !0 })
                      .on(fa ? 'touchstart' : 'mouseover', function(b) {
                          a.onMouseOver();
    ...
    ya = {
        ...
        pointClass: ca(Ta, {
            ...
            setVisible: function(a) {
                var b = this.series,
                    ...
                    g = this.shadowGroup,
                    h;
                h = (this.visible = a = a === x ? !this.visible : a)
                    ? 'show'
                    : 'hide';
                this.group[h]();
                if (d) d[h]();
                ...
                if (!b.isDirty && b.options.ignoreHiddenPoint)
                    (b.isDirty = !0), c.redraw();
            },
        ...
        translate: function() {
            ...
            for (n = 0; n < r; n++) {
                ...
                j = (i + h) / 2;
                q.slicedTranslation = Sa(
                    [V(j) * d + g.plotLeft, Y(j) * d + g.plotTop],
                    s
                );
                h = (V(j) * f[2]) / 2;
                i = (Y(j) * f[2]) / 2;
            ...
            n(a.points, function(j) {
                ...
                e
                    ...
                    : (j.graphic = e = c
                          ...
                          .attr(
                              r(j.pointAttr[''], { 'stroke-linejoin': 'round' })
                          )
                          .add(j.group)
                          .shadow(g, h));
            ...
            if (d.enabled || this._hasPointLabels) {
                ...
                for (
                    a =
                        r[0][0] &&
                        r[0][0].dataLabel &&
                        (r[0][0].dataLabel.getBBox().height || 21);
                    y--;
                    ...
                    for (v = 0; v < C; v++) {
                        ...
                        s = d.justify
                            ? k[0] + (y ? -1 : 1) * (l + j)
                            : this.getX(
                                  B === 0 || B === x.length - 1 ? s : q,
                                  y
                              );
                        g.attr({ visibility: t, align: h[6] })[
                            g.moved ? 'animate' : 'attr'
                        ]({
                            x: s + d.x + ({ left: e, right: -e }[h[6]] || 0),
                            y: q + d.y - 10,
                        });
                        g.moved = !0;
                        if (p && f)
                            (g = b.connector),
                                ...
                                g
                                    ? (g.animate({ d: h }),
                                      g.attr('visibility', t))
                                    : (b.connector = g = this.chart.renderer
                                          .path(h)
                                          .attr({
                                              'stroke-width': f,
                                              stroke:
