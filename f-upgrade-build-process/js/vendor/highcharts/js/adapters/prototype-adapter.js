...
var HighchartsAdapter = (function() {
    ...
    return {
            ...
            if (g)
                Effect.HighchartsTransition = Class.create(Effect.Base, {
                    ...
                    update: function(a) {
                        ...
                        d.attr
                            ? d.attr(this.options.attribute, a)
                            : ((b = {}),
                              (b[this.options.attribute] = a),
                              $(d).setStyle(b));
                    },
                    finish: function() {
        ...
        addEvent: function(c, a, b) {
            c.addEventListener || c.attachEvent
                ? Event.observe($(c), HighchartsAdapter.addNS(a), b)
        ...
        animate: function(c, a, b) {
            ...
            if (g)
                for (d in a) new Effect.HighchartsTransition($(c), d, a[d], b);
            else {
        ...
        fireEvent: function(c, a, b, d) {
            c.fire
                ? c.fire(HighchartsAdapter.addNS(a), b)
                : c._highcharts_extended &&
        ...
        removeEvent: function(c, a, b) {
            ...
            window === c
                ...
                : (HighchartsAdapter._extend(c),
                  c._highcharts_stop_observing(a, b));
        },
                        ...
                        a
                            ? b
                                ? (this._highchart_events[a] = [
                                      ...
                                      .flatten()
                                      .without(b))
                                : delete this._highchart_events[a]
