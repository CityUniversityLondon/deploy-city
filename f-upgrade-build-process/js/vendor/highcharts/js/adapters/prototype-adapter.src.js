...
var HighchartsAdapter = (function() {
    ...
    return {
        ...
        animate: function(el, params, options) {
            ...
            if (hasEffect) {
                for (key in params) {
                    ...
                    fx = new Effect.HighchartsTransition(
                        $(el),
                        key,
                        params[key],
                        options
        ...
        merge: function() {
            // the built-in prototype merge function doesn't do deep copy
            function doCopy(copy, original) {
                var value, key;
