...
(function() {
    ...
    function Ga(a, b, c) {
        var d, e;
        if (Sb(b))
            if (K(c)) a.setAttribute(b, c);
            else {
                if (a && a.getAttribute) e = a.getAttribute(b);
            }
        else if (K(b) && Nb(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function zc(a) {
    ...
    function Nd(a, b) {
        function c(p) {
            ...
            function x(k, n, t, r) {
                ...
                this.textAlign =
                    k.textAlign || (va ? (n ? 'right' : 'left') : 'center');
            }
            function V() {
                var k = [],
                    n = [],
                ...
                u(Ha, function(r) {
                    ...
                    u(['xAxis', 'yAxis'], function(F) {
                        if (
                            r.isCartesian &&
                            ((F === 'xAxis' && xa) || (F === 'yAxis' && !xa)) &&
                            (r.options[F] === o.index ||
                                (r.options[F] === Wa && o.index === 0))
                        ) {
                            r[F] = I;
                            zb.push(r);
                            t = true;
                    ...
                    if (t) {
                        ...
                        if (r.isCartesian) {
                            ...
                            if (/(area|column|bar)/.test(r.type) && !xa)
                                if (pa >= 0) {
                                    pa = 0;
                                    Od = true;
                                } else if (wa < 0) {
            ...
            function da() {
                var k,
                    ...
                    r,
                    J = o.tickInterval,
                    E = o.tickPixelInterval;
                k =
                    o.maxZoom ||
                    (xa && !K(o.min) && !K(o.max)
                        ? tb(l.smallestInterval * 5, wa - pa)
                        : null);
                ya = R ? Da : Aa;
                if (Ub) {
                ...
                Ta =
                    ia === ra
                        ? 1
                        : Ub && !J && E === t.options.tickPixelInterval
                            ? t.tickInterval
                            : A(J, Ya ? 1 : ((ra - ia) * E) / ya);
                if (!D && !K(o.tickInterval)) Ta = N(Ta);
                I.tickInterval = Ta;
                Wc =
                    o.minorTickInterval === 'auto' && Ta
                        ? Ta / 5
                        : o.minorTickInterval;
                if (D) {
                    Ba = [];
                    ...
                    Q = aa.getTime() / ub;
                    fa = aa[Rc]();
                    for (ka = aa[Cc](); Q < ra && t < Da; ) {
                        Ba.push(Q);
                        if (S === $) Q = Qc(n + t * F, 0) / ub;
                        else if (S === r) Q = Qc(n, fa + t * F) / ub;
                        else if (!J && (S === E || S === k))
            ...
            function Ma() {
                ...
                fb = ya / (ra - ia || 1);
                if (!xa)
                    for (k in s) for (n in s[k]) s[k][n].cum = s[k][n].total;
            ...
            function eb() {
                var k = o.title,
                    n = o.stackLabels,
                    t = o.alternateGridColor,
                    r = o.lineWidth,
                    J,
                    E,
                    Q = (J = l.hasRendered) && K(Dc) && !isNaN(Dc);
                ...
                if (E || Ub) {
                    ...
                    J ||
                        u(
                            (o.plotLines || []).concat(o.plotBands || []),
                            function($) {
                ...
                u([mb, Wb, dc], function($) {
                    for (var F in $)
                        if ($[F].isActive) $[F].isActive = false;
                        else {
                            $[F].destroy();
                            delete $[F];
                        }
                ...
                if (n && n.enabled) {
                    ...
                    n = I.stackTotalGroup;
                    if (!n)
                        I.stackTotalGroup = n = ga
                            .g('stack-labels')
                            .attr({ visibility: Ab, zIndex: 6 })
                            .translate(X, ea)
                            .add();
                    for (fa in s) {
                        k = s[fa];
            ...
            var pd,
                ...
                $c = R && o.labels.staggerLines,
                ec = o.reversed,
                fc = Ya && o.tickmarkPlacement === 'between' ? 0.5 : 0;
            q.prototype = {
                addLabel: function() {
                    var k = this.pos,
                        n = o.labels,
                        t = !(
                            (k === ia && !A(o.showFirstLabel, 1)) ||
                            (k === ra && !A(o.showLastLabel, 0))
                        ),
                        r =
                            (Ya &&
                                R &&
                        ...
                        this.label =
                            K(k) && t && n.enabled
                                ? ga
                                      ...
                                      .add(na)
                                : null;
                    else E && E.attr({ text: k }).css(r);
                },
                getLabelSize: function() {
                    var k = this.label;
                    return k
                        ? (this.labelBBox = k.getBBox())[R ? 'height' : 'width']
                        : 0;
                },
                render: function(k, n) {
                    var t = !this.minor,
                        ...
                        E = o.labels,
                        Q = this.gridLine,
                        fa = t ? o.gridLineWidth : o.minorGridLineWidth,
                        ka = t ? o.gridLineColor : o.minorGridLineColor,
                        $ = t ? o.gridLineDashStyle : o.minorGridLineDashStyle,
                        F = this.mark,
                        O = t ? o.tickLength : o.minorTickLength,
                        S = t ? o.tickWidth : o.minorTickWidth || 0,
                        aa = t ? o.tickColor : o.minorTickColor,
                        Eb = t ? o.tickPosition : o.minorTickPosition,
                        kb = E.step,
                        nb = (n && ad) || cb,
                        Qb;
                    Qb = R
                        ? G(J + fc, null, null, n) + cc
                        : X + la + (Oa ? ((n && qd) || $a) - Ib - X : 0);
                    nb = R
                        ? nb - vb + la - (Oa ? Aa : 0)
                        : nb - G(J + fc, null, null, n) - cc;
                    if (fa) {
                        J = ha(J + fc, fa, n);
                        if (Q === Wa) {
                    ...
                    if (S) {
                        ...
                        if (F) F.animate({ d: t });
                            ...
                            this.mark = ga
                                .path(t)
                                .attr({ stroke: aa, 'stroke-width': S })
                                .add(na);
                    }
                    if (r && !isNaN(Qb)) {
                        Qb = Qb + E.x - (fc && R ? fc * fb * (ec ? -1 : 1) : 0);
                        nb =
                            nb + E.y - (fc && !R ? fc * fb * (ec ? 1 : -1) : 0);
                        K(E.y) ||
                            (nb +=
                                ja(r.styles.lineHeight) * 0.9 -
                                r.getBBox().height / 2);
                        if ($c) nb += ((k / (kb || 1)) % $c) * 16;
            ...
            w.prototype = {
                render: function() {
                    ...
                    if (K(aa)) n.zIndex = aa;
                    if (F)
                        if (O) F.animate({ d: O }, null, F.onGetPath);
                        else {
                            F.hide();
            ...
            x.prototype = {
                ...
                render: function(k) {
                    ...
                    if (this.label)
                        this.label.attr({ text: n, visibility: ob });
                    else
                        this.label = l.renderer
                            .text(n, 0, 0)
                ...
                setOffset: function(k, n) {
                    var t = this.isNegative,
                        r = I.translate(this.total),
                        J = I.translate(0);
                    J = bb(r - J);
                    var E = l.xAxis[0].translate(this.x) + k,
                        Q = l.plotHeight;
                    t = {
                        x: va ? (t ? r : r - J) : E,
                    ...
                    this.label &&
                        this.label
                            .align(this.alignOptions, null, t)
                            .attr({ visibility: Ab });
                },
            };
            ...
            sa(I, {
                ...
                getOffset: function() {
                    ...
                    if (k || Ub) {
                        u(Ba, function(fa) {
                            if (mb[fa]) mb[fa].addLabel();
                            else mb[fa] = new q(fa);
                            if (
                                L === 0 ||
                                L === 2 ||
                                { 1: 'left', 3: 'right' }[L] === J.align
                            )
            ...
            return {
                add: function(q, w, x, V) {
                    if (!p[q]) {
                        w = ga
                            .text(w, 0, 0)
                            .css(a.toolbar.itemStyle)
                            .align({ align: 'right', x: -Ib - 20, y: ea + 30 })
                            .on('click', V)
                            .attr({ align: 'right', zIndex: 20 })
                            .add();
                        p[q] = w;
                    }
                },
        ...
        function e(p) {
            ...
            var o = ga
                    ...
                    .add(),
                I = ga
                    .rect(ab, ab, 0, 0, p.borderRadius, N)
                    .attr({ fill: p.backgroundColor, 'stroke-width': N })
                    .add(o)
                    .shadow(p.shadow),
                ba = ga
                    .text('', eb + ab, ja(Ma.fontSize) + eb + ab, p.useHTML)
                    .attr({ zIndex: 1 })
                    .css(Ma)
                    .add(o);
            o.hide();
            return {
                ...
                refresh: function(B) {
                    ...
                    if (ta) {
                        ta = zc(ta);
                        for (D = ta.length; D--; ) {
                            ca = B.series[D ? 'yAxis' : 'xAxis'];
                            if (ta[D] && ca) {
                                ca = ca.getPlotLinePath(B[D ? 'y' : 'x'], 1);
                                if (da[D])
                                    da[D].attr({ d: ca, visibility: Ab });
                                else {
                                    la = {
        ...
        function f(p) {
            function q(L) {
                var s,
                    o = Ud && ua.width / ua.body.scrollWidth - 1,
                    I,
                    ba,
                    B;
                L = L || db.event;
            ...
            function w(L) {
                ...
                u(Va, function(o) {
                    ...
                    s[ba ? 'xAxis' : 'yAxis'].push({
                        axis: o,
                        value: I(
                            (va ? !ba : ba) ? L.chartX - X : Aa - L.chartY + ea,
                            true
                        ),
                    });
                });
                ...
                var L = function(s) {
                    if (!(s && s.touches && s.touches.length > 1)) {
                        ...
                        if (Kb && s.type === 'touchstart')
                            ...
                            else !ke && !ba && s.preventDefault();
                        if (ba) {
                            if (o < X) o = X;
                            else if (o > X + Da) o = X + Da;
                            if (I < ea) I = ea;
                            else if (I > ea + Aa) I = ea + Aa;
                        }
                        if (ud && s.type !== 'touchstart') {
                            Ma = Math.sqrt(
                                Math.pow(ta - o, 2) + Math.pow(da - I, 2)
                            );
                            if (Ma > 10) {
        ...
        function g(p) {
            var q = p.type || z.type || z.defaultSeriesType,
                ...
                x = l.hasRendered;
            if (x)
                if (va && q === 'column') w = wb.bar;
                else if (!va && q === 'bar') w = wb.column;
            q = new w();
            q.init(l, p);
        ...
        function P() {
            function p() {
                var w = z.width || qb.offsetWidth,
                    x = z.height || qb.offsetHeight;
                if (w && x) {
                    if (w !== dd || x !== Jc) {
                        clearTimeout(q);
        ...
        function H() {
            ...
            if (l !== null) {
                ...
                pb(db, 'unload', H);
                pb(l);
                for (p = Va.length; p--; ) Va[p] = Va[p].destroy();
        ...
        function U() {
            if (!Lc && db == db.top && ua.readyState !== 'complete')
                ua.attachEvent('onreadystatechange', function() {
                    ua.detachEvent('onreadystatechange', U);
        ...
        var z = a.chart,
            M = z.margin;
        M = Nb(M) ? M : [M, M, M, M];
        var y = A(z.marginTop, M[0]),
            C = A(z.marginRight, M[1]),
            Z = A(z.marginBottom, M[2]),
            Sa = A(z.marginLeft, M[3]),
            Na = z.spacingTop,
            Ea = z.spacingRight,
            gb = z.spacingBottom,
            Lb = z.spacingLeft,
            ...
            le = function() {
                ...
                function x(G) {
                    ...
                    La = G.series || G;
                    var wa = La.options,
                        zb = (wa && wa.borderWidth) || 0;
                    if (!pa) {
                        La = /^(bar|pie|area|column)$/.test(La.type);
                        G.legendItem = pa = ga
                            .text(N.labelFormatter.call(G), 0, 0)
                            .css(G.visible ? ab : Oa)
                        ...
                        if (!La && wa && wa.lineWidth) {
                            ...
                            G.legendLine = ga
                                .path([Za, -da - Ma, 0, Ka, -Ma, 0])
                                .attr(Vb)
                                .add(qa);
                        }
                        if (La)
                            ha = ga
                                .rect((na = -da - Ma), (Ra = -11), da, 12, 2)
                                .attr({ zIndex: 3 })
                                .add(qa);
                    ...
                    ha = pa.getBBox();
                    na = G.legendItemWidth =
                        N.itemWidth || da + Ma + ha.width + R;
                    B = ha.height;
                ...
                function V() {
                    ...
                    u(Hb, function(Ra) {
                        ...
                        if (La.showInLegend)
                            za = za.concat(
                                La.legendType === 'point' ? Ra.data : Ra
                            );
                    });
                    Hd(za, function(Ra, La) {
                        return (
                            (Ra.options.legendIndex || 0) -
                            (La.options.legendIndex || 0)
                        );
                    });
                    cc && za.reverse();
                    u(za, x);
                        ...
                        if (D) {
                            if ($b > 0 && ac > 0) {
                                D[D.isNew ? 'attr' : 'animate'](
                                    D.crisp(null, null, null, $b, ac)
                                );
                                D.isNew = false;
                            }
                        } else {
                            D = ga
                                .rect(0, 0, $b, ac, N.borderRadius, ca || 0)
                                .attr({
                    ...
                    for (
                        var G = ['left', 'right', 'top', 'bottom'], ha, na = 4;
                        na--;
        ...
        td = function(p) {
            ...
            !p || p.resetSelection
                ...
                : u(p.xAxis.concat(p.yAxis), function(x) {
                      var V = x.axis;
                      if (l.tracker[V.isXAxis ? 'zoomX' : 'zoomY'])
        ...
        Gc = function() {
            ...
            if (p.enabled && !p.floating)
                if (V === 'right') K(C) || (Ib = Ia(Ib, $b - w + q + Ea));
                else if (V === 'left') K(Sa) || (X = Ia(X, $b + w + q + Lb));
                else if (N === 'top') K(y) || (ea = Ia(ea, ac + x + q + Na));
                else if (N === 'bottom') K(Z) || (vb = Ia(vb, ac - x + q + gb));
            sc &&
                u(Va, function(da) {
                    da.getOffset();
                });
        ...
        vd = function() {
            var p = z.borderWidth || 0,
                q = z.backgroundColor,
                w = z.plotBackgroundColor,
                x = z.plotBackgroundImage,
                V,
                N = { x: X, y: ea, width: Da, height: Aa };
            V = p + (z.shadow ? 8 : 0);
            if (p || q)
                if (wc) wc.animate(wc.crisp(null, null, null, $a - V, cb - V));
                else
                    wc = ga
                        .rect(V / 2, V / 2, $a - V, cb - V, z.borderRadius, p)
                        .attr({
            ...
            if (x)
                if (Ad) Ad.animate(N);
                else Ad = ga.image(x, X, ea, Da, Aa).add();
            if (z.plotBorderWidth)
                if (xc) xc.animate(xc.crisp(null, X, ea, Da, Aa));
                else
                    xc = ga
                        .rect(X, ea, Da, Aa, 0, z.plotBorderWidth)
                        .attr({
        ...
        l.get = function(p) {
            ...
            for (q = 0; q < Va.length; q++)
                if (Va[q].options.id === p) return Va[q];
            for (q = 0; q < Ha.length; q++)
                if (Ha[q].options.id === p) return Ha[q];
            for (q = 0; q < Ha.length; q++) {
                x = Ha[q].data;
    ...
    var ua = document,
        ...
        Pc = /msie/i.test(yc) && !db.opera,
        Mc = ua.documentMode === 8,
        Ud = /AppleWebKit/.test(yc),
        Yd = /Firefox/.test(yc),
        Lc =
            !!ua.createElementNS &&
            !!ua.createElementNS('http://www.w3.org/2000/svg', 'svg')
                .createSVGRect,
        me = Yd && parseInt(yc.split('Firefox/')[1], 10) < 4,
        fd,
        Kb = ua.documentElement.ontouchstart !== undefined,
        be = {},
        wd = 0,
        ub = 1,
        Tc,
        ...
        Za = 'M',
        Ka = 'L',
        ce = 'rgba(192,192,192,' + (Lc ? 1.0e-6 : 0.002) + ')',
        ib = '',
        Bb = 'hover',
        Qc,
        id,
    ...
    xb.column = Ca(ma, {
        ...
        minPointLength: 0,
        states: {
            hover: { brightness: 0.1, shadow: false },
            select: { color: '#C0C0C0', borderColor: '#000000', shadow: false },
        },
    ...
    var bc = function(a) {
        ...
        (function(d) {
            if (
                ...
                b = [ja(c[1]), ja(c[2]), ja(c[3]), parseFloat(c[4], 10)];
            else if (
    ...
    Uc.prototype = {
        init: function(a, b) {
            this.element = ua.createElementNS('http://www.w3.org/2000/svg', b);
            this.renderer = a;
        },
        ...
        attr: function(a, b) {
            ...
            if (Sb(a)) {
                ...
                for (c in a) {
                    ...
                    else if (c === 'width') d = ja(d);
                    else if (c === 'align') {
                        c = 'text-anchor';
                        d = { left: 'start', center: 'middle', right: 'end' }[
                            d
                        ];
                    } else if (c === 'title') {
                        e = ua.createElementNS(
    ...
    ed.prototype = {
        ...
        buildText: function(a) {
            for (
                ...
                b.removeChild(d[T]);
            m && !a.added && this.box.appendChild(b);
            u(c, function(Y, H) {
                var U,
                    z = 0,
                    M;
                Y = Y.replace(/<span/g, '|||<span').replace(
                    /<\/span>/g,
                    '</span>|||'
                );
                U = Y.split('|||');
        ...
        setSize: function(a, b, c) {
            ...
            this.height = b;
            for (
                this.boxWrapper[A(c, true) ? 'animate' : 'attr']({
                    width: a,
                    height: b,
                });
                e--;
        ...
        symbol: function(a, b, c, d, e) {
            ...
            if (g) {
                ...
                var j = function(m, v) {
                    m.attr({ width: v[0], height: v[1] }).translate(
                        -W(v[0] / 2),
                        -W(v[1] / 2)
                    );
                };
            ...
            attr: function(a, b) {
                ...
                if (Sb(a)) {
                    ...
                    for (c in a) {
                        ...
                        if (
                            j &&
                            /^(x|y|r|start|end|width|height|innerR)/.test(c)
                        ) {
                            if (!v) {
                                this.symbolAttr(a);
                                v = true;
                            ...
                            (f.getElementsByTagName('stroke')[0] ||
                                hb(i.prepVML(['<stroke/>']), null, null, f))[
                                c
                            ] = d || 'solid';
                            this.dashstyle = d;
                            m = true;
            ...
            updateTransform: function() {
                if (this.added) {
                    ...
                    if (b.tagName === 'SPAN') {
                        ...
                        var Y = a.xCorr || 0,
                            H = a.yCorr || 0,
                            U = [c, g, b.innerHTML, a.textWidth].join(',');
                        if (U !== a.cTT) {
                            if (K(c)) {
                                j = c * ae;
                                d = rb(j);
        ...
        ma.prototype = Ca(ed.prototype, {
            ...
            color: function(a, b, c) {
                ...
                if (a && a.linearGradient) {
                    ...
                    a =
                        90 -
                        (Fa.atan((h[3] - h[1]) / (h[2] - h[0])) * 180) / kc;
                    a = [
                        '<',
                        c,
                        ' colors="0% ',
            ...
            image: function(a, b, c, d, e) {
                ...
                arguments.length > 1 &&
                    f.css({ left: b, top: c, width: d, height: e });
                return f;
            },
            rect: function(a, b, c, d, e, f) {
                if (Nb(a)) {
            ...
            symbols: {
                arc: function(a, b, c, d) {
                    ...
                    var m = 0.07 / c,
                        v = (d && 0.1 / d) || 0;
                    if (f - e === 0) return ['x'];
                    else if (2 * kc - f + e < m) i = -m;
                    else if (f - e < v) i = rb(e + v);
                    return [
                        'wa',
                        a - c,
                        b - c,
    ...
    Oc.prototype = {
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(
                ...
                function() {
                    ...
                    c.setState(a && 'select');
                    b ||
                        u(d.getSelectedPoints(), function(e) {
                            if (e.selected && e !== c) {
                                e.selected = false;
                                e.setState(ib);
        ...
        importEvents: function() {
            if (!this.hasImportedEvents) {
                var a = Ca(this.series.options.point, this.options).events,
                    b;
                this.events = a;
        ...
        setState: function(a) {
            var b = this.series,
                c = b.options.states,
                d = xb[b.type].marker && b.options.marker,
                e = d && !d.enabled,
            ...
            if (
                !(
                    ...
                    (c[a] && c[a].enabled === false) ||
                    (a && (f || (e && !d.enabled)))
                )
            ) {
                if (this.graphic) this.graphic.attr(i[a]);
                else {
                    if (a) {
                        if (!g)
                            b.stateMarkerGraphic = g = h.renderer
                                .circle(0, 0, i[a].r)
                                .attr(i[a])
                                .add(b.group);
    ...
    sb.prototype = {
        ...
        translate: function() {
            for (
                ...
                if (i !== null) g.plotY = d.translate(i, 0, 1, 0, 1);
        ...
        setTooltipPoints: function(a) {
            var b = this.chart,
                c = b.inverted,
                d = [],
                e = W((c ? b.plotTop : b.plotLeft) + b.plotSizeX),
                f,
                g,
                h = [];
            ...
            u(d, function(i, j) {
                ...
                for (
                    g = i._high = d[j + 1]
                        ? lb((i.plotX + (d[j + 1] ? d[j + 1].plotX : e)) / 2)
                        : e;
                    f <= g;
            ...
            if (this.options.marker.enabled)
                for (f = b.length; f--; ) {
                    ...
                    if (e !== Wa && !isNaN(e)) {
                        ...
                        h = a.r;
                        if (i) i.animate({ x: d, y: e, r: h });
                        else
                            g.graphic = c.renderer
                                .symbol(
                                    A(g.marker && g.marker.symbol, this.symbol),
                                    d,
                                    e,
                                    h
                                )
        ...
        getAttribs: function() {
            var a = this,
                b = xb[a.type].marker ? a.options.marker : a.options,
                c = b.states,
                d = c[Bb],
                e,
                f = a.color,
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                var a,
                    ...
                    v;
                v = d.stacking;
                var P = m === 'column' || m === 'bar',
                    T = e.verticalAlign === null,
                    Y = e.y === null;
                if (P)
                    if (v) {
                ...
                if (g) g.translate(h.plotLeft, h.plotTop);
                    ...
                    g = this.dataLabelsGroup = i
                        .g('data-labels')
                        .attr({ visibility: this.visible ? Ab : ob, zIndex: 6 })
                        .translate(h.plotLeft, h.plotTop)
                        .add();
                v = e.color;
                if (v === 'auto') v = null;
                ...
                u(c, function(H) {
                    ...
                    if (y) {
                        if (j && !e.y)
                            b =
                                b +
                                ja(y.styles.lineHeight) * 0.9 -
                                y.getBBox().height / 2;
                        y.attr({ text: f }).animate({ x: a, y: b });
                    } else if (K(f)) {
                        y = H.dataLabel = i
                            .text(f, a, b)
                            .attr({ align: C, rotation: e.rotation, zIndex: 1 })
                            .css(e.style)
                            .add(g);
                        j &&
                            !e.y &&
        ...
        drawGraph: function() {
            var a = this,
                ...
                m,
                v = a.chart.renderer,
                P = a.yAxis.getThreshold(b.threshold || 0),
                T = /^area/.test(a.type),
                Y = [],
                H = [];
        ...
        render: function() {
            ...
            if (!h) {
                h = a.clipRect =
                    !b.hasRendered && b.clipRect
                        ? b.clipRect
                        : i.clipRect(0, 0, b.plotSizeX, b.plotSizeY);
            ...
            if (!a.group) {
                ...
                c.clip(a.clipRect)
                    .attr({ visibility: a.visible ? Ab : ob, zIndex: e.zIndex })
                    .translate(b.plotLeft, b.plotTop)
                    .add(b.seriesGroup);
            }
            a.drawDataLabels();
            g && a.animate(true);
        ...
        redraw: function() {
            ...
            if (b) {
                a.inverted &&
                    b.attr({ width: a.plotWidth, height: a.plotHeight });
        ...
        drawTracker: function() {
            var a = this,
                ...
                h = b.cursor;
            h = h && { cursor: h };
            var i = a.singlePoints,
                j;
            if (d)
                for (j = d + 1; j--; ) {
                    c[j] === Za &&
                        c.splice(j + 1, 0, c[j + 1] - f, c[j + 2], Ka);
                    if ((j && c[j] === Za) || j === d)
    ...
    var hd = yb(sb, {
        ...
        translate: function() {
            ...
            h = bb(
                v[1]
                    ? v[P].plotX - v[P - 1].plotX
                    : b.plotSizeX / ((h && h.length) || 1)
            );
            P = h * c.groupPadding;
            var T = (h - 2 * P) / f,
                Y = c.pointWidth,
                H = K(Y) ? (T - Y) / 2 : T * c.pointPadding,
                U = Ia(A(Y, T - 2 * H), 1),
                z =
                    H +
                    (P +
                        ((g ? f - a.columnIndex : a.columnIndex) || 0) * T -
                        h / 2) *
                        (g ? -1 : 1),
                M = a.yAxis.getThreshold(c.threshold || 0),
                y = A(c.minPointLength, 5);
            u(v, function(C) {
                var Z = C.plotY,
                    Sa = C.yBottom || M,
                    Na = C.plotX + z,
                    Ea = md(tb(Z, Sa)),
                    gb = md(Ia(Z, Sa) - Ea),
                    Lb = a.yAxis.stacks[(C.y < 0 ? '-' : '') + a.stackKey],
                    Rb;
                ...
                C.shapeType = 'rect';
                Z = sa(
                    b.renderer.Element.prototype.crisp.apply({}, [
                        e,
                        Na,
                        Ea,
                        U,
                ...
                C.shapeArgs = Z;
                C.trackerArgs =
                    K(Rb) && Ca(C.shapeArgs, { height: Ia(6, gb + 3), y: Rb });
            });
        },
        getSymbol: function() {},
        drawGraph: function() {},
            ...
            u(a.data, function(f) {
                ...
                if (g !== Wa && !isNaN(g) && f.y !== null) {
                    ...
                    if (d) {
                        ...
                        f.graphic = c[f.shapeType](e)
                            .attr(f.pointAttr[f.selected ? 'select' : ib])
                            .add(a.group)
                            .shadow(b.shadow);
                }
            });
                    ...
                    if (e) e.attr(d);
                        ...
                        m.tracker = c[m.shapeType](d)
                            ...
                            .on('mouseout', function(v) {
                                if (!g.stickyTracking) {
                                    j = v.relatedTarget || v.toElement;
                                    Ga(j, 'isTracker') !== f && a.onMouseOut();
                                }
                            })
                            .css(i)
                            .add(m.group || b.trackerGroup);
            });
        },
        animate: function(a) {
            var b = this,
    ...
    ma = yb(Oc, {
        ...
        setVisible: function(a) {
            var b = this.series.chart,
                ...
                f = this.shadowGroup,
                g;
            g = (this.visible = a = a === Wa ? !this.visible : a)
                ? 'show'
                : 'hide';
            this.group[g]();
            c && c[g]();
    ...
    ma = yb(sb, {
        ...
        translate: function() {
            ...
            f = tc(f, function(C, Z) {
                return (U = /%$/.test(C)) ? ([h, i, H, H][Z] * ja(C)) / 100 : C;
            });
            ...
            u(P, function(C) {
                ...
                v = (m + j) / 2;
                C.slicedTranslation = tc(
                    [rb(v) * d + g.plotLeft, Cb(v) * d + g.plotTop],
                    W
                );
                z = (rb(v) * f[2]) / 2;
                M = (Cb(v) * f[2]) / 2;
            ...
            u(this.data, function(i) {
                ...
                if (d) d.animate(h);
                    ...
                    i.graphic = b
                        .arc(h)
                        .attr(
                            sa(i.pointAttr[ib], { 'stroke-linejoin': 'round' })
                        )
                        .add(i.group)
                        .shadow(f, g);
            ...
            if (d.enabled) {
                ...
                for (
                    a =
                        T[0][0] &&
                        T[0][0].dataLabel &&
                        ja(T[0][0].dataLabel.styles.lineHeight);
                    M--;
