        ...
        init: function(elem, fromD, toD) {
            ...
            if (start.length) {
                ...
                while (start.length < endLength) {
                    ...
                    slice = []
                        .concat(start)
                        .splice(start.length - numParams, numParams);
                    if (bezier) {
 ...
 */
    ...
    if (!globalAdapter && win.jQuery) {
        ...
        /*jslint unparam: true*/ jQ.extend(jQ.easing, {
    ...
    SVGElement.prototype = {
                ...
                for (key in hash) {
                    ...
                    if (key === 'd') {
                        ...
                        if (value === 'solid') {
                            ...
                            while (i--) {
                                value[i] =
                                    pInt(value[i]) * hash['stroke-width'];
                            }
                        ...
                        for (j = 0; j < length; j++) {
                            ...
                            css(
                                ...
                                extend(wrapper.styles, {
                                    left:
                                        bBox.x + (wrapper.translateX || 0) + PX,
                                    top:
                                        bBox.y + (wrapper.translateY || 0) + PX,
                                })
                            );
        ...
        crisp: function(strokeWidth, x, y, width, height) {
            ...
            values.width = mathFloor(
                (width || wrapper.width || 0) - 2 * normalizer
            );
        ...
        getBBox: function() {
            ...
            if (rotation) {
                bBox.width =
                    mathAbs(height * mathSin(rad)) +
                    mathAbs(width * mathCos(rad));
                bBox.height =
                    mathAbs(height * mathCos(rad)) +
                    mathAbs(width * mathSin(rad));
            }
    ...
    SVGRenderer.prototype = {
        ...
        buildText: function(wrapper) {
            ...
            if (renderAsHtml) {
                if (!htmlNode) {
                    htmlNode = wrapper.htmlNode = createElement(
                        'span',
                        null,
                        extend(textStyles, {
                            position: ABSOLUTE,
        ...
        symbol: function(symbol, x, y, radius, options) {
            var obj,
                ...
                path =
                    symbolFn &&
                    symbolFn(mathRound(x), mathRound(y), radius, options),
                imageRegex = /^url\((.*?)\)$/,
                imageSrc,
                imageSize;
        ...
        var VMLElement = extendClass(SVGElement, {
            ...
            css: function(styles) {
                var wrapper = this,
                    element = wrapper.element,
                    textWidth =
                        styles && element.tagName === 'SPAN' && styles.width;
            ...
            updateTransform: function() {
                ...
                if (elem.tagName === 'SPAN') {
                    ...
                    if (currentTextTransform !== wrapper.cTT) {
                        ...
                        // correct x and y
                        lineHeight = mathRound(
                            (pInt(elem.style.fontSize) || 12) * 1.2
                        );
    ...
    function Chart(options, callback) {
        ...
        function Axis(userOptions) {
            ...
            var isXAxis = userOptions.isX,
                ...
                labelFormatter =
                    options.labels.formatter || // can be overwritten by dynamic format
                    function() {
                ...
                tickmarkOffset =
                    categories && options.tickmarkPlacement === 'between'
                        ? 0.5
                        : 0;
            ...
            Tick.prototype = {
                ...
                addLabel: function() {
                    var pos = this.pos,
                        ...
                        str,
                        withLabel = !(
                            (pos === min && !pick(options.showFirstLabel, 1)) ||
                        ...
                        css,
                        value =
                            categories && defined(categories[pos])
                                ? categories[pos]
                                : pos,
                        label = this.label;
                    ...
                    css = width && {
                        width:
                            mathMax(
                                1,
                                mathRound(
                                    width - 2 * (labelOptions.padding || 10)
                                )
                            ) + PX,
                    };
                ...
                render: function(index, old) {
                    ...
                    x = horiz
                        ? translate(pos + tickmarkOffset, null, null, old) +
                          transB
                        : plotLeft +
                          offset +
                          (opposite
                              ? ((old && oldChartWidth) || chartWidth) -
                                marginRight -
                                plotLeft
                              : 0);
                    ...
                    if (label && !isNaN(x)) {
                        ...
                        if (!defined(labelOptions.y)) {
                            y +=
                                pInt(label.styles.lineHeight) * 0.9 -
            ...
            StackItem.prototype = {
                ...
                render: function(group) {
                    ...
                    if (stackItem.label) {
                        ...
                        stackItem.label = chart.renderer
                ...
                each(series, function(serie) {
                    ...
                    each(['xAxis', 'yAxis'], function(strAxis) {
                        if (
                            ...
                            ((strAxis === 'xAxis' && isXAxis) ||
                                (strAxis === 'yAxis' && !isXAxis)) &&
                            // the axis number is given in the options and matches this axis index, or
                            (serie.options[strAxis] === options.index ||
                                // the axis index is not given
                                (serie.options[strAxis] === UNDEFINED &&
                                    options.index === 0))
                        ) {
                            serie[strAxis] = axis;
                        ...
                        if (serie.isCartesian) {
                            ...
                            each(serie.data, function(point) {
                                ...
                                if (isXAxis) {
                                    ...
                                    // y axis
                                    if (stacking) {
                                        pointStack[pointX] = defined(
                                            pointStack[pointX]
                                        )
                                            ? pointStack[pointX] + pointY
                                            : pointY;
                                    }
                                    totalPos = pointStack
                                        ? pointStack[pointX]
                                    ...
                                    if (stacking) {
                                        ...
                                        if (!stacks[key][pointX]) {
                                            stacks[key][pointX] = new StackItem(
                                                options.stackLabels,
                                                isNegative,
                                                pointX,
                                                stackOption
                            ...
                            if (
                                /(area|column|bar)/.test(serie.type) &&
                                !isXAxis
                            ) {
            ...
            function setDateTimeTickPositions() {
                ...
                var multitude = normalizeTickInterval(
                ...
                if (interval >= oneSecond) {
                    ...
                    minDate.setSeconds(
                        interval >= oneMinute
                            ? 0
                            : multitude *
                              mathFloor(minDate.getSeconds() / multitude)
                    );
                }
                ...
                if (interval >= oneMinute) {
                    ...
                    minDate[setMinutes](
                        interval >= oneHour
                            ? 0
                            : multitude *
                              mathFloor(minDate[getMinutes]() / multitude)
                    );
                }
                ...
                if (interval >= oneHour) {
                    ...
                    minDate[setHours](
                        interval >= oneDay
                            ? 0
                            : multitude *
                              mathFloor(minDate[getHours]() / multitude)
                    );
                }
                ...
                if (interval >= oneDay) {
                    ...
                    minDate[setDate](
                        interval >= oneMonth
                            ? 1
                            : multitude *
                              mathFloor(minDate[getDate]() / multitude)
                    );
                }
                ...
                if (interval >= oneMonth) {
                    ...
                    minDate[setMonth](
                        interval >= oneYear
                            ? 0
                            : multitude *
                              mathFloor(minDate[getMonth]() / multitude)
                    );
                ...
                while (time < max && i < plotWidth) {
                    ...
                    if (interval === oneYear) {
                        time =
                            makeTime(minYear + i * multitude, 0) / timeFactor;

                        // if the interval is months, use Date.UTC to increase months
                    } else if (interval === oneMonth) {
                        time =
                            makeTime(minYear, minMonth + i * multitude) /
                            timeFactor;
            ...
            function setLinearTickPositions() {
                var i,
                    roundedMin = correctFloat(
                        mathFloor(min / tickInterval) * tickInterval
                    ),
                    roundedMax = correctFloat(
                        mathCeil(max / tickInterval) * tickInterval
                    );
            ...
            function setTickPositions() {
                ...
                if (min === max) {
                    ...
                    tickPixelIntervalOption ===
                        linkedParent.options.tickPixelInterval
                ) {
                    ...
                    tickInterval = pick(
                        ...
                        categories // for categoried axis, 1 is default, for linear axis use tickPix
                            ? 1
                            : ((max - min) * tickPixelIntervalOption) /
                              axisLength
                    );
                }
                ...
                minorTickInterval =
                    options.minorTickInterval === 'auto' && tickInterval
                        ? tickInterval / 5
                ...
                if (!isLinked) {
                    ...
                    if (categories || (isXAxis && chart.hasColumn)) {
                        ...
                        if (
                            categories ||
                            !defined(pick(options.min, userMin))
                        ) {
                            min -= catPad;
                        }
                        if (
                            categories ||
                            !defined(pick(options.max, userMax))
                        ) {
                            max += catPad;
                        }
                    }
            ...
            function adjustTickAmount() {
                if (maxTicks && !isDatetimeAxis && !categories && !isLinked) {
                    ...
                    if (
                        defined(oldTickAmount) &&
                        tickAmount !== oldTickAmount
                    ) {
                        axis.isDirty = true;
                    }
                }
            ...
            function setExtremes(newMin, newMax, redraw, animation) {
                ...
                fireEvent(
                    ...
                    'setExtremes',
                    {
                        // fire an event to enable syncing of multiple charts
                        min: newMin,
                        max: newMax,
                    },
                    function() {
            ...
            function getOffset() {
                var hasData =
                        associatedSeries.length && defined(min) && defined(max),
                    titleOffset = 0,
                    titleMargin = 0,
                ...
                if (axisTitleOptions && axisTitleOptions.text) {
                    if (!axisTitle) {
                        axisTitle = axis.axisTitle = renderer
                            .text(
            ...
            function render() {
                var axisTitleOptions = options.title,
                    ...
                    slideInTicks =
                        hasRendered && defined(oldMin) && !isNaN(oldMin),
                    hasData =
                        associatedSeries.length && defined(min) && defined(max);
                ...
                if (hasData || isLinked) {
                    ...
                    if (minorTickInterval && !categories) {
                        var pos =
                            min +
                            ((tickPositions[0] - min) % minorTickInterval);
                    ...
                    if (!hasRendered) {
                        // only first time
                        each(
                            (options.plotLines || []).concat(
                                options.plotBands || []
                            ),
                            function(plotLineOptions) {
                                plotLinesAndBands.push(
                                    new PlotLineOrBand(plotLineOptions).render()
                                );
                            }
                        );
                    }
                ...
                if (lineWidth) {
                    ...
                    linePath = renderer.crispLine(
                        [
                            M,
                            horiz ? plotLeft : lineLeft,
                            horiz ? lineTop : plotTop,
                            L,
                            horiz ? chartWidth - marginRight : lineLeft,
                            horiz ? lineTop : chartHeight - marginBottom,
                        ],
                        lineWidth
                    );
                    if (!axisLine) {
                ...
                if (axisTitle) {
                    ...
                    var margin = horiz ? plotLeft : plotTop,
                        ...
                        offAxis =
                            (horiz ? plotTop + plotHeight : plotLeft) +
            ...
            function destroy() {
                ...
                // Destroy collections
                each(
                    [ticks, minorTicks, alternateBands, plotLinesAndBands],
                    function(coll) {
                ...
                each([axisLine, axisGroup, gridGroup, axisTitle], function(
                    obj
                ) {
                    if (obj) {
                        obj.destroy();
         ...
         */
        function Toolbar() {
            var buttons = {}; /* allow the unused param title until Toolbar rewrite*/

            /*jslint unparam: true*/ function add(id, text, title, fn) {
                if (!buttons[id]) {
                    var button = renderer
                        .text(text, 0, 0)
        ...
        function Tooltip(options) {
            ...
            var group = renderer
                ...
                label = renderer
                    .text(
                        '',
                        padding + boxOffLeft,
                        pInt(style.fontSize) + padding + boxOffLeft,
                        options.useHTML
                    )
                    .attr({ zIndex: 1 })
                    .css(style)
            ...
            function move(finalX, finalY) {
                ...
                if (
                    mathAbs(finalX - currentX) > 1 ||
                    mathAbs(finalY - currentY) > 1
                ) {
            ...
            function refresh(point) {
                ...
                show =
                    shared || !point.series.isCartesian || isInsidePlot(x, y);
                ...
                if (text === false || !show) {
                    ...
                    // do the move
                    move(
                        mathRound(placedTooltipPoint.x - boxOffLeft),
                        mathRound(placedTooltipPoint.y - boxOffLeft)
                    );
                }
                    ...
                    while (i--) {
                        ...
                        if (crosshairsOptions[i] && axis) {
                            ...
                            if (crosshairs[i]) {
                                ...
                                attribs = {
                                    'stroke-width':
                                        crosshairsOptions[i].width || 1,
                                    stroke:
                                        crosshairsOptions[i].color || '#C0C0C0',
                                    zIndex: 2,
                                };
                                if (crosshairsOptions[i].dashStyle) {
                                    attribs.dashstyle =
                                        crosshairsOptions[i].dashStyle;
                                }
                                crosshairs[i] = renderer
                                    .path(path)
                                    .attr(attribs)
                                    .add();
                            }
        ...
        function MouseTracker(options) {
            ...
            function normalizeMouseEvent(e) {
                var ePos,
                    pageZoomFix =
                        isWebKit && doc.width / doc.body.scrollWidth - 1, // #224, #348
                    chartPosLeft,
                    chartPosTop,
                    chartX,
                    chartY;
                ...
                if (e.type !== 'mousemove' || win.opera || pageZoomFix) {
                ...
                if (pageZoomFix) {
                    chartX += mathRound(
                        (pageZoomFix + 1) * chartPosLeft - chartPosLeft
                    );
                    chartY += mathRound(
                        (pageZoomFix + 1) * chartPosTop - chartPosTop
                    );
                }
                            ...
                            if (
                                ...
                                if (!selectionMarker) {
                                    selectionMarker = renderer
                                        ...
                                        .attr({
                                            fill:
                                                optionsChart.selectionMarkerFill ||
            ...
            placeTrackerGroup = function() {
                ...
                if (!trackerGroup) {
                    chart.trackerGroup = trackerGroup = renderer
                        .g('tracker')
                        .attr({ zIndex: 9 })
                        .add();
        ...
        var Legend = function() {
            ...
            function destroyItem(item) {
                ...
                each(['legendItem', 'legendLine', 'legendSymbol'], function(
                    key
                ) {
                    if (item[key]) {
                        item[key].destroy();
            ...
            function renderItem(item) {
                ...
                if (!li) {
                    ...
                    item.legendItem = li = renderer
                        .text(options.labelFormatter.call(item), 0, 0)
                ...
                itemWidth = item.legendItemWidth =
                    options.itemWidth ||
                    symbolWidth + symbolPadding + bBox.width + padding;
                itemHeight = bBox.height;

                // if the item exceeds the width, start a new line
                if (
                    horizontal &&
                    itemX - initialItemX + itemWidth >
        ...
        function getSelectedPoints() {
            ...
            each(series, function(serie) {
                points = points.concat(
                    grep(serie.data, function(point) {
        ...
        function getChartSize() {
            ...
            chart.chartWidth = chartWidth =
                optionsChart.width || containerWidth || 600;
        ...
        function getContainer() {
            ...
            chart.renderer = renderer = optionsChart.forExport // force SVG, used for SVG export
            ...
            if ((chart.title || chart.subtitle) && !defined(optionsMarginTop)) {
                ...
                if (titleOffset) {
                    plotTop = mathMax(
                        plotTop,
                        titleOffset +
                            pick(chartTitleOptions.margin, 15) +
                            spacingTop
                    );
                }
            }
        ...
        setChartSize = function() {
            ...
            chart.plotWidth = plotWidth = mathRound(
                chartWidth - plotLeft - marginRight
            );
            chart.plotHeight = plotHeight = mathRound(
                chartHeight - plotTop - marginBottom
            );
	...
	*/
    ...
    Point.prototype = {
        ...
        init: function(series, options) {
            ...
            if (series.options.colorByPoint) {
                ...
                point.color = point.options.color =
                    point.color || defaultColors[counters.color++];
        ...
        setState: function(state) {
            var point = this,
                ...
                markerStateOptions =
                    markerOptions && markerOptions.states[state],
                stateDisabled =
            ...
            if (
                ...
                (state &&
                    (stateDisabled ||
                        (normalDisabled && !markerStateOptions.enabled)))
            ) {
                return;
            }
    ...
    Series.prototype = {
        ...
        cleanData: function() {
            ...
            if (
                chartSmallestInterval === UNDEFINED ||
                smallestInterval < chartSmallestInterval
            ) {
        ...
        getSymbol: function() {
            var defaultSymbols = this.chart.options.symbols,
                counters = this.chart.counters;
            this.symbol =
                this.options.marker.symbol || defaultSymbols[counters.symbol++];
        ...
        translate: function() {
            ...
            while (i--) {
                var point = data[i],
                    ...
                    yBottom = point.low,
                    stack =
                        yAxis.stacks[(yValue < 0 ? '-' : '') + series.stackKey],
                    pointStack,
                    pointStackTotal;
                ...
                if (stacking && series.visible && stack && stack[xValue]) {
                    ...
                    if (stacking === 'percent') {
                        yBottom = pointStackTotal
                            ? (yBottom * 100) / pointStackTotal
                            : 0;
                        yValue = pointStackTotal
                            ? (yValue * 100) / pointStackTotal
                            : 0;
                    }
        ...
        setTooltipPoints: function(renew) {
            var series = this,
                ...
                data = [],
                plotSize = mathRound(
                    (inverted ? chart.plotTop : chart.plotLeft) +
                        chart.plotSizeX
                ),
                low,
                high,
            ...
            each(data, function(point, i) {
                ...
                high = point._high = data[i + 1]
                    ? mathFloor(
                          (point.plotX +
                              (data[i + 1] ? data[i + 1].plotX : plotSize)) /
                              2
                      )
                    : plotSize;
            ...
            if (series.options.marker.enabled) {
                ...
                while (i--) {
                    ...
                    if (plotY !== UNDEFINED && !isNaN(plotY)) {
                        ...
                        pointAttr =
                            point.pointAttr[
                                point.selected ? SELECT_STATE : NORMAL_STATE
                            ];
                        radius = pointAttr.r;
                        ...
                        if (graphic) {
                            ...
                            point.graphic = chart.renderer
                                .symbol(
                                    pick(
                                        point.marker && point.marker.symbol,
                                        series.symbol
                                    ),
                                    plotX,
                                    plotY,
                ...
                if (hasPointSpecificOptions) {
                    ...
                    if (!series.options.marker) {
                        ...
                        pointStateOptionsHover.color = Color(
                            pointStateOptionsHover.color || point.options.color
                        )
                            .brighten(
        ...
        destroy: function() {
            ...
            each(
                ['area', 'graph', 'dataLabelsGroup', 'group', 'tracker'],
                function(prop) {
                    if (series[prop]) {
                        // issue 134 workaround
                        destroy =
                            issue134 && prop === 'group' ? 'hide' : 'destroy';
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                ...
                if (!dataLabelsGroup) {
                    dataLabelsGroup = series.dataLabelsGroup = renderer
                        .g('data-labels')
                        .attr({
                ...
                each(data, function(point) {
                    var barX = point.barX,
                        plotX =
                            (barX && barX + point.barW / 2) ||
                            point.plotX ||
                            -999,
                        plotY = pick(point.plotY, -999),
                        dataLabel = point.dataLabel,
                        align = options.align,
                        individualYDelta = yIsNull
                            ? point.y >= 0
                                ? -6
                                : 12
                            : options.y;
                    ...
                    if (seriesType === 'column') {
                        x +=
                            ({ left: -1, right: 1 }[align] * point.barW) / 2 ||
                            0;
                    }
                    ...
                    if (dataLabel) {
                        ...
                        if (inverted && !options.y) {
                            y =
                                y +
                                pInt(dataLabel.styles.lineHeight) * 0.9 -
        ...
        drawGraph: function() {
            var series = this,
                ...
                segmentPath,
                renderer = chart.renderer,
                translatedThreshold = series.yAxis.getThreshold(
                    options.threshold || 0
                ),
            ...
            if (useArea) {
                ...
                if (area) {
                    ...
                    // draw the area
                    series.area = series.chart.renderer
                        .path(areaPath)
                        .attr({
                            fill: fillColor,
                        })
        ...
        render: function() {
            ...
            if (!clipRect) {
                clipRect = series.clipRect =
                    !chart.hasRendered && chart.clipRect
                        ? chart.clipRect
                        : renderer.clipRect(
                              0,
                              0,
    ...
    var ColumnSeries = extendClass(Series, {
        ...
        translate: function() {
            ...
            var data = series.data,
                ...
                pointWidth = mathMax(
                    pick(optionPointWidth, pointOffsetWidth - 2 * pointPadding),
                    1
                ),
                colIndex =
                    (reversedXAxis
                        ? columnCount - series.columnIndex
            ...
            each(data, function(point) {
                ...
                shapeArgs = extend(
                    chart.renderer.Element.prototype.crisp.apply({}, [
                        borderWidth,
                        barX,
                        barY,
                        pointWidth,
            ...
            each(series.data, function(point) {
                ...
                if (point.y !== null) {
                    if (tracker) {
                        ...
                        point.tracker = renderer[point.shapeType](shapeArgs)
                            .attr({
    ...
    var PieSeries = extendClass(Series, {
        ...
        drawDataLabels: function() {
            ...
            labelHeight =
                ...
                pInt(halves[0][0].dataLabel.styles.lineHeight);
