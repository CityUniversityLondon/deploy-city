    ...
    $.fn.cycle.API = {
        ...
        initSlideshow: function() {
            ...
            opts.container.on('cycle-paused cycle-resumed', function(e) {
                opts.container[
                    e.type === 'cycle-paused' ? 'addClass' : 'removeClass'
                ]('cycle-paused');
            });
        ...
        add: function(slides, prepend) {
            ...
            startSlideshow =
                opts._preInitialized &&
                (oldSlideCount < 2 && opts.slideCount >= 1);
            if (startSlideshow) {
        ...
        prepareTx: function(manual, fwd) {
            ...
            if (
                ...
                (manual || (!opts.paused && opts.timeout))
            ) {
        ...
        initSlide: function(slideOpts, slide, suggestedZindex) {
            ...
            if (isNaN(slideOpts.speed))
                slideOpts.speed =
                    $.fx.speeds[slideOpts.speed] || $.fx.speeds._default;
...
(function($) {
    ...
    $(document).on('cycle-initialized', function(e, opts) {
        ...
        if ($.type(opts.autoHeight) == 'number' && opts.autoHeight >= 0) {
            // use existing slide
            opts._sentinel = $(opts.slides[opts.autoHeight])
                .clone()
                .css({
                    position: 'static',
                    visibility: 'hidden',
            ...
            $.type(opts.autoHeight) == 'string' &&
            /\d+\:\d+/.test(opts.autoHeight)
        ) {
            // use ratio
...
(function($) {
    ...
    $(document).on('cycle-update-view', function(
        e,
        opts,
        slideOpts,
        currSlide
    ...
    $.extend(c2.API, {
        next: function() {
            ...
            if (
                ...
                opts.currSlide + count >= opts.slideCount
            )
                return;
...
(function($) {
    ...
    $(document).on('cycle-slide-added', function(
        e,
        opts,
        slideOpts,
        slideAdded
    ...
    $(document).on('cycle-slide-removed', function(
        e,
        opts,
        index,
        slideRemoved
...
(function($) {
    ...
    $(document).on('cycle-initialized', function(e, opts) {
        opts.API.getComponent('next')
            .off(opts.nextEvent)
            .on(opts.nextEvent, function(e) {
                e.preventDefault();
                opts.API.next();
            });

        opts.API.getComponent('prev')
            .off(opts.prevEvent)
            .on(opts.prevEvent, function(e) {
                e.preventDefault();
                opts.API.prev();
            });
        ...
        tmpl: function(str, opts, extra) {
            ...
            if (str && opts) {
                return str.replace(regex, function(_, str) {
                    ...
                    if ($.isFunction(prop)) return prop.call(obj, opts);
                    if (prop !== undefined && prop !== null) return prop;
                    if (extra && extra[str] !== undefined) return extra[str];
                    return str;
                });
            }
        },
