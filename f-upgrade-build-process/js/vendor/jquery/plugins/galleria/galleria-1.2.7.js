...
(function($) {
    ...
    var undef,
        ...
        _video = {
                ...
                getThumb: function(id, success, fail) {
                    ...
                    $.getJSON(
                        'https://api.dailymotion.com/video/' +
                            id +
                            '?fields=thumbnail_medium_url&callback=?',
                        function(data) {
                            try {
            ...
            city: {
                reg: /https?:\/\/((?:cass\.|www\.)?city\.ac\.uk)\/videos\/watch\?v=([^$&]+)/i,
                embed: function(id) {
                    return (
                        'https://s1.city.ac.uk/js/flowplayer/embed.html?v=' + id
                    );
                },
                getThumb: function(id, success, fail) {
                    if (
                        -1 !==
                        document.location.hostname.indexOf('cass.city.ac.uk')
                    ) {
                        success('https://s1.city.ac.uk/i/flowplayer-cass.jpg');
                    } else {
                        success('https://s1.city.ac.uk/i/flowplayer-city.jpg');
                    }
                },
            },
        },
        ...
        Utils = (function() {
            return {
                ...
                animate: (function() {
                    ...
                    return function(elem, to, options) {
                        ...
                        $.each(to, function(key, val) {
                            css = elem.css(key);
                            if (
                                Utils.parseValue(css) != Utils.parseValue(val)
                            ) {
                                change = true;
                            }
                ...
                forceStyles: function(elem, styles) {
                    elem = $(elem);
                    if (elem.attr('style')) {
                        elem.data('styles', elem.attr('style')).removeAttr(
                            'style'
                        );
                    }
                    elem.css(styles);
                    ...
                    options = $.extend(
                        {
                            ...
                            error: function() {
                                Galleria.raise(
                                    'Could not complete wait function.'
                                );
                            },
                            timeout: 3000,
                        },
                    ...
                    if ($('#' + id).length) {
                        ...
                        window.setTimeout(function() {
                            ...
                            if (styles.length) {
                                styles
                                    .get(0)
                                    .parentNode.insertBefore(link, styles[0]);
                            } else {
        ...
        _transitions = (function() {
            ...
            return {
                ...
                doorslide: function(params, complete) {
                    _slide.apply(
                        this,
                        Utils.array(arguments).concat([false, true])
                    );
                },
            };
        })();
    ...
    Galleria = function() {
        ...
        var keyboard = (this._keyboard = {
            ...
            press: function(e) {
                ...
                if (
                    key in keyboard.map &&
                    typeof keyboard.map[key] === 'function'
                ) {
        ...
        var carousel = (this._carousel = {
            ...
            update: function() {
                ...
                $.each(self._thumbnails, function(i, thumb) {
                    if (thumb.ready) {
                        w +=
                            thumb.outerWidth ||
                            $(thumb.container).outerWidth(true);
                        hooks[i + 1] = w;
                        h = Math.max(
                            h,
                            thumb.outerHeight ||
                                $(thumb.container).outerHeight(true)
                        );
                    }
                });
                ...
                carousel.next.bind('click', function(e) {
                    ...
                    if (self._options.carouselSteps === 'auto') {
                        for (
                            ...
                            if (
                                carousel.hooks[i] -
                                    carousel.hooks[carousel.current] >
                                carousel.width
                            ) {
                                carousel.set(i - 2);
                                break;
                        ...
                        carousel.set(
                            carousel.current + self._options.carouselSteps
                        );
                    }
                });
            ...
            setClasses: function() {
                ...
                carousel.next.toggleClass(
                    'disabled',
                    carousel.hooks[carousel.current] + carousel.width >=
                        carousel.max
                );
            },
        ...
        var tooltip = (this._tooltip = {
            ...
            define: function(elem, value) {
                ...
                elem = $(elem in self._dom ? self.get(elem) : elem).data(
                    'tt',
                    value
                );
        ...
        var lightbox = (this._lightbox = {
            ...
            init: function() {
                ...
                var elems =
                    ...
                    cssMap = {
                        ...
                        prevholder:
                            abs + 'width:50%;top:0;bottom:40px;cursor:pointer;',
                        nextholder:
                            abs +
            ...
            show: function(index) {
                ...
                lightbox.image.load(
                    data.iframe || data.big || data.image,
                    function(image) {
                        lightbox.width = image.isIframe
                            ? $(window).width()
                            : image.original.width;
                        lightbox.height = image.isIframe
                            ? $(window).height()
                        ...
                        lightbox.elems.counter.innerHTML =
                            index + 1 + ' / ' + total;
    ...
    */
        ...
        _init: function() {
            ...
            this.bind(Galleria.DATA, function() {
                ...
                Utils.wait({
                    ...
                    timeout:
                        typeof this._options.wait == 'number'
                            ? this._options.wait
                            : false,
                });
            });
            ...
            this.$('image-nav-right, image-nav-left').bind('click', function(
                e
            ) {
            ...
            if (options.swipe) {
                (function(images) {
                    ...
                    images.bind(ev.start, function(e) {
                        ...
                        images
                            .bind(ev.move, moveHandler)
                            .one(ev.stop, upHandler);
                    });
                })(self.$('images'));
        ...
        _createThumbnails: function() {
            ...
            var i,
                ...
                optval =
                    typeof o.thumbnails === 'string'
                        ? o.thumbnails.toLowerCase()
                        : null,
            ...
            for (i = 0; this._data[i]; i++) {
                ...
                if (o.thumbnails === true && (data.thumb || data.image)) {
                    ...
                    window.setTimeout(
                        fake(thumb.image, i, thumb.container),
                        50 + i * 20
                    );
                ...
                $(thumb.container)
                    .add(
                        o.keepSource && o.linkSourceImages
                            ? data.original
                            : null
                    )
                    .data('index', i)
                    .bind(o.thumbEventType, onThumbEvent);
        ...
        load: function(source, selector, config) {
            ...
            $(source)
                ...
                .each(function(i, elem) {
                    ...
                    $.each(
                        'big title description link layer'.split(' '),
                        function(i, val) {
                            if (elem.data(val)) {
        ...
        _parseData: function() {
            ...
            $.each(this._data, function(i, data) {
                ...
                if ('video' in data) {
                    ...
                    if (result) {
                        current.iframe =
                            _video[result.provider].embed(result.id) +
                            (function() {
                                // add options
                                if (
                                    typeof self._options[result.provider] ==
                                    'object'
                                ) {
                                    var str = '?',
                                        arr = [];
                                    $.each(
                                        self._options[result.provider],
                                        function(key, val) {
                                            arr.push(key + '=' + val);
                                        }
                                    );
        ...
        addPan: function(img) {
            ...
            var self = this,
                ...
                position = function(dist, cur, pos) {
                    if (dist > 0) {
                        move = Math.round(
                            Math.max(dist * -1, Math.min(0, cur))
                        );
                        if (cache !== move) {
                            cache = move;
            ...
            this.$('stage')
                .unbind('mousemove', calculate)
                .bind('mousemove', calculate);
...
this.prependChild( 'info', 'myElement' );
                ...
                scaleLayer = function(img) {
                    $(img.container)
                        ...
                        .css({
                            top: Math.max(
                                0,
                                Utils.parseValue(img.image.style.top)
                            ),
                            left: Math.max(
                                0,
                                Utils.parseValue(img.image.style.left)
                            ),
    ...
    */
        ...
        resize: function(measures, complete) {
            ...
            var self = this,
                ...
                aspect =
                    this._options.responsive == 'aspect' &&
    ...
    */
        ...
        show: function(index, rewind, _history) {
            ...
            index = Math.max(
                0,
                Math.min(parseInt(index, 10), this.getDataLength() - 1)
            );

            rewind =
                typeof rewind !== 'undefined'
                    ? !!rewind
                    : index < this.getIndex();
        ...
        _show: function() {
            ...
            var src =
                    data.iframe ||
                    (this.isFullscreen() && 'big' in data
                        ? data.big
                        : data.image), // use big image if fullscreen mode
            ...
            if (this._options.preload) {
                ...
                try {
                    for (i = this._options.preload; i > 0; i--) {
                        ...
                        ndata = self.getData(n);
                        p.preload(
                            this.isFullscreen() && 'big' in ndata
                                ? ndata.big
                                : ndata.image
                        );
                        n = self.getNext(n);
                    ...
                    complete: function(next) {
                        ...
                        $.each(
                            ...
                            function(type, arg) {
                                if (
                                    arg &&
                                    self._options[type + 'Transition'] !== undef
                                ) {
                                    transition =
                                        self._options[type + 'Transition'];
                                    return false;
                                }
                            }
                        );
    ...
    Galleria.loadTheme = function(src, options) {
        var loaded = false,
            ...
            err = window.setTimeout(function() {
                Galleria.raise(
                    'Theme at ' + src + ' could not load, check theme path.',
                    true
                );
            }, 5000);
        ...
        scale: function(options) {
            ...
            Utils.wait({
                ...
                success: function() {
                    ...
                    var newWidth =
                            (width - options.margin * 2) / self.original.width,
                        newHeight =
                    ...
                    $.each(['width', 'height'], function(i, m) {
                        $(self.image)[m](
                            (self[m] = self.image[m] = Math.round(
                                self.original[m] * ratio
                            ))
                        );
                    });
                    ...
                    $.each(options.position.toLowerCase().split(' '), function(
                        i,
                        value
                    ) {
                        if (value === 'center') {
