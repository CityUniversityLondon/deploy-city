        ...
        onResize = function() {
            if (viewportChanged()) {
                ...
                if (newWidth >= breakpoints.wide) {
                    //big to small?
                    $body
                        .addClass('screen-wide')
                        .removeClass('screen-thin screen-medium');
                    ...
                    //small to big?
                    $body
                        .addClass('screen-medium')
                        .removeClass('screen-thin screen-wide');
                    $utilNav.addClass('hidden');
                    $drops.removeClass('active').hide();
                    $navLis.removeClass('active');
                } else {
                    $body
                        .addClass('screen-thin')
                        .removeClass('screen-medium screen-wide');
                }
            }
        },
        init = function() {
