...
(function(e, t) {
    ...
    (e.cleanData = function(t) {
        ...
        (e.widget.extend = function(i) {
            for (
                var n, a, o = s.call(arguments, 1), r = 0, h = o.length;
                h > r;
                r++
            )
                for (n in o[r])
        ...
        (e.widget.bridge = function(i, n) {
            ...
            e.fn[i] = function(o) {
                ...
                return (
                    (o =
                        !r && h.length
                            ? e.widget.extend.apply(null, [o].concat(h))
                            : o),
                    r
                        ? this.each(function() {
                              var s,
            ...
            _on: function(i, s, n) {
                ...
                'boolean' != typeof i && ((n = s), (s = i), (i = !1)),
                    ...
                    e.each(n, function(n, r) {
                        ...
                        'string' != typeof r &&
                            (h.guid = r.guid = r.guid || h.guid || e.guid++);
                        var l = n.match(/^(\w+)\s*(.*)$/),
...
(function(e, t) {
    function i(e, t, i) {
        return [
            parseInt(e[0], 10) * (c.test(e[0]) ? t / 100 : 1),
            parseInt(e[1], 10) * (c.test(e[1]) ? i / 100 : 1),
        ];
    }
    function s(t, i) {
            ...
            return (
                9 === y.nodeType
                    ...
                    : e.isWindow(y)
                        ? ((c = v.width()),
                          (f = v.height()),
                          (m = { top: v.scrollTop(), left: v.scrollLeft() }))
                        : y.preventDefault
                            ? ((t.at = 'left top'),
                              (c = f = 0),
                              (m = { top: y.pageY, left: y.pageX }))
                            : ((c = v.outerWidth()),
                              (f = v.outerHeight()),
                              (m = v.offset())),
                (g = e.extend({}, m)),
                ...
                this.each(function() {
                    ...
                    'right' === t.my[0]
                        ...
                        'bottom' === t.my[1]
                            ? (S.top -= p)
                            : 'center' === t.my[1] && (S.top -= p / 2),
                        (S.left += N[0]),
                        (S.top += N[1]),
                        e.support.offsetFractions ||
                            ((S.left = r(S.left)), (S.top = r(S.top))),
                        (h = { marginLeft: y, marginTop: k }),
                        e.each(['left', 'top'], function(i, s) {
                            e.ui.position[x[i]] &&
                                e.ui.position[x[i]][s](S, {
                                    targetWidth: c,
                                    targetHeight: f,
                                    elemWidth: d,
                                    elemHeight: p,
        ...
        (e.ui.position = {
            fit: {
                left: function(e, t) {
                    ...
                    t.collisionWidth > o
                        ? h > 0 && 0 >= l
                            ? ((i = e.left + h + t.collisionWidth - o - n),
                              (e.left += h - i))
                            : (e.left =
                                  l > 0 && 0 >= h
                                      ? n
                ...
                top: function(e, t) {
                    ...
                    t.collisionHeight > o
                        ? h > 0 && 0 >= l
                            ? ((i = e.top + h + t.collisionHeight - o - n),
                              (e.top += h - i))
                            : (e.top =
                                  l > 0 && 0 >= h
                                      ? n
                                      : h > l
                                          ? n + o - t.collisionHeight
                                          : n)
                        : h > 0
                            ? (e.top += h)
                            : l > 0
            ...
            flip: {
                left: function(e, t) {
                    var i,
                        ...
                        f = -2 * t.offset[0];
                    0 > u
                        ? ((i = e.left + c + p + f + t.collisionWidth - r - a),
                ...
                top: function(e, t) {
                    var i,
                        ...
                        m = -2 * t.offset[1];
                    0 > u
                        ? ((s = e.top + p + f + m + t.collisionHeight - r - a),
                          e.top + p + f + m > u &&
                              (0 > s || o(u) > s) &&
                              (e.top += p + f + m))
                        : d > 0 &&
                ...
                ('document' == t.containment || 'window' == t.containment) &&
                    (this.containment = [
                        ...
                        ('document' == t.containment
                            ...
                            : e(window).scrollLeft()) +
                            e(
                                'document' == t.containment ? document : window
                            ).width() -
                            this.helperProportions.width -
                            this.margins.left,
                        ('document' == t.containment
            ...
            if (this.originalPosition) {
                ...
                if (this.containment) {
                    ...
                    t.pageX - this.offset.click.left < r[0] &&
                        (a = r[0] + this.offset.click.left),
                        t.pageY - this.offset.click.top < r[1] &&
                            (o = r[1] + this.offset.click.top),
                        t.pageX - this.offset.click.left > r[2] &&
                            (a = r[2] + this.offset.click.left),
                        t.pageY - this.offset.click.top > r[3] &&
                            (o = r[3] + this.offset.click.top);
                }
                if (i.grid) {
                    var l = i.grid[1]
                        ? this.originalPageY +
                          Math.round((o - this.originalPageY) / i.grid[1]) *
                              i.grid[1]
                        : this.originalPageY;
                    o = r
                        ? l - this.offset.click.top < r[1] ||
                          l - this.offset.click.top > r[3]
                            ? l - this.offset.click.top < r[1]
                                ? l + i.grid[1]
                                : l - i.grid[1]
                            : l
            ...
            drag: function(t, i) {
                for (
                    var s = e(this).data('draggable'),
                        ...
                        a = n.snapTolerance,
                        o = i.offset.left,
                        r = o + s.helperProportions.width,
                        h = i.offset.top,
                        l = h + s.helperProportions.height,
                        u = s.snapElements.length - 1;
                    u >= 0;
                    u--
                ) {
                    ...
                    if (
                        (o > d - a && c + a > o && h > p - a && f + a > h) ||
                        (o > d - a && c + a > o && l > p - a && f + a > l) ||
                        (r > d - a && c + a > r && h > p - a && f + a > h) ||
                        (r > d - a && c + a > r && l > p - a && f + a > l)
                    ) {
                        if ('inner' != n.snapMode) {
    ...
    e.widget('ui.resizable', e.ui.mouse, {
            ...
            if (
                ...
                for (var n = 0; s.length > n; n++) {
                    var a = e.trim(s[n]),
                        o = 'ui-resizable-' + a,
                        r = e(
                            '<div class="ui-resizable-handle ' + o + '"></div>'
                        );
        ...
        _mouseStart: function(i) {
            ...
            (this.resizing = !0),
                ...
                (a.is('.ui-draggable') || /absolute/.test(a.css('position'))) &&
                    a.css({ position: 'absolute', top: n.top, left: n.left }),
                this._renderProxy();
            var o = t(this.helper.css('left')),
                r = t(this.helper.css('top'));
            s.containment &&
                ((o += e(s.containment).scrollLeft() || 0),
                (r += e(s.containment).scrollTop() || 0)),
                (this.offset = this.helper.offset()),
                (this.position = { left: o, top: r }),
        ...
        _mouseStop: function(t) {
            ...
            if (this._helper) {
                ...
                i.animate || this.element.css(e.extend(h, { top: u, left: l })),
        ...
        _respectSize: function(e, t) {
            ...
            var l = this.originalPosition.left + this.originalSize.width,
                ...
                d = /sw|nw|w/.test(n),
                c = /nw|ne|n/.test(n);
            r && d && (e.left = l - s.minWidth),
                a && d && (e.left = l - s.maxWidth),
                h && c && (e.top = u - s.minHeight),
                o && c && (e.top = u - s.maxHeight);
                    ...
                    s.css({
                        height:
                            t.height() -
                                ...
                                this.borderDif[2] || 0,
                        width:
                            t.width() - this.borderDif[1] - this.borderDif[3] ||
                            0,
                    });
                }
        },
            ...
            resize: function(t) {
                ...
                h[0] != document && /static/.test(h.css('position')) && (r = n),
                    a.left < (i._helper ? n.left : 0) &&
                        ...
                        o && (i.size.height = i.size.width / i.aspectRatio),
                    ...
                    a.top < (i._helper ? n.top : 0) &&
                        ((i.size.height =
                            ...
                            (i._helper
                                ...
                                : i.position.top)),
                        o && (i.size.width = i.size.height * i.aspectRatio),
                ...
                var l = Math.abs(
                        (i._helper
                            ? i.offset.left - r.left
                            : i.offset.left - r.left) + i.sizeDiff.width
                    ),
                    u = Math.abs(
                        (i._helper
                            ? i.offset.top - r.top
                            : i.offset.top - n.top) + i.sizeDiff.height
                    ),
                    d = i.containerElement.get(0) == i.element.parent().get(0),
                    c = /relative|absolute/.test(
                        i.containerElement.css('position')
                    );
                d && c && (l -= i.parentData.left),
                    l + i.size.width >= i.parentData.width &&
                        ((i.size.width = i.parentData.width - l),
                        o && (i.size.height = i.size.width / i.aspectRatio)),
        ...
        e.ui.plugin.add('resizable', 'grid', {
            resize: function(t) {
                ...
                s._aspectRatio || t.shiftKey,
                    (s.grid =
                        'number' == typeof s.grid ? [s.grid, s.grid] : s.grid);
                var h =
                        Math.round((n.width - a.width) / (s.grid[0] || 1)) *
                        (s.grid[0] || 1),
                    l =
                        Math.round((n.height - a.height) / (s.grid[1] || 1)) *
                        (s.grid[1] || 1);
                /^(se|s|e)$/.test(r)
                    ? ((i.size.width = a.width + h),
                      (i.size.height = a.height + l))
                    : /^(ne)$/.test(r)
                        ? ((i.size.width = a.width + h),
                          (i.size.height = a.height + l),
                          (i.position.top = o.top - l))
                        : /^(sw)$/.test(r)
                            ? ((i.size.width = a.width + h),
                              (i.size.height = a.height + l),
                              (i.position.left = o.left - h))
                            : ((i.size.width = a.width + h),
                              (i.size.height = a.height + l),
                              (i.position.top = o.top - l),
                              (i.position.left = o.left - h));
            ...
            ((function(e, t) {
                ...
                t._create = function() {
                    if (this.options.navigation) {
                        ...
                        a &&
                            s.add(n).each(function(i) {
                                return e.contains(this, a)
                                    ? ((t.options.active = Math.floor(i / 2)),
                                      !1)
                                    : undefined;
                            });
                    }
        ...
        _create: function() {
            ...
            (this.isMultiLine = this._isMultiLine()),
                (this.valueMethod = this.element[
                    this.element.is('input,textarea') ? 'val' : 'text'
                ]),
                (this.isNewMenu = !0),
                this.element
                ...
                u &&
                    ...
                    this.buttonElement
                        .bind('mousedown' + this.eventNamespace, function(e) {
                            r.disabled ||
                                ((n = !1), (i = e.pageX), (s = e.pageY));
                        })
                        .bind('mouseup' + this.eventNamespace, function(e) {
                            r.disabled ||
                                ((i !== e.pageX || s !== e.pageY) && (n = !0));
                        })),
                'checkbox' === this.type
                    ...
                    : 'radio' === this.type
                        ...
                        : (this.buttonElement
                              ...
                              .bind('keydown' + this.eventNamespace, function(
                                  t
                              ) {
                                  return r.disabled
                                      ? !1
    ...
    $.extend(Datepicker.prototype, {
                ...
                if (i.match(/[DM]/)) {
                    ...
                    t.setMonth(
                        s(
                            this._get(
                                e,
                                i.match(/MM/) ? 'monthNames' : 'monthNamesShort'
                            )
                        )
                    ),
                        t.setDate(
                            s(
                                this._get(
                                    e,
                                    i.match(/DD/) ? 'dayNames' : 'dayNamesShort'
                                )
                            ) +
                                20 -
                                t.getDay()
        ...
        _optionDatepicker: function(e, t, i) {
            ...
            if (('string' == typeof t && ((n = {}), (n[t] = i)), s)) {
                ...
                extendRemove(s.settings, n),
                    null !== o &&
                        n.dateFormat !== undefined &&
                        n.minDate === undefined &&
                        (s.settings.minDate = this._formatDate(s, o)),
                    null !== r &&
                        n.dateFormat !== undefined &&
                        n.maxDate === undefined &&
                        (s.settings.maxDate = this._formatDate(s, r)),
            ...
            if (
                ...
                if (s !== !1) {
                    ...
                    if (
                        ...
                        $.datepicker._updateDatepicker(t),
                        (a = $.datepicker._checkOffset(t, a, n)),
                        t.dpDiv.css({
                            position:
        ...
        _hideDatepicker: function(e) {
            ...
            if (
                ...
                $.effects && ($.effects.effect[i] || $.effects[i])
                    ? t.dpDiv.hide(i, $.datepicker._get(t, 'showOptions'), s, n)
                    : t.dpDiv[
                          'slideDown' == i
                              ? 'slideUp'
                              : 'fadeIn' == i
                ...
                a &&
                    a.apply(t.input ? t.input[0] : null, [
                        t.input ? t.input.val() : '',
                        t,
                    ]),
        ...
        _adjustDate: function(e, t, i) {
            ...
            this._isDisabledDatepicker(s[0]) ||
                (this._adjustInstDate(
                    n,
                    t + ('M' == i ? this._get(n, 'showCurrentAtPos') : 0),
                    i
                ),
        ...
        _selectDate: function(e, t) {
            ...
            n
                ? n.apply(s.input ? s.input[0] : null, [t, s])
                ...
                var n =
                    ...
                    m = function(e, i, s) {
                        ...
                        if (
                            ($.each(n, function(e, i) {
                                var s = i[1];
                                return t.substr(v, s.length).toLowerCase() ==
                                    s.toLowerCase()
                                    ? ((a = i[0]), (v += s.length), !1)
                                    : undefined;
                            }),
                        ...
                        switch (h[2] || 'd') {
                            ...
                            case 'M':
                                (a += parseInt(h[1], 10)),
                                    (o = Math.min(
                                        o,
                                        $.datepicker._getDaysInMonth(n, a)
                                    ));
                                break;
                            case 'y':
                            case 'Y':
        ...
        _generateHTML: function(e) {
            ...
            g = a
                ? this.formatDate(
                      g,
                      this._daylightSavingAdjust(new Date(f, p - h, 1)),
            ...
            _ = a
                ...
                : _;
            var y = this._canAdjustMonth(e, 1, f, p)
            ...
            for (
                var H = this._getDefaultDate(e), z = '', F = 0;
                o[0] > F;
                F++
            ) {
                var E = '';
                this.maxRows = 4;
                for (var O = 0; o[1] > O; O++) {
                    var W = this._daylightSavingAdjust(
                            new Date(f, p, e.selectedDay)
                        ),
                        j = ' ui-corner-all',
                        L = '';
                    if (l) {
                        if (
                            ((L += '<div class="ui-datepicker-group'), o[1] > 1)
                        )
                            switch (O) {
                                case 0:
                    ...
                    L +=
                        ...
                        j +
                        '">' +
                        (/all|left/.test(j) && 0 == F ? (i ? y : v) : '') +
                        (/all|right/.test(j) && 0 == F ? (i ? v : y) : '') +
                    ...
                    this.maxRows = U;
                    for (
                        var q = this._daylightSavingAdjust(
                                new Date(f, p, 1 - K)
                            ),
                            Q = 0;
                        U > Q;
                        ...
                        for (
                            ...
                            var X = P
                                    ? P.apply(e.input ? e.input[0] : null, [q])
                                    : [!0, ''],
                                Z = q.getMonth() != p,
                                et =
                                    (Z && !I) ||
        ...
        _generateMonthYearHeader: function(e, t, i, s, n, a, o, r) {
            var h = this._get(e, 'changeMonth'),
                ...
                c = '';
            if (a || !h)
                c += '<span class="ui-datepicker-month">' + o[t] + '</span>';
            else {
            ...
            if ((u || (d += c + (!a && h && l ? '' : '&#xa0;')), !e.yearshtml))
                if (((e.yearshtml = ''), a || !l))
                    ...
                    var g = this._get(e, 'yearRange').split(':'),
                        ...
                        b = Math.max(y, _(g[1] || ''));
                    for (
                        y = s ? Math.max(y, s.getFullYear()) : y,
                            b = n ? Math.min(b, n.getFullYear()) : b,
                            e.yearshtml +=
    ...
    e.widget('ui.dialog', {
        ...
        _create: function() {
            ...
            (s = (this.uiDialog = e('<div>'))
                ...
                .css({ display: 'none', outline: 0, zIndex: l.zIndex })
                .attr('tabIndex', -1)
                .keydown(function(t) {
                    l.closeOnEscape &&
                ...
                (o = e('<span>')
                    ...
                    .html(u)
                    .prependTo(n)),
                (r = (this.uiDialogButtonPane = e('<div>')).addClass(
                    'ui-dialog-buttonpane ui-widget-content ui-helper-clearfix'
                )),
                (this.uiButtonSet = e('<div>'))
                    .addClass('ui-dialog-buttonset')
                    .appendTo(r),
                s.attr({ role: 'dialog', 'aria-labelledby': o.attr('id') }),
                n
                    .find('*')
                    .add(n)
                    .disableSelection(),
                    ...
                    keydown: function(i) {
                        if (l.modal && i.keyCode === e.ui.keyCode.TAB) {
                            var n = e(':tabbable', s),
                                a = n.filter(':first'),
                                o = n.filter(':last');
                            return i.target !== o[0] || i.shiftKey
                                ? i.target === a[0] && i.shiftKey
                                    ? (o.focus(1), !1)
                                    : t
                                : (a.focus(1), !1);
                        }
        ...
        _position: function(t) {
            ...
            t
                ? (('string' == typeof t ||
                      ('object' == typeof t && '0' in t)) &&
                      ((s = t.split ? t.split(' ') : [t[0], t[1]]),
                      1 === s.length && (s[1] = s[0]),
        ...
        _size: function() {
            ...
            this.element.show().css({ width: 'auto', minHeight: 0, height: 0 }),
                ...
                'auto' === n.height
                    ...
                    : this.element.height(Math.max(n.height - t, 0)),
                this.uiDialog.is(':data(resizable)') &&
        ...
        e.extend(e.ui.dialog.overlay, {
            ...
            create: function(i) {
                0 === this.instances.length &&
                    (setTimeout(function() {
                        e.ui.dialog.overlay.instances.length &&
                            e(document).bind(
                                e.ui.dialog.overlay.events,
                                function(i) {
                                    return e(i.target).zIndex() <
                                        e.ui.dialog.overlay.maxZ
                                        ? !1
                                        : t;
                                }
                ...
                return (
                    e(document).bind('keydown.dialog-overlay', function(t) {
            ...
            destroy: function(t) {
                var i = e.inArray(t, this.instances),
                    s = 0;
                -1 !== i &&
                    this.oldInstances.push(this.instances.splice(i, 1)[0]),
                    0 === this.instances.length &&
        ...
        _create: function() {
            (this.activeMenu = this.element),
                ...
                this._on(this.document, {
                    click: function(i) {
                        e(i.target).closest('.ui-menu').length ||
                            this.collapseAll(i),
                            (t = !1);
                    },
                });
        ...
        _move: function(e, t, i) {
            ...
            this.active &&
                ...
                (s && s.length && this.active) ||
                    (s = this.activeMenu.children('.ui-menu-item')[t]()),
                this.focus(i, s);
        },
        nextPage: function(t) {
            var i, s, n;
