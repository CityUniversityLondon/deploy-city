...
var libraryAdmin = (function($) {
    ...
    var //private attributes
        ...
        setNoticeMessage = function() {
            ...
            $noticeMessage.after(
                '<img class="ajax-loader-notice" src="https://s1.city.ac.uk/i/skin/ajax-loader-small-red.gif">'
            );
                                                ...
                                                if (!data3.error) {
                                                    if (is24Hours === false) {
                                                        newLi =
                                                            ...
                                                            "Opened on " +
                                                            $dayOfTheWeek.substring(0, $dayOfTheWeek.length - 1) +
