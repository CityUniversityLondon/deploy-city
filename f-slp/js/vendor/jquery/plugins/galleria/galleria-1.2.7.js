...
// internal constants
    ...
    _video = {
        ...
        city: {
            ...
            embed: function(id) {
                return 'http://s1.city.ac.uk/js/flowplayer/embed.html?v=' + id;
            },
            getThumb: function(id, success, fail) {
                if (-1 !== document.location.hostname.indexOf('cass.city.ac.uk')) {
                    success('//s1.city.ac.uk/i/flowplayer-cass.jpg');
                } else {
                    success('//s1.city.ac.uk/i/flowplayer-city.jpg');
                }
            }
        }
    },
