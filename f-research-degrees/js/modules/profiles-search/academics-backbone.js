...
(function (B, M) {
    ...
    var
        ...
        $scrollBtn = $("<button />", {
            ...
            html: "<i class=\"fa fa-arrow-up\"></i><span class=\"visuallyhidden\">scroll to top of page</a>",
            click: function (e) {
                e.preventDefault();
                $("html, body").animate({
                    scrollTop: 0
     ...
     */
        AcademicsCollection = Backbone.Paginator.clientPager.extend({
            ...
            server_api: {
                ...
                landing: "true",
                sort: "metaR",
                meta_x_not: "8706" // temporary fix to remove that profile from the listing
            },
    ...
    // views
        ...
        SearchboxView = B.View.extend({
            ...
            adjustRoom: function () {
                ...
                this.$inputEl.css({"padding-left": tagFilterWidth + "px"});
        ...
        TagFilterView = M.ItemView.extend({
            ...
            template: function (data) {
                ...
                return $("<span />", {
                    ...
                    html: "<i class=\"fa fa-tag\"></i> " + data.value.replace("\\(", "(").replace("\\)", ")") + "<i class=\"fa fa-times\"></i>"
                });
