        ...
        */
            ...
            initBookingForm = function () {
                ...
                ajaxFormOptions = {
                    ...
                    beforeSubmit: function (formData) {
                        ...
                        $(".primaryAction", $bookingForm).attr("value", "").attr("disabled", "disabled").addClass("submitting");
                    ...
                    success: function (responseText, statusText) {
                        ...
                        $response = $(responseText).find("#content").find("h1").remove().end();
        ...
        eventsCalendar = function (B, M) {
            ...
            CalendarCollection = Backbone.Collection.extend({
                ...
                url: function() {
                    var url = "/fb/search.json?collection=city-events&meta_P_orsand=%22Yes%22&landing=true&sort=adate&_=1373022367687";
            ...
            LinksView = M.ItemView.extend({
                ...
                template: function() {
                    ...
                    this.today = new Date();
                    this.endOfMonthObj = new Date(this.today.getFullYear(),
                                        this.today.getMonth(),
                                        daysInMonth(this.today.getMonth(),
            ...
            CalendarView = Backbone.View.extend({
                ...
                calendarBuild: function (calendarObj) {
                    ...
                    this.fbUrl = "/fb/search.json?collection=city-events&sort=adate&meta_P_orsand=%22Yes%22&form=calendar&date=all&landing=true";
                    this.noOfDaysFromNow = new Date();
                    this.today = new Date();
                    this.endOfMonthObj = new Date(this.today.getFullYear(),
                                                this.today.getMonth(),
                    ...
                    for (i; i < this.resultsLength; i++) {
                        ...
                        if (this.results[i].attributes.d) {
                            ...
                            this.eventDates.push($.datepicker.parseDate( "yy-mm-dd", this.results[i].attributes.d).setHours(0, 0, 0, 0));
                        }
                    }
                    ...
                    this.calendar.datepicker({
                        ...
                        onSelect : function (e, dateObj) {
                            if (isEventsHome) {
                                ...
                                newUrl = "/calendar#show/equalTo/" + dateObj.currentDay + "-" + months[dateObj.currentMonth] + "-" + dateObj.currentYear;
                    ...
                    calendarObj.removeClass("component-loading").children('.loading-fa-icon').remove();
                }
            ...
            */
            ...
            EventsListView = M.CollectionView.extend({
                ...
                removeSpinners: function () {
                    this.$el.removeClass("component-loading").children('.loading-fa-icon').remove();
                }
            ...
            FacetsView = B.View.extend({
                ...
                facetClick: function (e) {
                    ...
                    var $this = $(e.target),
                        ...
                        newUrl = "show/equalTo/" + encodeURIComponent($this.text()) + "-" + months[encodeURIComponent($this.parent().data("month"))] + "-" + $this.parent().data("year");
            ...
            MainRouter = B.Router.extend({
                ...
                searchRoute: function (param, value) {
                    ...
                    if (!APP.collections.eventsCollection.length) {
                        $("#events-results").append("<li class=\"no-results\"><h2>No upcoming events of this type</h2><p class=\"cta soft-cta\"><a class=\"reset\" href=\"#clear\">Reset filters</a></p></li>");
                    }

                    //Re adds it to the appropriate one
                    $.each($("#category-select").find("a"), function (k, v) {
                        if ($(v).data("href").replace("+", " ") === value) {
                            $(v).addClass("selected");
                        }
                    });
                },
                ...
                showRoute: function (param, value) {
                    ...
                    //If no values are available notify people
                    if (!APP.collections.eventsCollection.length) {
                        $("#events-results").append("<li class=\"no-results\"><h2>No events for this period are availiable to show</h2><p class=\"cta soft-cta\"><a class=\"reset\" href=\"#clear\">Reset filters</a></p></li>");
                    }
